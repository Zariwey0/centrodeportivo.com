													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-lists-panels.html"><i class="fa fa-bolt"></i> LIST PANELS</a></li>
															</ul>
														</div>
														<div class="coll">
															<ul class="list-unstyled">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Lists panels</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">Lists panels</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container padding-top-100 padding-bottom-100">
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							<div class="row">
								<div class="col-xs-12">
								<h2 class="heading-v3">List Groups - Badges</h2>
								<ul class="list-group col_half">
									<li class="list-group-item"><span class="badge">14</span> Technical Trial, etc</li>
								</ul>
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Linked Items</h2>
								<div class="list-group">
									<a class="list-group-item active" href="#">Lorem Ipsum is simply</a>
									<a class="list-group-item" href="#">Lorem Ipsum is simply</a>
									<a class="list-group-item" href="#">Lorem Ipsum is simply</a>
									<a class="list-group-item" href="#">Lorem Ipsum is simply</a>
									<a class="list-group-item" href="#">Lorem Ipsum is simply</a>
								</div>
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Contextual Classes</h2>
								<div class="row">
									<div class="col-xs-12 col-sm-6">
										<ul class="list-group">
											<li class="list-group-item list-group-item-success">Nam efficitur molestie nisi</li>
											<li class="list-group-item list-group-item-info">Nam efficitur molestie nisi</li>
											<li class="list-group-item list-group-item-warning">Nam efficitur molestie nisi</li>
											<li class="list-group-item list-group-item-danger">Nam efficitur molestie nisi</li>
										</ul>
									</div>
									<div class="col-xs-12 col-sm-6">
										<a class="list-group-item list-group-item-success" href="#">arcu magna. Vivamus </a>
										<a class="list-group-item list-group-item-info" href="#">arcu magna. Vivamus </a>
										<a class="list-group-item list-group-item-warning" href="#">arcu magna. Vivamus</a>
										<a class="list-group-item list-group-item-danger" href="#">arcu magna. Vivamus </a>
									</div>
								</div>
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Contextual alternatives</h2>
									<!-- panel panel-primary -->
								...
								<div class="divider-line2"></div>
								<h2 class="heading-v3">List Groups</h2>
								<ul class="list-group">
									<li class="list-group-item">Since you are one of the leading</li>
									<li class="list-group-item">Since you are one of the leading</li>
									<li class="list-group-item">Since you are one of the leading</li>
									<li class="list-group-item">Since you are one of the leading</li>
									<li class="list-group-item">Since you are one of the leading</li>
								...
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Custom Contents</h2>
								<div class="list-group">
								...
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Panel</h2>
								<!-- panel panel-primary -->
								<div class="panel panel-default">
									<div class="panel-body">Basic panel example</div>
								</div>
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Panel with heading</h2>
								<!-- panel panel-default -->
								<div class="col_half panel panel-default">
									<div class="panel-heading">Panel heading without title</div>
									<div class="panel-body">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel, esse, velit, eaque officiis mollitia inventore ipsum minus quo itaque provident error adipisci quisquam ratione assumenda at illo doloribus beatae totam?</div>
								</div>
								...
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Panel with footer</h2>
								<div class="panel panel-default">
									<div class="panel-body">Panel content</div>
									<div class="panel-footer">Panel footer</div>
								</div>
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Panel with Tables</h2>
								<div class="panel panel-default">
								...
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Panel with List Groups</h2>
								<div class="panel panel-default">
									<div class="panel-heading">Panel heading</div>
									<div class="panel-body">
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati, ratione, facere, blanditiis, incidunt beatae rem veniam autem sequi soluta in totam saepe necessitatibus repellat eos tenetur sapiente laboriosam corrupti. Asperiores.</p>
									</div>
									<ul class="list-group">
								...
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Default Well</h2>
									<div class="well">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam, quam, magnam, nesciunt id incidunt eveniet neque cum nam blanditiis tempora ipsa dolorem adipisci delectus reiciendis illum obcaecati harum rerum velit?</div>
								<div class="divider-line2"></div>
								<h2 class="heading-v3">Well - Sizing</h2>
								<div class="row">
									<div class="col-xs-12 col-sm-6">
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-lists-panels.html"><i class="fa fa-caret-right"></i> Lists &amp; Panels</a></li>
