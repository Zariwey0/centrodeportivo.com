													...
													<div class="drop-holder">
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-blockquotes.html"><i class="fa fa-compress"></i> BLOCQUOTE</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">blockquotes</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">blockquote</a></li>
								</ul>
							</div>
						</div>
					</div>
				</header>
				<div class="container padding-top-100 divider-section">
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							<blockquote class="post-blockquote"><q>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</q></blockquote>
							<blockquote class="blockquote-style1"><q>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</q></blockquote>
							<blockquote class="blockquote-style2"><q>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</q></blockquote>
						</div>
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-modal-boxes.html"><i class="fa fa-caret-right"></i> Modal Boxes</a></li>
