...
<body>
	...
	<div id="wrapper">
		<div class="w1">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="blog-alt-default.html">default</a></li>
			...
			<main id="main" class="bg-grey dark-bottom-border ajax-area" role="main">
                <!-- page banner -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG alt version</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<div id="ajax-holder">
					<div class="container padding-top-100">
						<div class="row">
							<div class="col-xs-12">
								<!-- blog-post-v1 -->
								<article class="blog-post-v1 style2" data-animate="fadeInUp" data-delay="400">
									<div class="img-box">
										<!-- beans-slider -->
											...
											<div class="beans-mask">
												<div class="beans-slideset">
													...
													<div class="beans-slide">
														<a href="blog-single-slider.html"><img src="http://placehold.it/570x420" alt="image description" class="img-responsive"></a>
													</div>
													<!-- beans-slide -->
													<div class="beans-slide">
														<a href="blog-single-slider.html"><img src="http://placehold.it/570x420" alt="image description" class="img-responsive"></a>
				...
				<div class="container" data-animate="fadeInUp" data-delay="400">
					<div class="row">
						<div class="col-xs-12">
							<nav class="blog-footer style2 text-center">
								<a href="inc/items02.html" class="btn btn-load">LOAD MORE</a>
							</nav>
						</div>
					</div>
				</div>
