...
<body>
	...
	<div id="wrapper">
		<div class="w1">
														...
														<li>
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="index-vimeo.html">VIMEO</a></li>
			...
			<!-- welcom banner -->
			<section class="welcom-banner vimeo-area mute">
				<div class="vimeo">
					<iframe src="https://player.vimeo.com/video/142658683?autoplay=1&loop=1&title=0&byline=0&portrait=0" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
				</div>
				<div class="container">
					<div class="row">
						<section class="col-xs-12">
							<div class="banner-section win-height">
								<div class="welcome-heading">
									<h1>WELCOME TO FEKRA</h1>
									<p>Creative. Clean Design. Let’s Start an Awesome Project.</p>
			...
			<main id="main" role="main">
                ...
                <section class="container padding-top-90 padding-bottom-60">
                    ...
                    <header class="page-heading style2">
                        <div class="heading">
                            <h2 class="lime text-uppercase font-medium">About Us<span class="dot">.</span></h2>
                ...
                <section class="container padding-top-90 padding-bottom-90">
                    ...
                    <header class="page-heading style2">
                        <div class="heading">
                            <h2 class="lime text-uppercase font-medium">OUR WORK<span class="dot">.</span></h2>
                            <p>Creative portfolio showcase</p>
                        </div>
                    </header>
                    <div class="row  padding-bottom-30">
                        <div class="col-sm-4 col-xs-12">
                            <!-- portfolio block nospace style2 -->
                            <div class="portfolio-block style2 nospace">
                                <!-- box -->
                                <div class="box">
                                    <div class="over">
                                        <div class="holder">
                                    ...
                                    <img src="http://placehold.it/370x370" alt="image description" class="img-responsive">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 col-xs-12">
				...
				<section class="container padding-top-90 padding-bottom-60">
                    ...
                    <header class="page-heading style2">
                        <div class="heading">
                            <h2 class="lime text-uppercase font-medium">OUR BEST SERVICES<span class="dot">.</span></h2>
							<p>Our Impressive Services</p>
                        </div>
                    </header>
					<div class="row">
						<div class="col-xs-12 col-md-4 hidden-sm hidden-xs" data-animate="fadeInLeft" data-delay="300">
							<img src="http://placehold.it/370x510" height="520" width="377" alt="image description" class="img img-responsive">
						</div>
					...
					<div class="container create-business padding-top-100 padding-bottom-100">
						<div class="row">
							...
							<article class="col-sm-6 col-xs-12 business-col padding-top-30 padding-sm-topzero">
								<h2>We are alwayes design <a href="#">creative</a> themes</h2>
								<p>Suspendisse et metus eu massa lobortis condimentum sed ut orci. Nullam viverra dapibus risus, eu tristique nisl sollicitudin at. Etiam iaculis blandit libero. licitudin at. Etiam iaculis blandit libero. licitudin at. Etiam iaculis blandit libero. Fusce id lobortis orci. Proin tristique laoreet tempus.</p>
								<div class="buttons-box">
									<a href="features.html" class="btn btn-f-info">FEATURES</a>
									<a href="index.html" class="btn btn-f-default">GET STRATED</a>
						...
						<div class="col-xs-12">
							...
							<div class="partners-block line-box">
                                ...
                                <ul class="partners-nav line list-inline">
                                    <li><a href="clients.html"><img src="http://placehold.it/150x100" alt="image"></a></li>
                                    <li><a href="clients.html"><img src="http://placehold.it/150x100" alt="image"></a></li>
                                    <li><a href="clients.html"><img src="http://placehold.it/150x100" alt="image"></a></li>
                                    <li><a href="clients.html"><img src="http://placehold.it/150x100" alt="image"></a></li>
                                    <li><a href="clients.html"><img src="http://placehold.it/150x100" alt="image"></a></li>
