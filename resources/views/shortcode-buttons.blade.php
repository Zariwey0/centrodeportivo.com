													...
													<div class="drop-holder">
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-buttons.html"><i class="fa fa-dot-circle-o"></i> BUTTONS</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">buttons</h1>
								</div>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Fekra Buttons</h3>
									<button type="button" class="btn know-more">READ MORE</button>
									<button type="button" class="btn btn-resume">READ MORE</button>
									<button type="button" class="btn btn-history">READ MORE</button>
								</div>
							</div>
							...
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<p>
										<button class="g-btn g-btn-1 g-btn-1a">Button</button>
										<button class="g-btn g-btn-1 g-btn-1b">Button</button>
										<button class="g-btn g-btn-1 g-btn-1c">Button</button>
									</p>
									<p>
										<button class="g-btn g-btn-1 g-btn-1d">Button</button>
										<button class="g-btn g-btn-1 g-btn-1e">Button</button>
										<button class="g-btn g-btn-1 g-btn-1f">Button</button>
									</p>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<h3>Button with hover and on click efects</h3>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<p>
										<button class="g-btn g-btn-2 g-btn-2a">Button</button>
										<button class="g-btn g-btn-2 g-btn-2b">Button</button>
									</p>
									<p>
										<button class="g-btn g-btn-2 g-btn-2c">Button</button>
										<button class="g-btn g-btn-2 g-btn-2d">Button</button>
									</p>
									<p>
										<button class="g-btn g-btn-2 g-btn-2e">Button</button>
										<button class="g-btn g-btn-2 g-btn-2f">Button</button>
									</p>
									<p>
										<button class="g-btn g-btn-2 g-btn-2g">Button</button>
										<button class="g-btn g-btn-2 g-btn-2h">Button</button>
									</p>
									<p>
										<button class="g-btn g-btn-2 g-btn-2i">Yes</button>
										<button class="g-btn g-btn-2 g-btn-2j">No</button>
									</p>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30 color-4">
								<div class="col-xs-12">
									<h3>Button with hover and on click efects</h3>
									<p>
										<button class="g-btn g-btn-3 g-btn-3a icon-cart">Add to cart</button>
										<button class="g-btn g-btn-3 g-btn-3b icon-star-2">Bookmark</button>
									</p>
									<p>
										<button class="g-btn g-btn-3 g-btn-3c icon-heart-2">Favorite</button>
									</p>
									<p>
										<button class="g-btn g-btn-3 g-btn-3d icon-cog">Settings</button>
										<button class="g-btn g-btn-3 g-btn-3e icon-arrow-right">Send data</button>
									</p>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<p>
										<button class="g-btn g-btn-4 g-btn-4a icon-arrow-right">Continue</button>
										<button class="g-btn g-btn-4 g-btn-4b icon-arrow-left">Return</button>
									</p>
									<p>
										<button class="g-btn g-btn-4 g-btn-4c icon-arrow-right">Continue</button>
										<button class="g-btn g-btn-4 g-btn-4d icon-arrow-left">Return</button>
									</p>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<p>
										<button class="g-btn g-btn-5 g-btn-5a icon-cart"><span>Add to cart</span></button>
										<button class="g-btn g-btn-5 g-btn-5a icon-remove"><span>Delete</span></button>
										<button class="g-btn g-btn-5 g-btn-5a icon-cog"><span>Settings</span></button>
									</p>
									<p>
										<button class="g-btn g-btn-5 g-btn-5b icon-cart"><span>Add to cart</span></button>
										<button class="g-btn g-btn-5 g-btn-5b icon-remove"><span>Delete</span></button>
										<button class="g-btn g-btn-5 g-btn-5b icon-cog"><span>Settings</span></button>
									</p>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<p>
										<button class="g-btn g-btn-6 g-btn-6a">Button</button>
										<button class="g-btn g-btn-6 g-btn-6b">Button</button>
										<button class="g-btn g-btn-6 g-btn-6c">Button</button>
									</p>
									<p>
										<button class="g-btn g-btn-6 g-btn-6d">Button</button>
										<button class="g-btn g-btn-6 g-btn-6e">Button</button>
										<button class="g-btn g-btn-6 g-btn-6f">Button</button>
									</p>
									<p>
										<button class="g-btn g-btn-6 g-btn-6g">Button</button>
										<button class="g-btn g-btn-6 g-btn-6h">Button</button>
										<button class="g-btn g-btn-6 g-btn-6i">Button</button>
									</p>
									<p>
										<button class="g-btn g-btn-6 g-btn-6j">Button</button>
										<button class="g-btn g-btn-6 g-btn-6k">Button</button>
										<button class="g-btn g-btn-6 g-btn-6l">Button</button>
									</p>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									...
									<!-- btn-group -->
									<div class="btn-group">
										<button type="button" class="btn dropdown-toggle btn-primary" data-toggle="dropdown">Primary <span class="caret"></span></button>
										<ul class="dropdown-menu" role="menu">
							...
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									...
									<div class="btn-toolbar" role="toolbar">
										<!-- btn-group -->
										<div class="btn-group">
											<button class="btn btn-default btn-lg dropdown-toggle" type="button" data-toggle="dropdown">Large button <span class="caret"></span></button>
											<ul class="dropdown-menu" role="menu">
												<li><a href="#">Action</a></li>
												<li><a href="#">Another action</a></li>
												<li><a href="#">Something else here</a></li>
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-buttons.html"><i class="fa fa-caret-right"></i> Buttons</a></li>
