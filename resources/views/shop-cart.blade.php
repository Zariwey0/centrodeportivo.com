				...
				<header class="page-banner">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Cart</h1>
									<p>Your Solgan Here</p>
								</div>
			     ...
			     <!-- contact block -->
				<section class="contact-block cart container padding-bottom-30">
					<div class="row shop-table-block">
						<div class="col-xs-12">
							<div class="table-container">
                                ...
                                <div class="table-block">
                                    <table class="shop-table">
                                        <thead>
                                            <tr class="gray">
                                                <th class="ico-1">Product</th>
                                                <th class="ico-2">Color</th>
                                                <th class="ico-3">SIZE</th>
                                                <th class="ico-4">Price</th>
                                                <th class="ico-5">Quantity</th>
                                                <th class="ico-6">Total</th>
                                                <th class="ico-7">&nbsp;</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="ico-1">
                                                    <div class="alignleft"><img alt="image description" src="http://placehold.it/60x60"></div>
                                                    <span class="product-name">Product Name</span>
                                                </td>
                                                <td class="ico-2">Black</td>
                                                <td class="ico-3">11.5</td>
                                                <td class="ico-4">$ 25 </td>
                                                <td class="ico-5">
                                                ...
                                                <td class="ico-6">$ 25 </td>
                                                <td class="ico-7"><a href="#" class="btn-close"><i class="fa fa-times"></i></a></td>
                                            </tr>
                                            <tr class="gray">
                                                <td class="ico-1">
                                                    <div class="alignleft"><img alt="image description" src="http://placehold.it/60x60"></div>
							...
							<div class="shop-apply">
								<form action="#" class="apply-form">
									<fieldset>
										...
										<input  class="btn btn-slider" type="submit" value="APPLY">
									</fieldset>
								</form>
								<div class="shop-buttons">
									<a href="#" class="btn btn-slider">UPDATE</a>
									<a href="#" class="btn btn-slider proceed">PROCEED TO CHECKOUT</a>
								</div>
							</div>
						</div>
                    </div>
			     ...
			     <!-- contact block -->
				<section class="contact-block cart bg-grey padding-top-30 padding-bottom-zero ">
                    <div class="container">
                        <div class="row shop-calculation margin-b-zero">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                ...
                                <form action="#" class="update-form">
                                    <fieldset>
                                        ...
                                        <input class="btn btn-slider" type="submit" value="UPDATE TOTAL">
                                    </fieldset>
                                </form>
                            </div>
                        </div>
			     ...
			     <!-- contact block -->
				<section class="contact-block cart padding-top-90">
                    <div class="container">
