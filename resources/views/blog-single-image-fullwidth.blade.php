														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="blog-single-image-fullwidth.html">image full width</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">single blog image full width</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<div class="container-fluid padding-top-100">
					<div class="row">
						...
						<article class="blog-post-v1 margin-b-zero border-zero">
							<div class="img-box">
								<img src="http://placehold.it/1920x480" alt="image description" class="img-responsive">
							</div>
						</article>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<article class="blog-post-v1 style-full">
								<div class="blog-txt">
									<h2>This is a image sample post</h2>
