										...
										<div class="cart-drop">
											<div class="cart-holder">
												...
												<ul class="cart-list list-unstyled">
													<li>
														<div class="image">
															<a href="#"><img src="http://placehold.it/5x56" alt="Image Description"></a>
														</div>
														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="shop-list-rightsidebar.html">leftsidebar</a></li>
																</ul>
															</div>
														</li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">SHOP</a></li>
									<li class="active"><a href="#">SHOP list left siebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
