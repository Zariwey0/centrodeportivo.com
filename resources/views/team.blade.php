...
<body>
	...
	<div id="wrapper">
				...
				<header class="page-banner">
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-capitalize">Our team</h1>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-5 col-xs-12 img-box hidden-xs hidden-sm" data-animate="fadeInUp" data-delay="300">
								<img class="img-responsive" src="http://placehold.it/430x550" alt="image description">
							</div>
						</div>
					</div>
				</div>
		...
		<div class="popup-holder">
			...
			<!-- popup6 -->
			<div id="popup6" class="lightbox team-lightbox">
				<div class="img-box">
					<img src="http://placehold.it/250x320" alt="image description" class="img-responsive">
				</div>
				<div class="holder">
			...
			<!-- popup8 -->
			<div id="popup8" class="lightbox team-lightbox">
				<div class="img-box">
					<img src="http://placehold.it/250x320" alt="image description" class="img-responsive">
				</div>
				<div class="holder">
