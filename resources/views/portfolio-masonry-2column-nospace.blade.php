															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="portfolio-masonry-2column-nospace.html">2 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO masonry 2 column no space</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="icotop-holder" id="work">
                                    <!-- portfolio block coll-2 style6 nospace -->
                                    <div class="portfolio-block coll-2 style6 nospace work-design">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/585x580" alt="image description" class="img-responsive">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block coll-2 style6 nospace -->
                                    <div class="portfolio-block coll-2 style6 nospace work-fashion">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/585x680" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <!-- portfolio block coll-2 style6 nospace -->
                                    <div class="portfolio-block coll-2 style6 nospace work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/585x660" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-2 style6 nospace work-design">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/585x640" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <!-- portfolio block coll-2 style6 nospace -->
                                    <div class="portfolio-block coll-2 style6 nospace work-products">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/585x580" alt="image description" class="img-responsive">
