													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-responsive.html"><i class="fa fa-bolt"></i> RESPONSIVE</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">responsive</h1>
								</div>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							...
							<div class="visible-lg text-center">
								<i class="fa fa-desktop" style="font-size: 300px; line-height: 1; margin-bottom: 10px;"></i>
								<div class="alert alert-info margin-bottom-zero">
									<strong>Note:</strong> This Text is visible only on Desktop Devices. Resize your Browser to view others
								</div>
							</div>
							<!-- visible-md -->
							<div class="visible-md text-center">
								<i class="fa fa-desktop" style="font-size: 300px; line-height: 1; margin-bottom: 10px;"></i>
							...
							<div class="visible-sm text-center">
								<i class="fa fa-desktop" style="font-size: 300px; line-height: 1; margin-bottom: 10px;"></i>
								<div class="alert alert-danger margin-bottom-zero">
							...
							<div class="visible-xs text-center">
								<i class="fa fa-desktop" style="font-size: 300px; line-height: 1; margin-bottom: 10px;"></i>
								<div class="alert alert-warning margin-bottom-zero">
								...
								<table class="table table-bordered responsive-utilities">
									<thead>
										<tr>
											...
											<th>Medium devices <small>Desktops (&gt;991px)</small></th>
											<th>Large devices <small>Desktops (&gt;1199px)</small></th>
										</tr>
									</thead>
									<tbody>
										<tr>
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-responsive.html"><i class="fa fa-caret-right"></i> Responsive</a></li>
