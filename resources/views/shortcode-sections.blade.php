													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-sections.html"><i class="fa fa-bolt"></i> SECTIONS</a></li>
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">sections</h1>
								</div>
				...
				<div class="banner">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<p>Section with parallax background</p>
								<a href="#" class="btn btn-f-info">GET STRATED NOW</a>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-sm-5 col-xs-12 img-box hidden-xs" data-animate="fadeInUp" data-delay="300">
								<img class="img-responsive img2" src="http://placehold.it/430x548" alt="image description">
							</div>
						</div>
					</div>
				</div>
				<!-- video section -->
				<section class="video-section padding-top-100 padding-bottom-100">
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
								...
								<h2>Section with Video Background</h2>
				...
				<!-- business block -->
				<div class="business-block padding-top-90 padding-bottom-90">
					<div class="stretch">
						<img src="http://placehold.it/1920x500" alt="image description">
					</div>
					<div class="container create-business design">
						<div class="row">
							...
							<article class="col-sm-6 col-xs-12 business-col padding-top-60 padding-xs-topzero">
								<h2>Section with <a href="#">light</a> image background</h2>
								...
								<div class="buttons-box">
									<a href="#" class="btn btn-f-info">FEATURES</a>
									<a href="#" class="btn btn-f-default get">GET STRATED</a>
								</div>
							</article>
						</div>
					</div>
