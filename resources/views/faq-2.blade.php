	...
	<div id="wrapper">
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															...
															<ul class="list-unstyled">
																...
																<li class="active"><a href="faq-2.html">FAQ LAYOUT 2</a></li>
			...
			<main id="main" role="main">
                ...
                <!-- faq section -->
				<div class="container padding-bottom-100 padding-top-100 faq-section">
                    <!-- page heading -->
					...
					<div class="row holder">
						<div class="col-xs-12 col-md-6" data-delay="300" data-animate="fadeInUp">
							<h3>themeforest <span class="add">(4)</span></h3>
							<!-- beans-accordion -->
							<ul class="beans-accordion list-unstyled style2">
								<li class="active">
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i>How do I become an author?</a></h2>
									<!-- beans-slide -->
								...
								<li>
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i>How do I pay for items on the Marketplaces?</a></h2>
									<!-- beans-slide -->
									<div class="beans-slide">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li>
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i> How can I get support for an item?</a></h2>
									<!-- beans-slide -->
									<div class="beans-slide">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li>
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i> Tips for Increasing Your Referral Income</a></h2>
									<!-- beans-slide -->
									<div class="beans-slide">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
						...
						<div class="col-xs-12 col-md-6" data-delay="300" data-animate="fadeInUp">
							<h3>codecanyon <span class="add">(9)</span></h3>
							<!-- beans-accordion -->
							<ul class="beans-accordion list-unstyled style2">
								<li class="active">
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i> Can I use trademarked names in my items?</a></h2>
									<!-- beans-slide -->
									<div class="beans-slide">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li>
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i> What Images, Videos, Code or Music Can I Use in my Items?</a></h2>
									<!-- beans-slide -->
									<div class="beans-slide">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li>
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i> An Introduction to the Marketplaces for Authors</a></h2>
									<!-- beans-slide -->
									<div class="beans-slide">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li>
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i> How much money can I make?</a></h2>
									<!-- beans-slide -->
									<div class="beans-slide">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
					...
					<div class="row holder">
						<div class="col-xs-12 col-md-6" data-delay="300" data-animate="fadeInUp">
							<h3>videohive <span class="add">(6)</span></h3>
							<!-- beans-accordion -->
							<ul class="beans-accordion list-unstyled style2">
								<li class="active">
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i> Can I use trademarked names in my items?</a></h2>
						...
						<div class="col-xs-12 col-md-6" data-delay="300" data-animate="fadeInUp">
							<h3>audiojungle <span class="add">(4)</span></h3>
							<!-- beans-accordion -->
							<ul class="beans-accordion list-unstyled style2">
								<li class="active">
									<h2><a href="#" class="opener"><i class="fa fa-angle-right"></i>How do I become an author?</a></h2>
