...
<body>
	...
	<div id="wrapper">
		<div class="w1">
																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-alt2-default-rightsidebar.html">right SIDEBAR - layout 2</a></li>
																			</ul>
																		</div>
																	</li>
																</ul>
			...
			<main id="main" role="main" class="bg-grey dark-bottom-border">
                <!-- page banner -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG FULL WIDTH alt2 right sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<div class="container padding-top-100">
					<div class="row">
						<div class="col-xs-12 col-xs-12 col-sm-8 col-md-9">
							<!-- blog-post-v1 -->
										...
										<div class="beans-mask">
											<div class="beans-slideset">
												...
												<div class="beans-slide">
													<a href="blog-single-slider.html"><img src="http://placehold.it/425x315" alt="image description" class="img-responsive"></a>
												</div>
												<!-- beans-slide -->
												<div class="beans-slide">
													<a href="blog-single-slider.html"><img src="http://placehold.it/425x315" alt="image description" class="img-responsive"></a>
								...
								<div class="blog-txt">
									...
									<ul class="meta list-inline">
										...
										<li>
											...
											<a href="blog-single-slider.html">Music</a>
										</li>
										<li>
							...
							<article class="blog-post-v1 style2">
								<div class="blog-txt">
									<h2><a href="blog-single-image.html">transitions in ux design</a></h2>
									<ul class="meta list-inline">
										<li>
											<i class="fa fa-user"></i>
										...
										<li>
											<i class="fa fa-tags"></i>
											<a href="blog-single-image.html">Technologies</a>
										</li>
										<li>
											<i class="fa fa-heart"></i>
								...
								<div class="img-box">
									<a href="blog-single-image.html"><img src="http://placehold.it/425x315" alt="image description" class="img-responsive"></a>
								</div>
							</article>
							<!-- blog-post-v1 -->
							<article class="blog-post-v1 style2">
								...
								<div class="blog-txt">
									...
									<ul class="meta list-inline">
										...
										<li>
											<i class="fa fa-tags"></i>
											<a href="blog-single-video-vimeo.html">People</a> 
										</li>
										<li>
											<i class="fa fa-heart"></i>
							...
							<article class="blog-post-v1 style2">
								<div class="blog-txt">
									...
									<ul class="meta list-inline">
										...
										<li>
											<i class="fa fa-tags"></i>
											<a href="blog-single-soundcloud.html">Music</a>
										</li>
										<li>
											<i class="fa fa-heart"></i>
							...
							<nav class="blog-footer style2 text-center">
								<a href="blog-alt2-default.html" class="btn btn-load">LOAD MORE</a>
							</nav>
						</div>
