																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="portfolio-2columns.html">2 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO GIRD 2 COLUMN </a></li>
								</ul>
							</div>
						</div>
				    </div>
                    ...
                    <div class="icotop-holder margin-bottom-30" id="work">
                        ...
                        <div class="portfolio-block coll-2 work-design">
                            ...
                            <div class="box">
                                ...
                                <div class="stretch">
                                    <img src="http://placehold.it/570x570" alt="image description">
                                </div>
                            </div>
                        </div>
                        <!-- portfolio block coll-2 -->
