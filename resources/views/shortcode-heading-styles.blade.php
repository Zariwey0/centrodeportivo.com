													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-heading-styles.html"><i class="fa fa-bolt"></i> HEADING STYLES</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Heading Styles</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">Heading Styles</a></li>
								</ul>
							</div>
						</div>
					</div>
				</header>
				<div class="container divider-section padding-top-100">
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
                           <div class="row">
                               <div class="col-xs-12">
                                    ...
                                    <header class="page-heading">
                                        <h1 class="heading lime text-capitalize font-medium">heading  h1</h1>
                                    </header>
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h2 class="heading lime text-capitalize font-medium">heading  h2</h2>
                                    </header>
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h3 class="heading lime text-capitalize font-medium">heading  h3</h3>
                                    </header>
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h4 class="heading lime text-capitalize font-medium">heading  h4</h4>
                                    </header>
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h5 class="heading lime text-capitalize font-medium">heading  h5</h5>
                                    </header>
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h6 class="heading lime text-capitalize font-medium">heading  h6</h6>
                                    </header>
                                </div>
                            </div>
                           ...
                           <div class="row">
                               <div class="col-xs-12">
                                    ...
                                    <header class="page-heading small">
                                        <h2 class="heading lime text-capitalize font-medium">heading  style 2</h2>
                                    </header>
                                </div>
                            </div>
							<div class="divider-line2"></div>
                           <div class="row">
                               <div class="col-xs-12">
                                    ...
                                    <header class="page-heading style2">
                                        <h2 class="heading lime text-capitalize font-medium">heading  style 3</h2>
                                    </header>
                                </div>
                            </div>
							<div class="divider-line2"></div>
                           <div class="row">
                               <div class="col-xs-12">
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h2 class="heading2 lime text-capitalize font-medium padding-bottom-10">heading style 4</h2>
                                    </header>
                                </div>
                            </div>
							<div class="divider-line2"></div>
                           <div class="row">
                               <div class="col-xs-12">
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h2 class="heading3 lime text-capitalize font-medium">heading style 5</h2>
                                    </header>
                                </div>
                            </div>
							<div class="divider-line2"></div>
                           <div class="row">
                               <div class="col-xs-12">
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h2 class="heading4 lime text-capitalize font-medium">heading style 6</h2>
                                    </header>
                                </div>
                            </div>
							<div class="divider-line2"></div>
                           <div class="row">
                               <div class="col-xs-12">
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h2 class="heading5 lime text-capitalize font-medium">heading style 7</h2>
                                    </header>
                                </div>
                            </div>
							<div class="divider-line2"></div>
                           <div class="row">
                               <div class="col-xs-12">
                                    ...
                                    <header class="page-heading dark-style">
                                        <h2 class="heading6 lime text-capitalize font-medium">heading style 8</h2>
                                    </header>
                                </div>
                            </div>
							<div class="divider-line2"></div>
                           <div class="row">
                               <div class="col-xs-12">
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h2 class="heading7 lime text-capitalize font-medium">heading style 9</h2>
                                    </header>
                                </div>
                            </div>
							<div class="divider-line2"></div>
                           <div class="row">
                               <div class="col-xs-12">
                                    <!-- page heading -->
                                    <header class="page-heading">
                                        <h2 class="heading8 lime text-capitalize font-medium">heading style 10</h2>
                                    </header>
                                </div>
                            </div>
						</div>
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-heading-styles.html"><i class="fa fa-caret-right"></i> Heading Styles</a></li>
