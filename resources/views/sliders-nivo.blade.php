...
<head>
	...
	<!-- include the site stylesheet of nivo slider  -->
	<link media="all" rel="stylesheet" href="css/nivo-slider.css">
...
<body>
				...
				<header class="page-banner">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Slider</h1>
									<p>Your Solgan Here</p>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">Slider</a></li>
									<li class="active"><a href="#">elastic Slider</a></li>
								</ul>
							</div>
						</div>
				    </div>
							...
							<div class="col-xs-12">
								<div class="slider-wrapper theme-default">
									<div id="nivo-slider" class="nivoSlider">
										<img src="http://placehold.it/1160x580" alt="Image Description">
										<a href="#">
											<img src="http://placehold.it/1160x580" alt="Image Description" title="This is an example of a caption">
										</a>
										<img src="http://placehold.it/1160x580" alt="Image Description" data-transition="slideInLeft" />
										<img src="http://placehold.it/1160x580" alt="Image Description" title="#htmlcaption" />
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="js/sliders-plugins.js"></script>
