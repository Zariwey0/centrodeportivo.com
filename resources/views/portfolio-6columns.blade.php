																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="portfolio-6columns.html">6 column</a></li>
																			</ul>
																		</div>
																	</li>
																	<li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO masonry 6 column</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<section class="work-section padding-top-90 padding-bottom-90 space">
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        <!-- portfolio block coll-6 -->
                        <div class="portfolio-block coll-6 work-design">
                            <!-- box -->
                            <div class="box">
                        ...
                        <!-- portfolio block coll-6 -->
                        <div class="portfolio-block coll-6 work-products">
                            <!-- box -->
                            <div class="box">
                                <a href="portfolio-single-image.html" class="over">
                                    <div class="holder">
                        ...
                        <!-- portfolio block coll-6 -->
                        <div class="portfolio-block coll-6 work-illustration">
                            <!-- box -->
                            <div class="box">
                                <a href="portfolio-single-image.html" class="over">
                                    <div class="holder">
                        ...
                        <!-- portfolio block coll-6 -->
                        <div class="portfolio-block coll-6 work-fashion">
                            <!-- box -->
                            <div class="box">
                                <a href="portfolio-single-image.html" class="over">
                                    <div class="holder">
