															...
															<div class="drop">
																<ul class="list-unstyled">
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="blog-full-width.html">DEFAULT</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG FULL WIDTH</a></li>
								</ul>
							</div>
						</div>
				    </div>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<nav class="blog-footer">
								<div class="btn-box">
									<a href="blog-full-width.html" class="btn">PREVIOUS</a>
									<a href="blog-full-width.html" class="btn">NEXT</a>
								</div>
								<ul class="b-pagination list-unstyled">
									<li><a href="blog-full-width.html">1</a></li>
									<li class="active"><a href="blog-full-width.html">2</a></li>
									<li><a href="blog-full-width.html">3</a></li>
									<li><a href="blog-full-width.html">4</a></li>
								</ul>
							</nav>
						</div>
					</div>
