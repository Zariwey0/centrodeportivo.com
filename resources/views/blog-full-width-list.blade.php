																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-full-width-list.html">LIST</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG list FULL WIDTH</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							<div class="row">
								...
								<article class="blog-post-v2">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/635x240" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
								...
								<article class="blog-post-v2">
											...
											<div class="beans-mask">
												<div class="beans-slideset">
													<div class="beans-slide">
														<a href="blog-single-slider.html"><img src="http://placehold.it/635x240" alt="image description" class="img-responsive"></a>
													</div>
													<div class="beans-slide">
														<a href="blog-single-slider.html"><img src="http://placehold.it/635x240" alt="image description" class="img-responsive"></a>
													</div>
									...
									<div class="blog-txt">
										<h2><a href="blog-single-slider.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
											<li>
												<i class="fa fa-user"></i>
								...
								<article class="blog-post-v2">
									...
									<div class="blog-txt">
										<h2><a href="blog-single-video-youtube.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
											<li>
												<i class="fa fa-user"></i>
												By <a href="blog-single-video-youtube.html">Admin name</a>
											</li>
											<li>
												<i class="fa fa-tags"></i>
												<a href="blog-single-video-youtube.html">Business</a>, <a href="blog-single-video-youtube.html">Technologies</a>, <a href="blog-single-video-youtube.html">Sport</a> 
											</li>
											<li>
												<i class="fa fa-heart"></i>
												<a href="blog-single-video-youtube.html">14</a>
											</li>
											<li>
												<i class="fa fa-comments"></i>
												<a href="blog-single-video-youtube.html">320</a>
											</li>
										</ul>
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptate...</p>
										<div class="box">
							...
							<div class="row">
								...
								<article class="blog-post-v2">
									<div class="img-box audio-box">
										<iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/189617583&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
									</div>
									<div class="blog-txt">
										<h2><a href="blog-single-soundcloud.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
											<li>
												<i class="fa fa-user"></i>
											...
											<li>
												<i class="fa fa-tags"></i>
												<a href="blog-single-soundcloud.html">Business</a>, <a href="blog-single-soundcloud.html">Technologies</a>, <a href="blog-single-soundcloud.html">Sport</a> 
											</li>
											<li>
												<i class="fa fa-heart"></i>
										...
										<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptate...</p>
										<div class="box">
											<span class="icon"><i class="fa fa-volume-off"></i></span>
											<time datetime="2015-02-18">
												<span class="add">18</span>jan
											</time>
										</div>
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								...
								<!-- blog-post-v2 -->
								<article class="blog-post-v2">
									<blockquote><q> Cicero famously orated against his political Lucius   Sergius Catilina. Occasionally the first Oration against Catiline.</q></blockquote>
									<div class="blog-txt">
										...
										<ul class="meta list-inline">
											...
											<li>
												<i class="fa fa-tags"></i>
												<a href="blog-single-blockquote.html">Business</a>, <a href="blog-single-blockquote.html">Technologies</a>, <a href="blog-single-blockquote.html">Sport</a> 
											</li>
											<li>
												<i class="fa fa-heart"></i>
					...
					<div class="row">
						<div class="col-xs-12">
							<nav class="blog-footer style2 text-center">
								<a href="blog-full-width-list.html" class="btn btn-load">LOAD MORE</a>
							</nav>
						</div>
					</div>
				</div>
