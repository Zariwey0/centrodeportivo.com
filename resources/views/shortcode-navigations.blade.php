													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-navigations.html"><i class="fa fa-bolt"></i> NAVIGATIONS</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Navigations</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">Navigations</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
                            ...
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Navs - Tabs</h2>
                            </header>
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Pills</h2>
                            </header>
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Stacked</h2>
                            </header>
							<ul class="nav nav-pills nav-stacked margin-bottom-30" style="max-width: 300px;">
								<li class="active"><a href="#">Home</a></li>
								<li><a href="#">Profile</a></li>
								<li><a href="#">Messages</a></li>
							</ul>
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Justified</h2>
                            </header>
							<ul class="nav nav-tabs nav-justified margin-bottom-30">
								<li class="active"><a href="#">Home</a></li>
								<li><a href="#">Profile</a></li>
								<li><a href="#">Messages</a></li>
							</ul>
							<div class="divider-line2"></div>
							<ul class="nav nav-pills nav-justified margin-bottom-30">
								<li class="active"><a href="#">Home</a></li>
								<li><a href="#">Profile</a></li>
								<li><a href="#">Messages</a></li>
							</ul>
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Disabled</h2>
                            </header>
							<ul class="nav nav-pills margin-bottom-30">
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Using Dopdowns</h2>
                            </header>
							<ul class="nav nav-tabs margin-bottom-30">
								<li class="active"><a href="#">Home</a></li>
								<li><a href="#">Help</a></li>
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Pills with Dropdowns</h2>
                            </header>
							<ul class="nav nav-pills margin-bottom-30">
								<li class="active"><a href="#">Home</a></li>
								<li><a href="#">Help</a></li>
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Navbar</h2>
                            </header>
							<!-- navbar -->
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Navbar With Forms</h2>
                            </header>
							<!-- navbar -->
							<nav class="navbar navbar-default margin-bottom-30" role="navigation">
								<div class="container-fluid">
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Navbar With Buttons</h2>
                            </header>
							<!-- navbar -->
							<nav class="navbar navbar-default margin-bottom-30" role="navigation">
								<div class="container-fluid">
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Navbar Text</h2>
                            </header>
							<!-- navbar -->
							<nav class="navbar navbar-default margin-bottom-30" role="navigation">
								<div class="container-fluid">
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Inverted Navbar</h2>
                            </header>
							<!-- navbar -->
							<nav class="navbar navbar-inverse margin-bottom-30" role="navigation">
								<div class="container-fluid">
									<!-- Brand and toggle get grouped for better mobile display -->
									<div class="navbar-header">
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-navigations.html"><i class="fa fa-caret-right"></i> Navigations</a></li>
