		...
		<div class="w1">
														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="blog-full-width-accordion-leftsidebar.html">LEFT SIDEBAR</a></li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG FULL WIDTH accordion left sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<div class="container padding-top-100">
					<div class="row">
						<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3 blog-section padding-zero">
							<!-- blog-accordion -->
							<ul class="blog-accordion list-unstyled">
								<!-- blog-post -->
								<li class="blog-m-post accordion">
									<a href="blog-single-image.html" class="opener"><img src="http://placehold.it/900x155" alt="image description" class="img-responsive"></a>
									<div class="blog-txt">
								...
								<!-- blog-post -->
								<li class="blog-m-post accordion active">
									<a href="blog-single-image.html" class="opener"><img src="http://placehold.it/900x155" alt="image description" class="img-responsive"></a>
									<div class="blog-txt">
								...
								<!-- blog-post -->
								<li class="blog-m-post accordion video-area">
									...
									<div class="blog-txt">
										<h3><a href="blog-single-video-vimeo.html">Video post</a></h3>
										<ul class="meta list-inline">
											<li>
												<i class="fa fa-user"></i>
											...
											<li>
												<i class="fa fa-tags"></i>
												<a href="blog-single-video-vimeo.html">Business</a>, <a href="blog-single-video-vimeo.html">Technologies</a>, <a href="blog-single-video-vimeo.html">Sport</a> 
											</li>
											<li>
												<i class="fa fa-heart"></i>
								...
								<li class="blog-m-post accordion video-area">
									...
									<div class="blog-txt">
										<h3><a href="blog-single-soundcloud.html">Soundcloud post</a></h3>
										<ul class="meta list-inline">
											<li>
												<i class="fa fa-user"></i>
							...
							<!-- blog-footer -->
							<nav class="blog-footer text-center">
								<a href="blog-full-width-accordion.html" class="btn btn-load">LOAD MORE</a>
							</nav>
						</div>
