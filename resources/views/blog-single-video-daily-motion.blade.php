														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="blog-single-video-daily-motion.html">dialymotion</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">single blog daily motion</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							...
							<article class="blog-post-v1 style-full">
								<div class="img-box video-area">
									<iframe frameborder="0" width="100%" height="500" src="//www.dailymotion.com/embed/video/x391q7k" allowfullscreen></iframe>
								</div>
								<div class="blog-txt">
									<h2>Daily motion Single Sample Post</h2>
