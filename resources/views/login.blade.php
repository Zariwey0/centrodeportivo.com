	...
	<div id="wrapper">
		<div class="w1">
			...
			<main id="main" role="main">
				...
				<header class="page-banner">
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-capitalize">login</h1>
                ...
                <!-- login form2 -->
				<form class="login-form2" action="#">
					<fieldset>
                        <!-- page heading -->
                        <header class="page-heading">
                            <div class="heading">
                                <p class="text-uppercase">Login to continue</p>
                                <h2 class="heading5 lime text-uppercase font-medium">Login</h2>
                            </div>
                        </header>
