											...
											<li class="active">
												...
												<div class="drop">
													<ul class="list-unstyled">
														...
														<li class="active"><a href="shop-single.html">single</a></li>
							...
							<header class="description-header">
								<div class="holder">
									...
									<div class="block">
										...
										<a href="#" class="review">(3 Reviews)</a>
									</div>
									<span class="in-stock">In Stock</span>
								</div>
								<span class="amount"><sup>$</sup>28.99</span>
							</header>
							...
							<form action="#" class="cart-form">
								<fieldset>
									<div class="form-col color">
										...
										<select id="color" data-jcf='{"wrapNative": false}'>
											<option>Black</option>
									...
									<div class="form-col">
										...
										<select id="size" data-jcf='{"wrapNative": false}'>
											<option>11.5</option>
											<option>10.5</option>
											<option>9.5</option>
											<option>8.5</option>
									...
									<button class="btn btn-slider" type="submit">Add to cart</button>
								</fieldset>
							</form>
							<div class="buttons-block">
								<a href="#" class="btn-add"><i class="fa fa-heart-o"></i>ADD TO WISHLIST</a>
								<a href="#" class="btn-add"><i class="fa fa-envelope-o"></i>SEND TO FRIEND</a>
							</div>
					...
					<div class="row descriptio-tabs review">
						<div class="col-xs-12">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="#review" aria-controls="review" role="tab" data-toggle="tab">REVIEW  (5)</a></li>
							</ul>
							<!-- Tab panes -->
							<div class="tab-content">
                                ...
                                <div class="comment-box">
                                    <h2 class="margin-bottom-10">Review (5)</h2>
