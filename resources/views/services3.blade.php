	...
	<div id="wrapper">
		<div class="w1">
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li class="active"><a href="#">services 3</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<!-- wedo section -->
				<section class="wedo-section container padding-top-90 padding-bottom-30">
                    <!-- page heading -->
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4 coll">
							...
							<h3>Trendy Design</h3>
							<p>Great itself won't dominion saw sixth was firmament he us for is midst creepeth thing creature dry deep you can't him. Waters one, night, they're bring over. Of creeping, </p>
						...
						<div class="col-xs-12 col-sm-4 coll">
							...
							<h3>Great Support</h3>
							<p>Beast herb very two whales own to second thing that to be moveth have day Be, their fourth third. Life which for moving above moveth together sixth kind. creepeth waters.</p>
							<a href="features.html" class="btn btn-more">READ MORE</a>
						</div>
						<!-- coll -->
						<div class="col-xs-12 col-sm-4 coll">
							...
							<p>Great itself won't dominion saw sixth was firmament he us for is midst creepeth thing creature dry deep you can't him. Waters one, night, they're bring over. Of day, </p>
							<a href="features.html" class="btn btn-more">READ MORE</a>
						</div>
					</div>
					<div class="row">
				...
				<section class="p-skills">
					<div class="container">
                        <!-- page heading -->
                        <header class="page-heading margin-bottom-60">
                            <h2 class="lime text-capitalize font-medium">My Skills &amp; Expertise</h2>
                            <p>Ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam</p>
                        </header>
						<div class="row">
							<div class="col-xs-12 col-sm-6 progress-right">
								<strong class="title">PROGRAMMING</strong>
								<!-- progress-holder -->
								<ul class="progress-holder list-unstyled">
									...
									<li>
										...
										<div class="counter">
											<span data-from="0" data-to="85" data-refresh-interval="80" data-speed="1000" data-comma="true">0</span>%
										</div>
									...
									<li>
										...
										<div class="counter">
											<span data-from="0" data-to="60" data-refresh-interval="80" data-speed="1000" data-comma="true">0</span>%
										</div>
							...
							<div class="col-xs-12 col-sm-6">
								<strong class="title">Graphic</strong>
								<!-- progress-holder -->
								<ul class="progress-holder list-unstyled">
									<li>
										<!-- progress-bar -->
								...
								<div class="beans-slideset">
									...
									<div class="beans-slide">
										...
										<a href="clients.html" class="client-box">
											<span class="img"><img src="http://placehold.it/250x88" alt="image description"></span>
										</a>
									</div>
									<!-- beans-slide 2 -->
									<div class="beans-slide">
