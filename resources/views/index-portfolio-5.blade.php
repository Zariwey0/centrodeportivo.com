	...
	<div id="wrapper" class="no-boxed">
		<div class="w1">
					...
					<div class="row">
						<div class="col-xs-12">
												...
												<div class="drop-holder">
													...
													<div class="coll">
														...
														<ul class="list-unstyled">
															...
															<li class="active"><a href="index-portfolio-5.html">Home - Portfolio 5</a></li>
														</ul>
													</div>
													<div class="coll">
							...
							<ul class="list-unstyled icon-list add">
								<li><a href="#" class="opener-icons"><i class="fa fa-facebook"></i></a></li>
								<li><a href="#" class="opener-icons"><i class="fa fa-twitter"></i></a></li>
								<li><a href="#" class="opener-icons"><i class="fa fa-google-plus"></i></a></li>
								<li><a href="#" class="opener-icons"><i class="fa fa-behance"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<main id="main" role="main">
							...
							<div class="col-xs-12 padding-right-zero">
								<div class="icotop-holder" id="work">
                                    ...
                                    <div class="portfolio-block coll-5 style6">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/350x345" alt="image description" class="img-responsive">
                                                <div class="over">
                                    ...
                                    <div class="portfolio-block coll-5 style6">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/350x395" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-5 style6">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/350x445" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-5 style6">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/350x545" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-5 style6">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/350x405" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-5 style6">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/350x400" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-5 style6">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/350x420" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-5 style6">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/350x390" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								...
								<a href="http://fekra.csshunter.com" class="btn btn-f-info">GET STRATED NOW</a>
							</div>
						</div>
					</div>
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x600" height="1280" width="1920" alt="image description"></div>
					</div>
				</div>
				<!-- container -->
				...
				<!-- clients section -->
				<div class="clients-section bg-grey dark-bottom-border padding-top-60 padding-bottom-60">
					<div class="container">
						<!-- beans-stepslider -->
								...
								<div class="beans-slideset">
									...
									<div class="beans-slide">
										<a href="clients.html" class="client-box">
											<span class="img"><img src="http://placehold.it/120x60" alt="image description"></span>
										</a>
									</div>
									<!-- beans-slide -->
									<div class="beans-slide">
