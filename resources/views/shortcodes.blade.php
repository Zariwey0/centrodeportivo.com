				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">shortcodes</h1>
								</div>
					...
					<div class="row text-uppercase">
						<aside class="col-xs-12 col-sm-6 col-md-3">
							...
							<section class="widget cate-widget">
                                <ul class="list-unstyled">
                                    <li><a href="shortcode-alert-boxes.html"><i class="fa fa-bolt"></i> ALERT BOXES</a></li>
                                    <li><a href="shortcode-animations.html"><i class="fa fa-bolt"></i> ANIMATION</a></li>
                                    <li><a href="shortcode-blockquotes.html"><i class="fa fa-bolt"></i> BLOCQUOTE</a></li>
                                    <li><a href="shortcode-buttons.html"><i class="fa fa-bolt"></i> BUTTONS</a></li>
                                    <li><a href="shortcode-carousel.html"><i class="fa fa-bolt"></i> CAROUSAL</a></li>
                                    <li><a href="shortcode-clients.html"><i class="fa fa-bolt"></i> CLIENTS</a></li>
                                    <li><a href="shortcode-columns.html"><i class="fa fa-bolt"></i> CLOUMNS</a></li>
                                    <li><a href="shortcode-counters.html"><i class="fa fa-bolt"></i> COUNTERS</a></li>
                                </ul>
							</section>
						</aside>
						<aside class="col-xs-12 col-sm-6 col-md-3">
