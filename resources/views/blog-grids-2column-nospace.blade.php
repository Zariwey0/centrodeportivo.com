															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="blog-grids-2column-nospace.html">2 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog grids 2 column no space</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							<div class="col-xs-12">
								<div class="blog-masonry-holder full-width" id="masonry-container">
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style5 item nospace">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/600x355" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
												...
												<div class="beans-mask">
													<div class="beans-slideset">
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/600x405" alt="image description" class="img-responsive"></a>
														</div>
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/600x405" alt="image description" class="img-responsive"></a>
														</div>
									...
									<article class="blog-post-v1 style5 item nospace">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/600x295" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
									...
									<article class="blog-post-v1 style5 item nospace">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/600x375" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
