																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-alt-default-rightsidebar.html">right SIDEBAR</a></li>
										...
										<div class="beans-mask">
											<div class="beans-slideset">
												...
												<div class="beans-slide">
													<a href="blog-single-slider.html"><img src="http://placehold.it/425x310" alt="image description" class="img-responsive"></a>
												</div>
												<!-- beans-slide -->
												<div class="beans-slide">
													<a href="blog-single-slider.html"><img src="http://placehold.it/425x310" alt="image description" class="img-responsive"></a>
							...
							<article class="blog-post-v1 style2">
								...
								<div class="blog-txt">
									...
									<ul class="meta list-inline">
										...
										<li>
											<i class="fa fa-tags"></i>
											<a href="blog-single-soundcloud.html">People</a> 
										</li>
										<li>
											<i class="fa fa-heart"></i>
