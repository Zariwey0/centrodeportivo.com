																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-masonry-fullwidth.html">Full width</a></li>
																			</ul>
																		</div>
																	</li>
																	<li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog MASONRY full width</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							<div class="col-xs-12">
								<ul id="work-filter" class="list-inline isotop-controls">
									...
									<li><a data-filter=".blog-design" href="#">Design</a></li>
									<li><a data-filter=".blog-fashion" href="#">Fashion</a></li>
									<li><a data-filter=".blog-illustration" href="#">Illustration</a></li>
									<li><a data-filter=".blog-products" href="#">Products</a></li>
								</ul>
								<!-- blog-masonry-holder -->
								<div class="blog-masonry-holder full-width" id="work">
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style3 blog-design">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/345x205" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											...
											<p>In a professional context it often happens that private or corporate clients corder a publication to be made and presented.</p>
									...
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style3 blog-fashion">
										<div class="img-box">
											<div class="beans-slider" data-rotate="true">
												<div class="beans-mask">
													<div class="beans-slideset">
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/345x235" alt="image description" class="img-responsive"></a>
														</div>
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/345x235" alt="image description" class="img-responsive"></a>
														</div>
									...
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style3 blog-illustration">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/345x170" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
									...
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style3 blog-products">
										<div class="img-box video-area">
											<iframe src="https://player.vimeo.com/video/44109350?title=0&byline=0&portrait=0" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
										</div>
										<div class="blog-txt">
									...
									<article class="blog-post-v1 style3 blog-design">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/345x218" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
									...
									<article class="blog-post-v1 style3 blog-fashion">
										<div class="img-box video-area">
											<iframe width="100%" height="450" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/207659137&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
										</div>
										<div class="blog-txt">
									...
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style3 blog-design">
										<blockquote><q>Neque porro quisquam est qui dolorem ipsum quia dolor sit amet</q></blockquote>
										<div class="blog-txt">
											<h2><a href="blog-single-blockquote.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
												<li>
													<i class="fa fa-user"></i>
													By <a href="blog-single-blockquote.html">Admin name</a>
												</li>
												<li>
													<i class="fa fa-heart"></i>
													<a href="blog-single-blockquote.html">14</a>
												</li>
												<li>
													<i class="fa fa-comments"></i>
													<a href="blog-single-blockquote.html">320</a>
												</li>
											</ul>
											<p>In a professional context it often happens that private or corporate clients corder a publication to be made and presented.</p>
											<a href="blog-single-blockquote.html" class="more">[ CONTINUE READING ]</a>
											<div class="box-holder">
									...
									<article class="blog-post-v1 style3 blog-fashion">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/345x180" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
									...
									<article class="blog-post-v1 style3 blog-fashion">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/345x285" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
									...
									<article class="blog-post-v1 style3 blog-fashion">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/345x255" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
								...
								<nav class="blog-footer style2 text-center">
									<a href="blog-masonry-fullwidth.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
						</div>
					</div>
