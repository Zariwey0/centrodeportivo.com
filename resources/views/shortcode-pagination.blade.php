													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-pagination.html"><i class="fa fa-bolt"></i> PAGINATIONS</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">pagination</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">pagination</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container padding-top-100 padding-bottom-100">
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							<h2 class="heading-v5">Paginations</h2>
							<!-- pagination -->
							<ul class="pagination">
							...
							<h2 class="heading-v5">Disabled and active states</h2>
							<!-- pagination -->
							<ul class="pagination">
							...
							<div class="divider-line2"></div>
							<h2 class="heading-v5">Aligned Links</h2>
							<!-- pager -->
							<ul class="pager">
							...
							<div class="divider-line2"></div>
							<h2 class="heading-v5">Progress Bars</h2>
							<!-- progress -->
							<div class="progress">
							...
							<div class="divider-line2"></div>
							<h2 class="heading-v5">With Label</h2>
							<!-- progress -->
							<div class="progress">
								<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">60%</div>
							</div>
							<div class="divider-line2"></div>
							<h2 class="heading-v5">Contextual alternatives</h2>
							<!-- progress -->
							<div class="progress">
							...
							<div class="divider-line2"></div>
							<h2 class="heading-v5">Striped</h2>
							<!-- progress -->
							...
							<div class="divider-line2"></div>
							<h2 class="heading-v5">Animated</h2>
							<!-- progress -->
							...
							<div class="divider-line2"></div>
							<h2 class="heading-v5">Stacked</h2>
							<!-- progress -->
							<div class="progress">
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-pagination.html"><i class="fa fa-caret-right"></i> Pagination</a></li>
