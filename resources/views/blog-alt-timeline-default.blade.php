	...
	<div id="wrapper">
		<div class="w1">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="blog-alt-timeline-default.html">DEFAULT</a></li>
			...
			<main id="main" role="main" class="ajax-area">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG alt timeline</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<!-- personal exper -->
				<section class="personal-exper padding-top-100 style3">
					<div id="ajax-holder">
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
									<div class="p-holder" data-animate="fadeInUp" data-delay="200">
										...
										<div class="box">
											<div class="img-box">
												<a href="blog-single-image.html"><img src="http://placehold.it/530x200" alt="image description" class="img-responsive"></a>
											</div>
						...
						<div class="container text-center">
							<div class="row">
								<div class="col-xs-12">
								<nav class="blog-footer style2">
									<a href="inc/items03.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
						</div>
					</div>
