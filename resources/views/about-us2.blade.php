	...
	<div id="wrapper">
		<div class="w1">
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li class="active"><a href="#">about us 2</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<section class="services-section style6 container">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-6 hidden-xs hidden-sm">
							<img src="http://placehold.it/966x653" alt="image description" class="img" data-animate="fadeInRight" data-delay="200">
						</div>
					</div>
				</section>
				<!-- counter section -->
				...
				<!-- container -->
				<section class="padding-top-90 padding-bottom-90 bg-grey">
					<div class="container">
	                    <!-- page heading small -->
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6 col-md-4 padding-top-60 padding-sm-topzero">
								<!-- f iconbox -->
								<div class="f-iconbox right padding-bottom-30" data-animate="fadeInUp" data-delay="100">
								...
								<!-- f iconbox -->
								<div class="f-iconbox right padding-bottom-30" data-animate="fadeInUp" data-delay="150">
									<span class="icon"><i class="fa fa-cog"></i></span>
									<span class="title">Theme Options</span>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
								</div>
								<!-- f iconbox -->
								<div class="f-iconbox right padding-bottom-30" data-animate="fadeInUp" data-delay="200">
							...
							<div class="col-xs-12 col-md-4 hidden-sm hidden-xs">
								<img src="http://placehold.it/370x511" alt="image description" class="img-responsive margin-zero">
							</div>
							<div class="col-xs-12 col-sm-6 col-md-4 padding-top-60 padding-sm-topzero">
								<!-- f iconbox -->
								<div class="f-iconbox padding-bottom-30" data-animate="fadeInUp" data-delay="250">
									<span class="icon"><i class="fa fa-eye"></i></span>
									<span class="title">Retina Ready</span>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
								</div>
								<!-- f iconbox -->
								<div class="f-iconbox padding-bottom-30" data-animate="fadeInUp" data-delay="300">
									<span class="icon"><i class="fa fa-life-ring"></i></span>
									<span class="title">Great Support</span>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
								</div>
								<!-- f iconbox -->
								<div class="f-iconbox padding-bottom-30" data-animate="fadeInUp" data-delay="350">
						...
						<div class="col-xs-12">
							...
							<div class="partners-block line-box">
                                ...
                                <ul class="partners-nav line list-inline">
                                    <li><a href="clients.html"><img src="http://placehold.it/160x40" alt="graphicriver"></a></li>
                                    <li><a href="clients.html"><img src="http://placehold.it/160x40" alt="graphicriver"></a></li>
                                    <li><a href="clients.html"><img src="http://placehold.it/160x40" alt="graphicriver"></a></li>
                                    <li><a href="clients.html"><img src="http://placehold.it/160x40" alt="graphicriver"></a></li>
                                    <li><a href="clients.html"><img src="http://placehold.it/160x40" alt="graphicriver"></a></li>
