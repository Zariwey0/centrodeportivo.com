															...
															<div class="drop">
																<ul class="list-unstyled">
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="blog-grids-2column.html">2 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog grids 2 column</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							<div class="col-xs-12">
								<div class="blog-masonry-holder full-width" id="masonry-container">
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style5 item">
										<div class="img-box">
												...
												<div class="beans-mask">
													<div class="beans-slideset">
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/565x385" alt="image description" class="img-responsive"></a>
														</div>
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/565x385" alt="image description" class="img-responsive"></a>
														</div>
									...
									<article class="blog-post-v1 style5 item">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/565x275" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
									...
									<article class="blog-post-v1 style5 item">
										...
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Video post</a></h2>
											<ul class="meta list-inline">
												<li>
													<i class="fa fa-user"></i>
													By <a href="blog-single-video-vimeo.html">Admin name</a>
									...
									<article class="blog-post-v1 style5 item">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/565x355" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
								...
								<nav class="blog-footer style2 text-center">
									<a href="blog-grids-2column.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
						</div>
					</div>
