	...
	<div id="wrapper">
		<div class="w1">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="blog-timeline-default.html">DEFAULT</a></li>
			...
			<main id="main" role="main">
				...
				<!-- love story -->
				<section class="love-story padding-top-100">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="row-holder">
									...
									<div class="box" data-animate="fadeInUp" data-delay="300">
										<a href="blog-single-image.html"><img src="http://placehold.it/370x220" alt="image description" class="img-responsive"></a>
										<div class="text-box">
