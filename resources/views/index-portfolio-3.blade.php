...
<body>
	...
	<div id="wrapper" class="no-boxed">
		<div class="w1">
			<!-- header of the page -->
			<header id="header" class="style24">
												...
												<div class="drop-holder">
													...
													<div class="coll">
														...
														<ul class="list-unstyled">
															...
															<li class="active"><a href="index-portfolio-3.html">Home - Portfolio 3</a></li>
			...
			<main id="main" role="main">
				<!-- beans fadeslider port slider -->
				<div class="beans-fadeslider win-height port-slider">
					<div class="slideset">
               ...
               <div class="personal-about">
                   <div class="container">
                       ...
                       <header class="page-heading">
                           <h2 class="heading lime text-capitalize font-medium">Awesome Team</h2>
                       </header>
                       <div class="row">
                           <div class="col-xs-12 col-md-8 col-md-offset-2">
                               <p class="margin-zero">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo  enim ipsam voluptatem quia voluptas sit aspernatur. Lorem Ipsum is simply dummy text of the printing and  typesetting industry. Lorem Ipsum has been the industry's standard.</p>
                            </div>
                       </div>
                    </div>
                </div>
				...
				<div class="work-section padding-bottom-60">
                    ...
                    <div class="portfolio-block nospace coll-2">
                        <!-- box -->
                        <div class="box">
                                ...
                                <div class="holder">
                                    <div class="frame">
                                        <div class="over-frame">
                                            ...
                                            <strong class="title upper no-bg">The Have</strong>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <img src="http://placehold.it/952x952" alt="image description" class="img-responsive">
                        </div>
                    </div>
                            ...
                            <a href="portfolio-single-image.html" class="over">
                                <div class="holder">
                                    <div class="frame">
                                        <div class="over-frame">
                                            <span class="plus">+</span>
                                            <strong class="title upper no-bg">some awosome work</strong>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="portfolio-single-image.html" class="over">
                                <div class="holder">
                                    <div class="frame">
                                        <div class="over-frame">
                                            <span class="plus">+</span>
                                            <strong class="title upper no-bg">our products</strong>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="portfolio-single-image.html" class="over">
                                <div class="holder">
                                    <div class="frame">
                                        <div class="over-frame">
                                            <span class="plus">+</span>
                                            <strong class="title upper no-bg">cover Design</strong>
                                        </div>
                                    </div>
                                </div>
                            </a>
				...
				<!-- twitter section -->
				<div class="twitter-section dark-bottom-border bg-grey">
					<div class="container">
						<!-- beans-slider -->
							...
							<div class="col-xs-12">
								...
								<div class="bottom-box3">
									...
									<div class="f-info-box">
										...
										<a href="tel:01234567890" class="tel add">01234-567-890</a>
										<p>ENVATO ,LEVEL 13, 2 ELIZABETH ST, <br>MELBOURNE, VICTORIA 3000, <br>AUSTRALIA</p>
										<div class="row">
