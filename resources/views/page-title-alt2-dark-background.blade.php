	...
	<div id="wrapper">
		<div class="w1">
																	...
																	<li class="active">
																		...
																		<div class="drop right-align">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="page-title-alt2-dark-background.html">dark background</a></li>
			...
			<main id="main" role="main">
                <!-- page banner -->
				<header class="page-banner style2 dark dark-bottom-border">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li class="active"><a href="#">page title alt2 dark background</a></li>
								</ul>
							</div>
						</div>
				    </div>
