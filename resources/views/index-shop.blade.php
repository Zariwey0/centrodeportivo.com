						...
						<div class="col-xs-12 header-top">
							...
							<nav class="top-nav">
								<ul class="list-inline">
									...
									<li><a href="shop-checkout.html">WISHLIST</a></li>
									<li><a href="shop-cart.html">checkout</a></li>
									<!-- cart box -->
									<li class="cart-box">
										<a href="#">
											<i class="fa fa-shopping-cart"></i>
											<span class="cart-num">cart (10)</span>
										</a>
										<!-- cart drop -->
										<div class="cart-drop">
													...
													<div class="drop-holder">
														<div class="coll">
															...
															<ul class="list-unstyled">
																...
																<li class="active"><a href="index-shop.html">Home - Shop</a></li>
														...
														<li>
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li>
																		<a href="portfolio-single-image.html">without space</a>
																		<div class="drop">
																			<ul class="list-unstyled">
			...
			<main id="main" role="main">
									...
									<div class="row">
										<div class="col-xs-12 shop-content win-height">
											<header class="shop-heading">
												<h1><span class="txt">GET 50% OFf</span> on orders of $99</h1>
												<div class="button-slider">
													<a href="shop-grid-4column.html" class="btn btn-f-default">VIEW MEN</a>
													<a href="shop-grid-3column-leftsidebar.html" class="btn btn-f-default">VIEW WOMEN</a>
												</div>
											</header>
										</div>
									</div>
				...
				<section class="container product-section">
                    ...
                    <header class="page-heading small">
                       <div class="heading">
                            <p class="text-uppercase">Our favorite items</p>
                            <h3 class="heading5 lime text-capitalize font-medium">NEW PRODUCTS</h3>
                        </div>
                    </header>
					<div class="row product-nav-holder">
						<div class="col-xs-12">
							<ul class="product-nav list-inline tabset">
								...
								<li class="active"><a href="#tab2">WOMEN</a></li>
								<li><a href="#tab3">watches</a></li>
								<li><a href="#tab4">SHOES</a></li>
								<li><a href="#tab5">LEATHERS</a></li>
							</ul>
						</div>
					</div>
					<div class="row">
						...
						<div class="row">
							<section class="col-xs-12 special-content">
								<div class="special-box">
									...
									<a href="http://fekra.csshunter.com" class="btn btn-f-default">GET IT NOW</a>
								</div>
							</section>
						</div>
					</div>
				...
				<section class="container product-section seller">
                    <!-- page heading -->
                    <header class="page-heading small">
                       <div class="heading">
                            <p class="text-uppercase">Our TOP PRODUCTS</p>
                            <h3 class="heading5 lime text-capitalize font-medium">BEST SELLERS</h3>
                        </div>
                    </header>
					<div class="row best-seller">
						<div class="col-sm-3 col-xs-12" data-animate="fadeInUp" data-delay="300">
							<!-- new-product -->
							<article class="new-product">
								<div class="product-img">
									<img src="http://placehold.it/270x270" alt="image description">
									<div class="product-over">
										<div class="frame">
											<div class="box">
												<a href="images/placeholder.jpg" class="btn lightbox btn-f-default">QUICK VIEW</a>
				...
				<div class="bg-grey padding-top-90 padding-bottom-90">
					<div class="container">
						<div class="row">
							<div class="col-sm-4 col-xs-12" data-animate="fadeInUp" data-delay="200">
								<article class="other-services">
									<h2><a href="#"><i class="fa fa-truck"></i>Free Shipping</a></h2>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
								</article>
							</div>
							<div class="col-sm-4 col-xs-12" data-animate="fadeInUp" data-delay="300">
								<article class="other-services">
									<h2><a href="#"><i class="fa fa-money"></i>Money Back</a></h2>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
								</article>
							</div>
							<div class="col-sm-4 col-xs-12" data-animate="fadeInUp" data-delay="400">
								<article class="other-services">
									<h2><a href="#"><i class="fa fa-phone"></i>Hot Line</a></h2>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
								</article>
							</div>
						</div>
				...
				<div class="padding-top-90 padding-bottom-90">
                    ...
                    <div class="line-box">
                        <!-- partners nav large -->
                        <ul class="partners-nav line large list-inline">
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/170x70" alt="image"></a></div></li>
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/170x70" alt="image"></a></div></li>
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/170x70" alt="image"></a></div></li>
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/170x70" alt="image"></a></div></li>
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/170x70" alt="image"></a></div></li>
				...
				<div class="padding-top-90 padding-bottom-60 bg-grey">
					<div class="container">
						<div class="row">
				            <!-- shop features -->
							<section class="col-sm-6 col-md-3 col-xs-12 margin-bottom-30 shop-features hot">
								<h2>HOT DEALS</h2>
								<!-- beans-slider -->
								<div class="deal-gallery beans-slider" data-rotate="true">
									<div class="beans-mask">
										<div class="beans-slideset">
											<!-- beans-slide -->
											<div class="beans-slide">
												<div class="deal-img">
													<img src="http://placehold.it/268x268" alt="image description">
													<a href="#" class="btn-sale">Sale</a>
												</div>
												<div class="deal-box">
													<div class="deal-row">
														<a href="shop-single.html" class="name">Product Name</a>
														<ul class="rattings-nav list-inline">
															<li><i class="fa fa-star"></i></li>
															<li><i class="fa fa-star"></i></li>
															<li><i class="fa fa-star"></i></li>
													...
													<div class="deal-row">
														<span class="price cancel">$99.00</span>
				            ...
				            <!-- shop features -->
							<div class="col-sm-6 col-md-3 col-xs-12 margin-bottom-30 shop-features">
								<h2>FEATURED PRODUCTS</h2>
								<div class="features-box">
									<!-- product-article -->
									<article class="product-article">
										<div class="alignleft">
											<a href="shop-single.html"><img src="http://placehold.it/98x98" alt="image description"></a>
										</div>
										<div class="txt-box">
				            ...
				            <!-- shop features -->
							<div class="col-sm-6 col-md-3 col-xs-12 margin-bottom-30 shop-features clearfix-sm">
								<h2>Latest Blogs</h2>
								<div class="features-box">
									<!-- product-article -->
									<article class="product-article blog">
										<div class="alignleft">
											<a href="blog-single-image.html"><img src="http://placehold.it/98x98" alt="image description"></a>
										</div>
										<div class="txt-box">
											<h3><a href="blog-single-image.html">Blog Title Name Here</a></h3>
											<time datetime="2015-01-01">19 March, 2015</time>
											<p>Lorem Ipsum is simply dummy text of the ands typesetting industry.</p>
										</div>
									</article>
									<!-- product-article -->
									<article class="product-article blog">
				            ...
				            <!-- shop features -->
							<nav class="col-sm-6 col-md-3 col-xs-12 margin-bottom-30 shop-features">
								<h2>USEFUL LINKS</h2>
								<div class="features-box links">
									<h3>Information</h3>
									<ul class="list-unstyled links-nav">
										<li><a href="#"><i class="fa fa-angle-right"></i>New products</a></li>
										<li><a href="#"><i class="fa fa-angle-right"></i>Top sellers</a></li>
										<li><a href="#"><i class="fa fa-angle-right"></i>Manufactirers</a></li>
									...
									<ul class="list-unstyled links-nav">
										...
										<li><a href="shop-cart.html"><i class="fa fa-angle-right"></i>Wishlist</a></li>
										<li><a href="shop-checkout.html"><i class="fa fa-angle-right"></i>Checkout</a></li>
										<li><a href="#"><i class="fa fa-angle-right"></i>Account Setting</a></li>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="holder2">
                                    ...
                                    <a href="about-us.html" class="btn btn-more">READ MORE</a>
                                </div>
                            </div>
                        </div>
					</div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="bottom-box1">
                                    <ul class="list-inline payment-nav">
                                        <li><a href="#"><img src="http://placehold.it/38x28" alt="image"></a></li>
                                        <li><a href="#"><img src="http://placehold.it/38x28" alt="image"></a></li>
                                        <li><a href="#"><img src="http://placehold.it/38x28" alt="image"></a></li>
                                        <li><a href="#"><img src="http://placehold.it/38x28" alt="image"></a></li>
                                    </ul>
