														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="portfolio-layout-both-sidebar.html">both SIDEBAR</a></li>
																</ul>
															</div>
														</li>
														<li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO GIRD both sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
								...
								<div class="icotop-holder margin-bottom-60">
                                    ...
                                    <div class="portfolio-block coll-2 nospace">
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="stretch">
                               					<img src="http://placehold.it/285x285" alt="image description">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- portfolio block coll-2 nospace -->
