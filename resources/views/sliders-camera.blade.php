...
<head>
	...
	<!-- include the site stylesheet of camera slider  -->
	<link media="all" rel="stylesheet" href="css/camera.css">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#">Camera Slider</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="camera_wrap camera_azure_skin" id="camera_wrap_1">
									<div data-src="http://placehold.it/1160x580">
