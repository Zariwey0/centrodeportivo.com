																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="portfolio-2columns-nospace.html">2 column</a></li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO GIRD 2 COLUMN no space</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<section class="work-section padding-top-90 padding-bottom-90 space">
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        ...
                        <div class="portfolio-block coll-2 nospace work-design">
                            <!-- box -->
                            <div class="box">
                                ...
                                <div class="stretch">
                                    <img src="http://placehold.it/600x600" alt="image description">
                                </div>
                            </div>
                        </div>
                        <!-- portfolio block coll-2 nospace -->
