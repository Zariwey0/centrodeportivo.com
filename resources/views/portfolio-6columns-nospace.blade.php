																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="portfolio-6columns-nospace.html">6 column</a></li>
																			</ul>
																		</div>
																	</li>
																</ul>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO masonry 6 column no space</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<section class="work-section padding-top-90 padding-bottom-90">
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        ...
                        <div class="portfolio-block coll-6 nospace work-design">
                            <!-- box -->
                            <div class="box">
                                ...
                                <img src="http://placehold.it/320x320" alt="image description" class="img-responsive">
                            </div>
                        </div>
                        <!-- portfolio block coll-6 nospace -->
                        <div class="portfolio-block coll-6 nospace work-products">
                            <!-- box -->
                            <div class="box">
                                <a href="portfolio-single-image.html" class="over">
                                    <div class="holder">
                        ...
                        <!-- portfolio block coll-6 nospace -->
                        <div class="portfolio-block coll-6 nospace work-illustration">
                            <!-- box -->
                            <div class="box">
                                <a href="portfolio-single-image.html" class="over">
                                    <div class="holder">
                        ...
                        <!-- portfolio block coll-6 nospace -->
                        <div class="portfolio-block coll-6 nospace work-fashion">
                            <!-- box -->
                            <div class="box">
                                <a href="portfolio-single-image.html" class="over">
                                    <div class="holder">
                        ...
                        <div class="portfolio-block coll-6 nospace work-illustration">
                            ...
                            <div class="box">
                                ...
                                <div class="stretch">
                             	   <img src="http://placehold.it/320x320" alt="image description">
                                </div>
                            </div>
                        </div>
                        <!-- portfolio block coll-6 nospace -->
