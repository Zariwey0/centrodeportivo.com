	...
	<div id="wrapper">
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-pricing-boxes.html"><i class="fa fa-bolt"></i> PRICING BOXES</a></li>
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">pricing box</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">pricing box</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<section class="price-section style2 padding-top-100">
					<div class="container">
						<div class="row">
				...
				<section class="price-section">
					...
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x1200" height="1173" width="1920" alt="image description"></div>
					</div>
				</section>
				...
				<section class="price-section style4">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6 col-md-3">
								...
								<div class="box">
									...
									<a href="#" class="btn btn-purchase">ORDER NOW</a>
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-3">
								<!-- box -->
					...
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x1200" height="1131" width="1698" alt="image description"></div>
					</div>
				</section>
			</main>
			<!-- footer of the page -->
