													...
													<div class="drop-holder">
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-animations.html"><i class="fa fa-certificate"></i> ANIMATION</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Animation</h1>
								</div>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							...
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro, libero, temporibus quam eaque numquam debitis excepturi assumenda necessitatibus dolore dolorum vero enim distinctio ipsa. Quod, dolorum, quidem eum quisquam facilis nam molestias et voluptas omnis quibusdam dignissimos illum ullam. Possimus consectetur veniam fugit libero pariatur illum eos tempora repudiandae dolorum non. Adipisci, porro, natus hic expedita sed eius provident incidunt fugit autem alias quod ratione et reprehenderit architecto qui ea.</p>
								</div>
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="bounce">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="flash">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="pulse">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="shake">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="swing">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="tada">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="wobble">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="bounceIn">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Bounce-In-Down Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="bounceInDown">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Bounce-In-Left Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="bounceInLeft">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="bounceInRight">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="bounceInUp">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="fadeInDown">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Fade-In-Down-Big Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="fadeInDownBig">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Fade-In-Down-Left Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="fadeInLeft">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Fade-In-Right-Big Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="fadeInRightBig">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="fadeInRight">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="fadeInUpBig">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Fade-In-Up-Big Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9">
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="flip">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="flipInX">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="flipInY">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Light-Speed-In Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="lightSpeedIn">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Slide-In-Right Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="slideInRight">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="slideInLeft">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Slide-In-Down Animationz</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="slideInDown">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Rotate-In-Up-Right Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="rotateInUpRight">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Rotate-In-Up-Left Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="rotateInUpLeft">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Rotate-In-Down-Right Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="rotateInDownRight">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12">
									<h3>Rotate-In-Down-Left Animation</h3>
								</div>
							</div>
							<div class="row padding-bottom-30">
								<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="rotateInDownLeft">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="rotateIn">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9" data-animate="rollIn">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
							<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
							...
							<div class="row padding-bottom-30">
								...
								<div class="col-xs-12 col-sm-4 col-md-3" data-animate="fadeIn" data-delay="3000">
									<img src="http://placehold.it/195x115" alt="Image description" class="img-responsive"/>
								</div>
							</div>
						</div>
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								<h2>Pages</h2>
								<ul class="list-unstyled">
									<li class="active"><a href="shortcode-animations.html"><i class="fa fa-caret-right"></i> Animations</a></li>
									...
									<li><a href="shortcode-clients.html"><i class="fa fa-caret-right"></i> Clients</a></li>
									...
									<li><a href="shortcode-social-icons.html"><i class="fa fa-caret-right"></i> Social Icons</a></li>
									...
									<li><a href="shortcode-testimonials.html"><i class="fa fa-caret-right"></i> Testimonials</a></li>
