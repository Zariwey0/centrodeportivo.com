		...
		<div class="w1">
												...
												<div class="mega-drop">
													<div class="drop-holder">
														...
														<div class="coll">
															...
															<ul class="list-unstyled">
																<li class="active"><a href="layout-full-widthwide.html">LAYOUT WIDE</a></li>
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Full Width Fluid Layout</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">pages</a></li>
									<li class="active"><a href="#">Full Width Fluid Layout</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container-fluid padding-bottom-100 padding-top-100">
                   <div class="row">
						<div class="col-xs-12">
							<h3 class="margin-t-zero">Full Width</h3>
