			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-inline breadcrumbs">
									...
									<li class="active"><a href="#">PORTFOLIO VERTICAL 5 COLUMN no space</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<section class="work-section padding-top-100 padding-bottom-100 bg-grey dark-bottom-border">
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        <!-- portfolio block nospace coll-5 -->
                        <div class="portfolio-block nospace coll-5 work-design">
                            <!-- box -->
                            <div class="box">
                                ...
                                <div class="stretch">
                                    <img src="http://placehold.it/330x330" alt="image description">
                                </div>
                            </div>
                        </div>
                        <!-- portfolio block nospace coll-5 -->
                        <div class="portfolio-block nospace coll-5 work-fashion">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <div class="over">
                        ...
                        <!-- portfolio block nospace coll-5 -->
                        <div class="portfolio-block nospace coll-5 work-illustration">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <div class="over">
                        ...
                        <!-- portfolio block nospace coll-5 -->
                        <div class="portfolio-block nospace coll-5 work-products">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <div class="over">
