																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="portfolio-5columns-nospace.html">5 column</a></li>
			...
			<main id="main" role="main">
				...
				<section class="work-section padding-top-90 padding-bottom-90">
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        <!-- portfolio block coll-5 nospace -->
                        <div class="portfolio-block coll-5 nospace work-design">
                            <!-- box -->
                            <div class="box">
                                ...
                                <div class="stretch">
                                    <img src="http://placehold.it/381x381" alt="image description">
                                </div>
                            </div>
                        </div>
                        <!-- portfolio block coll-5 nospace -->
                        <div class="portfolio-block coll-5 nospace work-fashion">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <a href="portfolio-single-image.html" class="over">
                        ...
                        <!-- portfolio block coll-5 nospace -->
                        <div class="portfolio-block coll-5 nospace work-illustration">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <a href="portfolio-single-image.html" class="over">
                        ...
                        <!-- portfolio block coll-5 nospace -->
                        <div class="portfolio-block coll-5 nospace work-products">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <a href="portfolio-single-image.html" class="over">
