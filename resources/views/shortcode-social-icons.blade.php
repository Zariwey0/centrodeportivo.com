													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-social-icons.html"><i class="fa fa-bolt"></i> SOCIAL ICONS</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">social icons</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">social icons</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
                            ...
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">FONTAWESOME</h2>
                            </header>
							<!-- s-network -->
							<ul class="s-network margin-bottom-30 cricle-icons white-icons">
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">IMAGES</h2>
                            </header>
							<!-- s-network -->
							<ul class="s-network margin-bottom-30">
								<li><a href="#"><img src="images/socials/arim.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/bebo.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/behance.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/blogger.png" alt=""></a></li>
								<li><a href="#"><img src="img/socials/delicious.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/deviantart.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/digg.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/facebook.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/fastfm.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/flikr.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/formspring.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/google_plus.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/linkedin.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/myspace.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/path.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/pinterest.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/quora.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/rss.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/stumblepun.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/technorati.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/vimeo.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/wordpress.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/yelp.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/youtube.png" alt=""></a></li>
							</ul>
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">CRICLE IMAGES</h2>
                            </header>
							<!-- s-network -->
							<ul class="s-network cricle-icons margin-bottom-30">
								<li><a href="#"><img src="images/socials/arim.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/bebo.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/behance.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/blogger.png" alt=""></a></li>
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">CORNER ICONS</h2>
                            </header>
							<!-- s-network -->
							<ul class="s-network margin-bottom-30 radius-icons white-icons">
								<li><a href="#"><i class="fa fa-facebook"></i></a></li>
								<li><a href="#"><i class="fa fa-twitter"></i></a></li>
								<li><a href="#"><i class="fa fa-dribbble"></i></a></li>
								<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">CORNER IMAGES</h2>
                            </header>
							<!-- s-network -->
							<ul class="s-network margin-bottom-30 radius-icons">
								<li><a href="#"><img src="img/socials/arim.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/bebo.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/behance.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/blogger.png" alt=""></a></li>
								<li><a href="#"><img src="images/socials/delicious.png" alt=""></a></li>
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">TOOLTIPS ICONS</h2>
                            </header>
							<!-- s-network -->
							<ul class="s-network cricle-icons white-icons">
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="facebook"><i class="fa fa-facebook"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="twitter"><i class="fa fa-twitter"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="dribbble"><i class="fa fa-dribbble"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="linkedin"><i class="fa fa-linkedin"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="google plus"><i class="fa fa-google-plus"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="youtube"><i class="fa fa-youtube"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="rss"><i class="fa fa-rss"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="skype"><i class="fa fa-skype"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="apple"><i class="fa fa-apple"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="android"><i class="fa fa-android"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="soundcloud"><i class="fa fa-soundcloud"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="behance"><i class="fa fa-behance"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="vimeo"><i class="fa fa-vimeo-square"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="instagram"><i class="fa fa-instagram"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="pinterest"><i class="fa fa-pinterest"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="tumblr"><i class="fa fa-tumblr"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="windows"><i class="fa fa-windows"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="paypal"><i class="fa fa-paypal"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="deviantart"><i class="fa fa-deviantart"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="digg"><i class="fa fa-digg"></i></a></li>
								<li><a href="#" data-thumb="tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="lastfm"><i class="fa fa-lastfm"></i></a></li>
							</ul>
						</div>
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								<h2>Pages</h2>
								<ul class="list-unstyled">
									<li><a href="shortcode-animations.html"><i class="fa fa-caret-right"></i> Animations</a></li>
									<li><a href="shortcode-buttons.html"><i class="fa fa-caret-right"></i> Buttons</a></li>
									<li><a href="shortcode-carousel.html"><i class="fa fa-caret-right"></i> Carousel</a></li>
									<li><a href="shortcode-columns.html"><i class="fa fa-caret-right"></i> Columns</a></li>
									<li><a href="shortcode-counters.html"><i class="fa fa-caret-right"></i> Counters</a></li>
									<li><a href="shortcode-dividers.html"><i class="fa fa-caret-right"></i> Dividers</a></li>
									<li><a href="shortcode-icon-boxes.html"><i class="fa fa-caret-right"></i> Icon Boxes</a></li>
									<li><a href="shortcode-galleries.html"><i class="fa fa-caret-right"></i> Galleries</a></li>
									<li><a href="shortcode-heading-styles.html"><i class="fa fa-caret-right"></i> Heading Styles</a></li>
									<li><a href="shortcode-icon-lists.html"><i class="fa fa-caret-right"></i> Icon Lists</a></li>
									<li><a href="shortcode-labels.html"><i class="fa fa-caret-right"></i> Labels</a></li>
									<li><a href="shortcode-lightbox.html"><i class="fa fa-caret-right"></i> Lightbox</a></li>
									<li><a href="shortcode-lists-panels.html"><i class="fa fa-caret-right"></i> Lists &amp; Panels</a></li>
									<li><a href="shortcode-maps.html"><i class="fa fa-caret-right"></i> Maps</a></li>
									<li><a href="shortcode-media-embeds.html"><i class="fa fa-caret-right"></i> Media Embeds</a></li>
									<li><a href="shortcode-modal-boxes.html"><i class="fa fa-caret-right"></i> Modal Boxes</a></li>
									<li><a href="shortcode-navigations.html"><i class="fa fa-caret-right"></i> Navigations</a></li>
									<li><a href="shortcode-pagination.html"><i class="fa fa-caret-right"></i> Pagination</a></li>
									<li><a href="shortcode-pies-skills.html"><i class="fa fa-caret-right"></i> Pies &amp; Skills</a></li>
									<li><a href="shortcode-pricing-boxes.html"><i class="fa fa-caret-right"></i> Pricing Boxes</a></li>
									<li><a href="shortcode-process-steps.html"><i class="fa fa-caret-right"></i> Process Steps</a></li>
									<li><a href="shortcode-promo-boxes.html"><i class="fa fa-caret-right"></i> Promo Boxes</a></li>
									<li><a href="shortcode-blockquotes.html"><i class="fa fa-caret-right"></i> Blockquotes</a></li>
									<li><a href="shortcode-responsive.html"><i class="fa fa-caret-right"></i> Responsive</a></li>
									<li class="active"><a href="shortcode-social-icons.html"><i class="fa fa-caret-right"></i> Social Icons</a></li>
									<li><a href="shortcode-alert-boxes.html"><i class="fa fa-caret-right"></i> Alert Boxes</a></li>
									<li><a href="shortcode-tables.html"><i class="fa fa-caret-right"></i> Tables</a></li>
									<li><a href="shortcode-tabs.html"><i class="fa fa-caret-right"></i> Tabs</a></li>
									<li><a href="shortcode-thumbnails.html"><i class="fa fa-caret-right"></i> Thumbnails</a></li>
									<li><a href="shortcode-toggles.html"><i class="fa fa-caret-right"></i> Toggles</a></li>
									<li><a href="shortcode-sections.html"><i class="fa fa-caret-right"></i> Sections</a></li>
								</ul>
							</section>
						</aside>
					</div>
