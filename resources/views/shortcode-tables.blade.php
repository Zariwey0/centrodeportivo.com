													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-tables.html"><i class="fa fa-bolt"></i> TABLES</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">tables</h1>
								</div>
				...
				<div class="container padding-top-100 padding-bottom-100">
					<div class="row">
                        ...
                        <header class="page-heading">
                            <h2 class="heading lime text-capitalize font-medium">Striped Rows</h2>
                        </header>
                        ...
                        <!-- page heading -->
                        <header class="page-heading">
                            <h2 class="heading lime text-capitalize font-medium">Bordered table</h2>
                        </header>
                        ...
                        <!-- page heading -->
                        <header class="page-heading">
                            <h2 class="heading lime text-capitalize font-medium">Hover rows</h2>
                        </header>
                        ...
                        <!-- page heading -->
                        <header class="page-heading">
                            <h2 class="heading lime text-capitalize font-medium">Contextual classes</h2>
                        </header>
                        <div class="table-responsive">
                          ...
                          <table class="table margin-bottom-30">
                            ...
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Responsive Tables</h2>
                            </header>
                            <div class="table-responsive">
                              <table class="table">
                                <thead>
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-tables.html"><i class="fa fa-caret-right"></i> Tables</a></li>
