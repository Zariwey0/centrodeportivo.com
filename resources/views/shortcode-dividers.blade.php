											...
											<li class="active">
												...
												<div class="mega-drop">
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																<li class="active"><a href="shortcode-dividers.html"><i class="fa fa-bolt"></i> DIVIDERS</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">dividers</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">dividers</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container divider-section padding-top-100">
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							<div class="row">
								<div class="col-xs-12">
									<h2 class="heading-v5 text-uppercase"><span>divider styles</span></h2>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-12">
									<div class="divider-line1"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line2"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line3"><i class="fa fa-paper-plane"></i></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line4"><i class="fa fa-heart"></i></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line5"><i class="fa fa-hand-o-down"></i></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line6"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line7"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line8"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line9"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line10"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line11"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line12"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
									<div class="divider-line13"></div>
									<p>Fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will  many web sites still in their infancy  versions have evolved over the years by sometimes on purpose.</p>
								</div>
							</div>
						</div>
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-dividers.html"><i class="fa fa-caret-right"></i> Dividers</a></li>
