...
<body>
	<div id="pre-loader">
        <div class="loader-holder">
            <div class="frame">
                <img src="images/preloader/logo.png" alt="Fekar"/>
                <div class="spinner7">
                    <div class="circ1"></div>
                    <div class="circ2"></div>
                    <div class="circ3"></div>
	...
	<div id="wrapper" class="no-boxed">
		<div class="w1">
												...
												<div class="drop-holder">
													<div class="coll">
														...
														<ul class="list-unstyled">
															...
															<li class="active"><a href="index-home-parallax.html">Home - Parallax</a></li>
			...
			<main id="main">
				<!-- parallax section -->
				<section class="win-height parallax-section">
					<!-- parallax-holder -->
					...
					<div class="over">
						<div class="over-holder">
							<div class="over-frame">
								<div class="container">
									<div class="row">
										<div class="col-xs-12">
											<h2>We Are Creative Studio Team</h2>
						...
						<a href="#section2" class="next-section smoothanchor"><i class="fa fa-angle-down"></i></a>
					</div>
				</section>
				<!-- parallax section -->
				<section class="win-height parallax-section" id="section2">
					<!-- parallax-holder -->
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x1000" height="1000" width="1920" alt="image description"></div>
					</div>
								...
								<div class="container">
									<div class="row">
										<div class="col-xs-12 col-sm-6 text-left">
											<h3>We Grow Success <br>for your Business</h3>
											...
											<a href="#section3" class="scroll smoothanchor">SCROLL TO DOWN <i class="fa fa-long-arrow-down"></i></a>
										</div>
									</div>
								</div>
							</div>
				...
				<!-- parallax section -->
				<section class="win-height parallax-section" id="section3">
					<!-- parallax-holder -->
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x1000" height="1000" width="1920" alt="image description"></div>
					</div>
					<div class="over">
						<div class="over-holder">
							<div class="over-frame">
								<div class="container">
									<div class="row">
										<div class="col-xs-12 col-sm-6 text-left col-sm-push-6">
											<h3>We Work Hard For <br>Build Your Dreams</h3>
											<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.</p>
											<a href="#section4" class="scroll add smoothanchor">SCROLL TO DOWN <i class="fa fa-long-arrow-down"></i></a>
										</div>
									</div>
								</div>
							</div>
				...
				<!-- parallax section -->
				<section class="win-height parallax-section" id="section4">
					<!-- parallax-holder -->
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x1000" height="1000" width="1920" alt="image description"></div>
					</div>
						...
						<div class="over-holder">
							<div class="over-frame">
								<div class="container">
									<div class="row">
										<div class="col-xs-12">
											<h2>ALL ABOUT PARALLAX EFFECTS</h2>
											<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in <br>some form, by injected humour</p>
										</div>
									</div>
								</div>
