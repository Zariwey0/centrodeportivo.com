																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="portfolio-5columns.html">5 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO masonry 5 column</a></li>
								</ul>
							</div>
						</div>
				    </div>
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        ...
                        <div class="portfolio-block coll-5 work-design">
                            ...
                            <div class="box">
                                ...
                                <div class="stretch">
                                    <img src="http://placehold.it/345x345" alt="image description">
                                </div>
                            </div>
                        </div>
                        <!-- portfolio block coll-5 -->
