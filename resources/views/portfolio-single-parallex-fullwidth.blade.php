		...
		<div class="w1">
														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="portfolio-single-parallex-fullwidth.html">parallax full width</a></li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO single parallex fullwidth</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<section class="port-single padding-top-100">
					...
					<section class="port-parallex margin-bottom-60">
						<div class="parallax-holder">
							<div class="parallax-frame"><img src="http://placehold.it/1920x800" height="800" width="1920" alt="image description"></div>
						</div>
					</section>
