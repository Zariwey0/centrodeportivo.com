														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="blog-full-width-accordion-bothsidebar.html">BOTH  SIDEBAR</a></li>
																</ul>
															</div>
														</li>
														<li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG FULL WIDTH accordion both sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12 col-md-6 col-md-push-3 blog-section padding-zero">
							...
							<ul class="blog-accordion list-unstyled">
								...
								<li class="blog-m-post accordion">
									<a href="blog-single-image.html" class="opener"><img src="http://placehold.it/600x200" alt="image description" class="img-responsive"></a>
									<div class="blog-txt">
							...
							<section class="widget toppost-widget">
								...
								<div class="tab-content">
									<div id="tab1">
										<article class="box">
											<div class="img-box">
												<img src="http://placehold.it/65x65" alt="image description">
											</div>
											<div class="holder">
