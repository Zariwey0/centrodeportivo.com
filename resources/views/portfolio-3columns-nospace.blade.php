																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="portfolio-3columns-nospace.html">3 column</a></li>
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        ...
                        <div class="portfolio-block coll-3 nospace work-design">
                            ...
                            <div class="box">
                                ...
                                <div class="stretch">
                                    <img src="http://placehold.it/400x400" alt="image description">
                                </div>
                            </div>
                        </div>
                        <!-- portfolio block coll-3 nospace -->
                        <div class="portfolio-block coll-3 nospace work-fashion">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <a href="portfolio-single-image.html" class="over">
