																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-grids-fullwidth.html">Full width</a></li>
																			</ul>
																		</div>
																	</li>
																	<li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog grids full width</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							<div class="col-xs-12">
								...
								<div class="blog-masonry-holder full-width" id="masonry-container">
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style3 item">
										<div class="img-box">
									...
									<article class="blog-post-v1 style3 item">
										<div class="img-box">
											<a href="blog-single-slider.html"><img src="http://placehold.it/345x170" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
									...
									<article class="blog-post-v1 style3 item">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/345x220" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
									...
									<article class="blog-post-v1 style3 item">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/345x160" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
									...
									<article class="blog-post-v1 style3 item">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/345x290" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
								...
								<nav class="blog-footer style2 text-center">
									<a href="blog-grids-4column-nospace.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
						</div>
					</div>
