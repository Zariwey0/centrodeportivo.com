					...
					<div class="row text-uppercase">
						<aside class="col-xs-12 col-sm-6">
							...
							<section class="widget cate-widget">
								<h2>GIRD</h2>
                                <ul class="list-unstyled">
                                    <li><a href="shop-grid-3column.html"><i class="fa fa-caret-right"></i> 3 column</a></li>
                                    <li><a href="shop-grid-3column-rightsidebar.html"><i class="fa fa-caret-right"></i> 3 column - right sidebar</a></li>
                                    <li><a href="shop-grid-3column-leftsidebar.html"><i class="fa fa-caret-right"></i> 3 column - left sidebar</a></li>
                                    <li><a href="shop-grid-4column.html"><i class="fa fa-caret-right"></i> 4 column</a></li>
                                    <li><a href="shop-grid-4column-rightsidebar.html"><i class="fa fa-caret-right"></i> 4 column - right sidebar</a></li>
                                    <li><a href="shop-grid-4column-leftsidebar.html"><i class="fa fa-caret-right"></i> 4 column - left sidebar</a></li>
                                    <li><a href="shop-grid-full-width.html"><i class="fa fa-caret-right"></i> full width</a></li>
                                </ul>
							</section>
						</aside>
						<aside class="col-xs-12 col-sm-6">
							...
							<section class="widget cate-widget">
								<h2>LIST</h2>
                                <ul class="list-unstyled">
                                    <li><a href="shop-list.html"><i class="fa fa-caret-right"></i> default</a></li>
                                    <li><a href="shop-list-leftsidebar.html"><i class="fa fa-caret-right"></i> right sidebar</a></li>
                                    <li><a href="shop-list-rightsidebar.html"><i class="fa fa-caret-right"></i> leftsidebar</a></li>
                                    <li><a href="shop-single.html"><i class="fa fa-caret-right"></i> single</a></li>
                                    <li><a href="shop-cart.html"><i class="fa fa-caret-right"></i> cart</a></li>
                                    <li><a href="shop-checkout.html"><i class="fa fa-caret-right"></i> checkout</a></li>
