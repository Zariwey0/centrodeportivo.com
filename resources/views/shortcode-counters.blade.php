	...
	<div id="wrapper">
		<div class="w1">
													...
													<div class="drop-holder">
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-counters.html"><i class="fa fa-th-large"></i> COUNTERS</a></li>
															</ul>
														</div>
														<div class="coll">
															<ul class="list-unstyled">
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Counters</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">Counters</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<!-- facts section -->
				<section class="facts-section container padding-top-90 padding-bottom-90">
					<div class="row">
				...
				<!-- counter container -->
				<div class="counter-container container padding-bottom-90">
					<div class="row">
						<div class="col-xs-12 col-sm-3">
				...
				<div class="container padding-top-60 padding-bottom-60">
                    ...
                    <header class="page-heading">
                        <h2 class="heading lime text-capitalize font-medium">Countdowns</h2>
                    </header>
					<div class="row">
						<div class="col-xs-12">
							<div id="countdown" class="wedding-nav white"></div>
						</div>
					</div>
				</div>
			</main>
