	...
	<div id="wrapper">
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															...
															<ul class="list-unstyled">
																...
																<li class="active"><a href="faq-3.html">FAQ LAYOUT 3</a></li>
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">faq<span class="text-lowercase">s</span></h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">pages</a></li>
									<li class="active"><a href="#">faq<span class="text-lowercase">s</span></a></li>
								</ul>
							</div>
						</div>
					</div>
                ...
                <!-- faq section -->
				<div class="container padding-bottom-100 padding-top-100 faq-section style3" id="main-section">
                    <!-- page heading -->
                    <header class="page-heading">
                        <h2 class="heading2 lime text-capitalize font-medium margin-bottom-30">Some of your Questions</h2>
                        <p>Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper.</p>
                    </header>
					<div class="row holder">
						<div class="col-xs-12">
							<h2><a href="#section1" class="smoothanchor"><i class="fa fa-caret-right"></i> How do I become an author?</a></h2>
							<h2><a href="#section2" class="smoothanchor"><i class="fa fa-caret-right"></i> How do I pay for items on the Marketplaces?</a></h2>
							<h2><a href="#section3" class="smoothanchor"><i class="fa fa-caret-right"></i> How can I get support for an item which isn't working correctly?</a></h2>
							<h2><a href="#section4" class="smoothanchor"><i class="fa fa-caret-right"></i> Tips for Increasing Your Referral Income</a></h2>
							<h2><a href="#section5" class="smoothanchor"><i class="fa fa-caret-right"></i> Can I use trademarked names in my items?</a></h2>
							<h2><a href="#section6" class="smoothanchor"><i class="fa fa-caret-right"></i> What Images, Videos, Code or Music Can I Use in my Items?</a></h2>
							<h2><a href="#section7" class="smoothanchor"><i class="fa fa-caret-right"></i> An Introduction to the Marketplaces for Authors</a></h2>
							<h2><a href="#section8" class="smoothanchor"><i class="fa fa-caret-right"></i> How much money can I make?</a></h2>
							<div class="divider-line2"></div>
                            <!-- beans accordion -->
							<ul class="beans-accordion list-unstyled">
								<li id="section1">
									<h2>Q: How do I become an author?</h2>
									<!-- box -->
									<div class="box">
										...
										<ol>
											<li>Maiores, quasi, voluptates, exercitationem fuga</li>
											<li>Saepe, aperiam, nam unde quas beatae ve</li>
											<li>ipsa alias assumenda officiis quasi sap</li>
											<li>laboriosam iusto quia nulla ad voluptatibus iste beatae</li>
										</ol>
									</div>
									<div class="divider-line2"> <a href="#main-section" class="smoothanchor"><i class="fa fa-chevron-up"></i></a> </div>
								</li>
								<li id="section2">
									<h2>Q: How do I pay for items on the Marketplaces?</h2>
									<!-- box -->
									<div class="box">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li id="section3">
									<h2>Q: How can I get support for an item which isn't working correctly?</h2>
									<!-- box -->
									<div class="box">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li id="section4">
									<h2>Q: Tips for Increasing Your Referral Income</h2>
									<!-- box -->
									<div class="box">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li id="section5">
									<h2>Q: Can I use trademarked names in my items?</h2>
									<!-- box -->
									<div class="box">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li id="section6">
									<h2>Q: What Images, Videos, Code or Music Can I Use in my Items?</h2>
									<!-- box -->
									<div class="box">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li id="section7">
									<h2>Q: An Introduction to the Marketplaces for Authors</h2>
									<!-- box -->
									<div class="box">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
								...
								<li id="section8">
									<h2>Q: How much money can I make?</h2>
									<!-- box -->
									<div class="box">
										<p>Ultrices metus et dui dictum quis elementum augue imperdiet. Nunc a turpis nec elit porttitor varius. Cras non felis eget nibh eleifend rhoncus id sit amet nisi. Cras est mi, dapibus eu dictum quis, interdum in dui. Ut lacinia accumsan libero ac semper. Sed in turpis in massa mattis blandit eget vel sem. Nullam id erat sapien, ac faucibus est. Ut eu tortor rutrum erat pellentesque iaculis. Nunc porta convallis pharetra.</p>
										<ol>
