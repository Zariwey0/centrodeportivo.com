														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="portfolio-single-parallex.html">parallax</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO single parallex</a></li>
								</ul>
							</div>
						</div>
				    </div>
							...
							<div class="col-xs-12">
								<section class="port-parallex small">
									<div class="parallax-holder">
										<div class="parallax-frame"><img src="http://placehold.it/1170x800" height="800" width="1170" alt="image description"></div>
									</div>
								</section>
