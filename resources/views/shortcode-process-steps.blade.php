	...
	<div id="wrapper">
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-process-steps.html"><i class="fa fa-bolt"></i> PROCESS STEPS</a></li>
															</ul>
														</div>
														<div class="coll">
															<ul class="list-unstyled">
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">process steps</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">process steps</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<!-- process section -->
				<section class="process-section padding-top-100">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
				                <!-- page heading -->
							    <header class="page-heading">
								    <h2 class="heading lime text-capitalize font-medium">Our Process</h2>
