															...
															<div class="drop">
																<ul class="list-unstyled">
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="portfolio-masonry-2column.html">2 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO masonry 2 column</a></li>
								</ul>
							</div>
						</div>
				    </div>
							...
							<div class="col-xs-12">
								<div class="icotop-holder" id="work">
                                    ...
                                    <div class="portfolio-block coll-2 style6 work-design">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/555x520" alt="image description" class="img-responsive">
                                                <div class="over">
                                    ...
                                    <div class="portfolio-block coll-2 style6 work-fashion">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/555x620" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <!-- portfolio block coll-2 style6 -->
                                    <div class="portfolio-block coll-2 style6 work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/555x620" alt="image description" class="img-responsive">
                                    ...
                                    <div class="portfolio-block coll-2 style6 work-design">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/555x640" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-2 style6 work-fashion">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/555x360" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-2 style6 work-illustration">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/555x630" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
                                    ...
                                    <div class="portfolio-block coll-2 style6 work-design">
                                        ...
                                        <div class="box">
                                            <div class="img-box">
                                                <img src="http://placehold.it/555x700" alt="image description" class="img-responsive">
                                                <div class="over">
                                                    <a class="search lightbox" href="images/placeholder.jpg"><i class="fa fa-search"></i></a>
                                                    <a class="link" href="portfolio-single-image.html"><i class="fa fa-link"></i></a>
                                                </div>
