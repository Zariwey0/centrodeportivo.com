...
<body>
	...
	<div id="wrapper">
		<div class="w1">
														...
														<li>
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="index-youtube.html">YOUTUBE</a></li>
			...
			<!-- mainslider -->
			<div class="main-slider win-height video-section style4">
				<div class="caption win-height">
					<div class="holder">
						<h1 class="heading">Faster &amp; More Powerful</h1>
						<p class="txt">Creative. Clean Design. Let’s Start an Awesome Project.</p>
						<div class="btn-box">
                            <a href="index.html" class="btn btn-f-default">LEARN MORE</a>
                            <a href="http://fekra.csshunter.com" class="btn btn-f-info">PURCHASE</a>
						</div>
					</div>
				</div>
				<div class="youtube_bg_video has_overlay" data-property="{videoURL:'https://www.youtube.com/watch?v=3U4YgEfPCow',containment:'self',startAt:0,mute:true,autoPlay:true,loop:true,opacity:1,showYTLogo:false, realfullscreen:false, quality:'small'}"></div>
			</div>
