	...
	<div id="wrapper">
		<div class="w1">
			...
			<main id="main" role="main">
				...
				<header class="page-banner">
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-lowercase"><span class="text-capitalize">Clients</span></h1>
				...
				<!-- clients section3 -->
				<section class="clients-section3 container padding-bottom-90 padding-top-90">
					<div class="row">
						<div class="col-xs-12">
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="lime text-capitalize font-medium">Lovely Clients</h2>
							...
							<ul class="list list-inline">
								<li>
									<!-- box -->
									<div class="box">
										<div class="holder"><a href="#"><img src="http://placehold.it/125x35" alt="image description"></a></div>
									</div>
								</li>
								<li>
									<!-- box -->
				...
				<div class="onepage-clientbox">
					<div class="stretch">
						<img src="http://placehold.it/1920x640" alt="image description">
					</div>
					<!-- onepage client -->
							...
							<div class="col-xs-12">
								...
								<ul class="tabset list-unstyled margin-zero">
								    <li class="active">
                                       <a href="#tab6-1">
                                            <div class="holder">
                                                <div class="frame"><img src="http://placehold.it/155x155" alt="image description"></div>
                                            </div>
                                        </a>
								    </li>
								    <li>
				...
				<!-- clients section -->
				<div class="clients-section padding-bottom-60 padding-top-60">
					<div class="container">
				...
				<!-- section -->
				<div class="padding-top-60 dark-bottom-border padding-bottom-60 bg-grey">
                    <!-- line box -->
                    <div class="line-box">
                        <!-- partners nav large -->
                        <ul class="partners-nav line large list-inline">
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/125x50" alt="logo"></a></div></li>
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/125x50" alt="logo"></a></div></li>
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/125x50" alt="logo"></a></div></li>
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/125x50" alt="logo"></a></div></li>
                            <li><div class="frame"><a class="box" href="clients.html"><img class="img-responsive" src="http://placehold.it/125x50" alt="logo"></a></div></li>
						...
						<div class="row padding-bottom-30">
							<div class="col-xs-12 col-sm-3">
								...
								<a href="#" class="client-box large">
									<span class="img"><img src="http://placehold.it/250x130" alt="image description"></span>
								</a>
							</div>
							<div class="col-xs-12 col-sm-3">
				                <!-- client box -->
								...
								<div class="beans-slideset">
									...
									<div class="beans-slide">
										...
										<a href="clients.html" class="client-box large dark">
											<span class="img"><img src="http://placehold.it/200x130" alt="image description"></span>
										</a>
									</div>
									<!-- beans-slide -->
									<div class="beans-slide">
