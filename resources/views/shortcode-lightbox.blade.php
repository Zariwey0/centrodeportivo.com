													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-lightbox.html"><i class="fa fa-bolt"></i> LIGHTBOX</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">light box</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">light box</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container padding-top-100">
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							<!-- wedding photos -->
							<section class="wedding-photos margin-zero padding-bottom-zero bg-none">
				                <!-- page heading -->
							    <header class="page-heading">
								    <h2 class="heading lime text-capitalize font-medium">Lightbox with Gallery</h2>
				                </header>
								<div class="holder" id="masonry-container">
									<!-- box half item -->
									<div class="box half item">
										<img src="http://placehold.it/422x430"  alt="image description" class="img-responsive">
										<div class="over">
											<a href="images/placeholder.jpg" rel="lightbox[gallery1]" class="lightbox"><i class="fa fa-search-plus"></i></a>
										</div>
									</div>
									<!-- box item -->
									<div class="box item">
										<img src="http://placehold.it/200x200" alt="image description" class="img-responsive">
										<div class="over">
											<a href="images/placeholder.jpg" rel="lightbox[gallery1]" class="lightbox"><i class="fa fa-search-plus"></i></a>
										</div>
									</div>
							...
							<section class="wedding-photos margin-zero padding-bottom-zero bg-none">
				                <!-- page heading -->
							    <header class="page-heading">
								    <h2 class="heading lime text-capitalize font-medium">Lightbox with Single image</h2>
				                </header>
								<div class="holder" id="work">
									<!-- box item -->
									<div class="box half item">
										<img src="http://placehold.it/422x430"  alt="image description" class="img-responsive">
										<div class="over">
							...
							<section class="wedding-photos margin-zero padding-bottom-zero bg-none">
				                <!-- page heading -->
							    <header class="page-heading">
								    <h2 class="heading lime text-capitalize font-medium">Video Lightbox</h2>
				                </header>
								<div class="holder">
									<!-- box half item -->
									<div class="box half item video-area">
										<iframe width="560" height="315" src="https://www.youtube.com/embed/aPzz4RTJrE0" frameborder="0" allowfullscreen></iframe>
										<div class="over">
											<a href="https://www.youtube.com/embed/watch?v=aPzz4RTJrE0" class="lightbox fancybox.iframe"><i class="fa fa-search-plus"></i></a>
										</div>
									</div>
									<!-- box half item -->
									<div class="box half item video-area">
										<iframe src="https://player.vimeo.com/video/38067095?title=0&byline=0&portrait=0" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
										<div class="over">
											<a href="http://player.vimeo.com/video/38067095?autoplay=true" class="lightbox fancybox.iframe"><i class="fa fa-search-plus"></i></a>
										</div>
									</div>
								</div>
							</section>
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-lightbox.html"><i class="fa fa-caret-right"></i> Lightbox</a></li>
