...
<body>
	...
	<div id="wrapper">
		<div class="w1">
										...
										<div class="cart-drop">
											<div class="cart-holder">
												...
												<ul class="cart-list list-unstyled">
													<li>
														<div class="image">
															<a href="#"><img src="images/cart-images/img01.jpg" alt="Image Description"></a>
														</div>
													...
													<li>
														<div class="image">
															<a href="#"><img src="images/cart-images/img02.jpg" alt="Image Description"></a>
														</div>
														<div class="description">
															<span class="product-name"><a href="#">Product Name</a></span>
															<ul class="rating list-inline">
			...
			<!-- mainslider -->
			<div class="win-height main-slider">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<div class="caption win-height">
								<div class="holder">
									<img src="images/newdemo/img18.png" alt="image description" class="img-responsive">
								</div>
							</div>
						</div>
					</div>
