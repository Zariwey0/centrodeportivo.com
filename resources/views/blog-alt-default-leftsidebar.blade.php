																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-alt-default-leftsidebar.html">LEFT SIDEBAR</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG FULL WIDTH alt right sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
										...
										<div class="beans-mask">
											<div class="beans-slideset">
												...
												<div class="beans-slide">
													<a href="blog-single-image.html"><img src="http://placehold.it/425x310" alt="image description" class="img-responsive"></a>
												</div>
												<!-- beans-slide -->
												<div class="beans-slide">
													<a href="blog-single-image.html"><img src="http://placehold.it/425x310" alt="image description" class="img-responsive"></a>
							...
							<article class="blog-post-v1 style2">
								...
								<div class="blog-txt">
									...
									<ul class="meta list-inline">
										...
										<li>
											<i class="fa fa-tags"></i>
											<a href="blog-single-image.html">People</a> 
										</li>
										<li>
											<i class="fa fa-heart"></i>
											<a href="blog-single-image.html">14</a>
							...
							<nav class="blog-footer style2 text-center">
								<a href="blog-alt-default.html" class="btn btn-load">LOAD MORE</a>
							</nav>
						</div>
