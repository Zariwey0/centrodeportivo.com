														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="blog-single-blockquote.html">blockquote</a></li>
																	<li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">single blog blockquote</a></li>
								</ul>
							</div>
						</div>
				    </div>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<article class="blog-post-v1 style-full">
								<blockquote class="main-blockquote"><q> Most text editors like MS Word or Lotus Notes generate random lorem text when needed, either as pre-installed module or plug-in to be added. Word selection or sequence don't necessarily match the original, which is intended to add variety</q></blockquote>
								<div class="blog-txt">
									<h2>This is a blockquote sample post</h2>
								...
								<div class="txt">
									...
									<h3>WHAT WE WILL DO ? IT IS FOR YOU</h3>
									...
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Aenean commodo ligula eget dolor aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec vitae sapien ut libero venenatis faucibus Nulla consequat massa quis enim. Donec vitae sapien ut libero venenatis.</p>
								</div>
							</article>
							<!-- post-footer -->
							...
							<div class="post-author-box">
								<div class="img-box">
									<img src="http://placehold.it/120x120" alt="image description">
								</div>
								<div class="holder">
									<strong class="title"><a href="#">- Mohammed Arafa, Senior UI Designer, Cairo</a></strong>
									<span class="aut-text"><a href="#">125 POST</a>  -  <a href="#">3600 COMMENTS</a></span>
