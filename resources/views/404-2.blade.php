		...
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															...
															<ul class="list-unstyled">
																...
																<li class="active"><a href="404-2.html">404 - layout 2</a></li>
			...
			<main id="main" role="main">
				...
				<div class="container lost-block">
					<div class="row">
						<div class="col-xs-12">
							<h2>ARE YOU LOST <br>SOMEWHERE<span>?</span></h2>
							<a href="#" class="btn btn-back"><i class="fa fa-home"></i> BACK TO HOME</a>
						</div>
					</div>
				</div>
			</main>
