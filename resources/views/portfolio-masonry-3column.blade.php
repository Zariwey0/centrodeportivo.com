																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="portfolio-masonry-3column.html">3 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO masonry 3 column</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="icotop-holder" id="work">
                                    ...
                                    <div class="portfolio-block coll-3 style6 work-design">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="img-box">
