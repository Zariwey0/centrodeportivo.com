													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-modal-boxes.html"><i class="fa fa-bolt"></i> MODAL BOXES</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">modal boxes</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">modal boxes</a></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<section class="wedding-photos margin-zero padding-bottom-zero bg-none">
								<div class="holder" id="masonry-container">
									...
									<div class="box half item">
										<img src="http://placehold.it/422x422" alt="image description" class="img-responsive">
										<div class="over">
