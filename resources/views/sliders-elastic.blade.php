...
<head>
	...
	<!-- include the site stylesheet of elastic slider  -->
	<link media="all" rel="stylesheet" href="css/elastic.css">
...
<body>
							...
							<div class="col-xs-12">
								<div id="slider">
									<div class="mask">
										<ul class="images">
											<li>
												<img src="http://placehold.it/1160x580">
											</li>
											<li>
												<img src="http://placehold.it/1160x580">
											</li>
										...
										<ul class="base-controls">
											<li class="prev"></li>    
											<li class="next"></li>
										</ul>	
									</div>
									<ul class="specific-controls">
										<li class="active"></li>
										<li></li>
										<li></li>
										<li></li>
	...
	<script type="text/javascript">
		...
		function initElasticSlider() {
			elastic_slider.call({
				images: jQuery("ul.images > li"), 
				animation: 'slide',
				base_controls: jQuery("ul.base-controls li"),
				specific_controls: jQuery("ul.specific-controls li"),
			}); 
		}
	</script>
</body>
