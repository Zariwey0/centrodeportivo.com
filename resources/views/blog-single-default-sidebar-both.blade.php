																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-single-default-sidebar-both.html">both sidebar</a></li>
																			</ul>
																		</div>
																	</li>
																</ul>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">single blog default both sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
					...
					<div class="row">
						<div class="col-xs-12 col-md-6 col-md-push-3">
							...
							<article class="blog-post-v1 style-full">
										...
										<div class="beans-mask">
											<div class="beans-slideset">
												...
												<div class="beans-slide">
													<img src="http://placehold.it/570x235" alt="image description" class="img-responsive">
												</div>
												<!-- beans-slide -->
												<div class="beans-slide">
													<img src="http://placehold.it/570x235" alt="image description" class="img-responsive">
								...
								<div class="blog-txt">
									<h2>Intelegent transitions in ux design</h2>
