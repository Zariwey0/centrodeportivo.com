														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="portfolio-layout-left-sidebar.html">LEFT SIDEBAR</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO GIRD left sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
								...
								<div class="icotop-holder margin-bottom-60">
                                    ...
                                    <div class="portfolio-block coll-2 nospace">
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="stretch">
                               					<img src="http://placehold.it/435x435" alt="image description">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- portfolio block coll-2 nospace -->
