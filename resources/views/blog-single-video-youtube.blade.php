														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="blog-single-video-youtube.html">youtube</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">single blog youtibe</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							...
							<article class="blog-post-v1 style-full">
								<div class="img-box video-area">
									<iframe width="560" height="315" src="https://www.youtube.com/embed/XR2j5GTq9NU" frameborder="0" allowfullscreen></iframe>
								</div>
								<div class="blog-txt">
									<h2>Youtube Single Sample Post</h2>
