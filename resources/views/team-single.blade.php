	...
	<div id="wrapper">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">team</a></li>
									<li class="active"><a href="#">Single team</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<section class="whatwedo-section container style3 padding-top-90 padding-bottom-60">
					<div class="row">
						<div class="col-xs-12 col-sm-6">
							<img src="http://placehold.it/570x390" alt="image description" class="img-responsive">
						</div>
						<div class="col-xs-12 col-sm-6">
                            <!-- page heading -->
                            <header class="page-heading margin-zero left-align">
                                <h2 class="lime text-capitalize font-medium">Ahrami Luiz</h2>
                            </header>
							<strong class="title">Senior Web Designer</strong>
							<p>In a professional context it often happens that private or corporate clients corder a publication to be made and presented with the actual content still not being ready. Think of a news blog that's filled with content hourly on the day of going live. However, reviewers.</p>
							<ul class="progress-holder style2 add-style list-unstyled">
								<li class="no-bg">
				...
				<div id="lancer-footer" class="style2">
					...
					<div class="parallax-holder">
						<div class="parallax-frame">
							<img width="1920" height="400" alt="image description" src="http://placehold.it/1920x400">
						</div>
					</div>
				</div>
				<!-- container -->
					...
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-3">
							...
							<div class="team-box" data-animate="fadeInUp" data-delay="200">
								<div class="img-box">
									<img src="http://placehold.it/270x265" alt="image description" class="img-responsive">
		...
		<div class="popup-holder">
			...
			<div id="popup1" class="lightbox team-lightbox">
				<div class="img-box">
					<img src="http://placehold.it/250x320" alt="image description" class="img-responsive">
				</div>
				<div class="holder">
