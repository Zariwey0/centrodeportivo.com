	...
	<div id="wrapper">
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-galleries.html"><i class="fa fa-bolt"></i> GALLERIES</a></li>
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">galleries</h1>
								</div>
					...
					<div class="icotop-holder">
						...
						<div class="portfolio-block coll-6 nospace">
							...
							<div class="box">
								...
								<img src="http://placehold.it/317x317" alt="image description" class="img-responsive">
							</div>
						</div>
						<!-- portfolio block coll-6 nospace -->
						<div class="portfolio-block coll-6 nospace">
					...
					<div class="icotop-holder">
						...
						<div class="portfolio-block coll-2 nospace">
							...
							<div class="box">
								...
								<img src="http://placehold.it/952x952" alt="image description">
							</div>
						</div>
						<!-- portfolio block coll-4 nospace -->
						...
						<div class="portfolio-block coll-2 nospace">
							...
							<div class="box">
								...
								<img src="http://placehold.it/952x476" alt="image description">
							</div>
						</div>
					</div>
				</section>
				...
				<!-- wedding photos -->
				<section class="wedding-photos padding-top-90">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder" id="masonry-container">
									...
									<div class="box half item">
										<img src="http://placehold.it/568x568" alt="image description" class="img-responsive">
										<div class="over">
											<a href="images/placeholder.jpg" class="lightbox"><i class="fa fa-search-plus"></i></a>
										</div>
									</div>
