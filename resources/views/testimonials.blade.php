			...
			<main id="main" role="main">
				...
				<section class="testimon-section">
										...
										<div class="beans-slideset">
											...
											<div class="beans-slide">
												...
												<blockquote>
													<q>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus Nam libero tempore, cum soluta nobis est eligendi optio.</q>
													<cite>
														<span class="name">Teresa Lisbon</span>
											...
											<div class="beans-slide">
												...
												<blockquote>
													<q>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus Nam libero tempore, cum soluta nobis est eligendi optio.</q>
													<cite>
														<span class="name">Patrick Jane</span>
											...
											<div class="beans-slide">
												...
												<blockquote>
													<q>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus Nam libero tempore, cum soluta nobis est eligendi optio.</q>
													<cite>
														<span class="name">Wayne Rigsby</span>
														<span class="comp-name"><a href="#">COMPANY NAME - CEO</a></span>
													</cite>
												</blockquote>
											</div>
					...
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x700" height="700" width="1920" alt="image description"></div>
					</div>
				</section>
				<!-- testimonials box -->
				<div class="container padding-top-90 padding-bottom-90 testimonials-box">
					<div class="row">
						<!-- testimonials -->
						<article class="testimonials" data-delay="200" data-animate="fadeInUp">
							<div class="img-box">
								<img alt="image description" class="img-responsive" src="http://placehold.it/270x270">
							</div>
							<div class="holder">
								<blockquote>
									<q>Friends from Utica recommended Joey's Restaurant, so we drove down one evening for dinner. We can't say enough good things about our experience.</q>
								</blockquote>
								<div class="author">
									<p>Fatoma Hassan</p>
								</div>
						...
						<article class="testimonials" data-delay="200" data-animate="fadeInUp">
							...
							<div class="holder">
								<blockquote>
									<q>We've been to Joey's many times over the years. We know what to expect: great food and great prices. I suggest checking them out.</q>
								</blockquote>
								<div class="author">
									<p>Fatoma Hassan</p>
								</div>
						...
						<article class="testimonials" data-delay="200" data-animate="fadeInUp">
							...
							<div class="holder">
								<blockquote>
									<q>I can't say enough about your quaint Italian Restaurant! The reasonable prices, and great atmosphere are only topped by the delicious food.</q>
								</blockquote>
								<div class="author">
									<p>Fatoma Hassan</p>
								</div>
						...
						<article class="testimonials" data-delay="200" data-animate="fadeInUp">
							...
							<div class="holder">
								<blockquote>
									<q>Joey's is simply the BEST there is! Great Food, big portions, nice atmosphere.</q>
								</blockquote>
								<div class="author">
									<p>Fatoma Hassan</p>
								</div>
				...
				<!-- testimon section -->
				<div class="testimon-section large">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
					...
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x900" height="900" width="1920" alt="image description"></div>
					</div>
				</div>
				<!-- testimon section -->
				<div class="testimon-section alt-version no-bg">
                    <div class="container">
                        <!-- page heading -->
                        <header class="page-heading">
                            <h2 class="heading lime text-capitalize font-medium">Happy Clients</h2>
                        </header>
						<div class="row">
							<div class="col-xs-12">
								<!-- beans-slider -->
				...
				<section class="testimon-section">
										...
										<div class="beans-slideset">
											...
											<div class="beans-slide">
												<blockquote>
													<q>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus Nam libero tempore, cum soluta nobis est eligendi optio.</q>
													<cite>
														<span class="comp-name"><a href="#">YOUR NAME</a>  - <a href="#">COMPANY NAME</a></span>
													</cite>
												</blockquote>
											</div>
											<!-- beans-slide -->
					...
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x900" height="200" width="1920" alt="image description"></div>
					</div>
				</section>
			</main>
			<!-- footer of the page -->
