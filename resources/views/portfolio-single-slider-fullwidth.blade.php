														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="portfolio-single-slider-fullwidth.html">slider full width</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO single slider fullwidth</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="beans-mask">
							<div class="beans-slideset">
								...
								<div class="beans-slide">
									<div class="stretch">
										<img src="http://placehold.it/1920x440" alt="image description">
									</div>
								</div>
								<!-- beans-slide -->
								<div class="beans-slide">
