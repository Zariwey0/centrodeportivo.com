				...
				<header class="page-banner">
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-capitalize">sitemap</h1>
									<p>Your challenge is our progress</p>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li class="active"><a href="#">sitemap</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row text-uppercase">
						<aside class="col-xs-12 col-sm-6 col-md-3">
							...
							<section class="widget cate-widget">
								<h2>COMPANY</h2>
                                <ul class="list-unstyled">
                                    <li><a href="about-us.html"><i class="fa fa-caret-right"></i> ABOUT US</a></li>
                                    <li><a href="about-me.html"><i class="fa fa-caret-right"></i> ABOUT ME</a></li>
                                    <li><a href="clients.html"><i class="fa fa-caret-right"></i> CLIENTS</a></li>
                                    <li><a href="testimonials.html"><i class="fa fa-caret-right"></i> TESTIMONIALS</a></li>
                                    <li><a href="team.html"><i class="fa fa-caret-right"></i> OUR TEAM</a></li>
                                    <li><a href="team-single.html"><i class="fa fa-caret-right"></i> TEAM SINGLE</a></li>
						...
						<aside class="col-xs-12 col-sm-6 col-md-3">
							...
							<section class="widget cate-widget">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="services2.html"><i class="fa fa-caret-right"></i> service 2</a></li>
                                    <li><a href="faq-1.html"><i class="fa fa-caret-right"></i> FAQ LAYOUT 1</a></li>
                                    <li><a href="faq-2.html"><i class="fa fa-caret-right"></i> FAQ LAYOUT 2</a></li>
                                    <li><a href="faq-3.html"><i class="fa fa-caret-right"></i> FAQ LAYOUT 3</a></li>
                                    <li><a href="sitemap.html"><i class="fa fa-caret-right"></i> sitemap</a></li>
                                    <li><a href="blank-page.html"><i class="fa fa-caret-right"></i> blank page</a></li>
                                </ul>
							</section>
						</aside>
						<aside class="col-xs-12 col-sm-6 col-md-3 clearfix-sm">
							...
							<section class="widget cate-widget">
								<h2>LAYOUT DESIGN</h2>
                                <ul class="list-unstyled">
                                    <li><a href="layout-full-widthwide.html"><i class="fa fa-caret-right"></i> LAYOUT WIDE</a></li>
                                    <li><a href="layout-full-width.html"><i class="fa fa-caret-right"></i> FULL WIDTH</a></li>
                                    <li><a href="layout-left-sidebar.html"><i class="fa fa-caret-right"></i> LEFT SIDE BAR</a></li>
                                    <li><a href="layout-right-sidebar.html"><i class="fa fa-caret-right"></i> RIGHT SIDEBAR</a></li>
                                    <li><a href="layout-both-sidebar.html"><i class="fa fa-caret-right"></i> both  SIDEBAR</a></li>
                                    <li><a href="layout-side-navigation.html"><i class="fa fa-caret-right"></i> SIDE NAVIGATION</a></li>
                                    <li><a href="index-freelancer.html"><i class="fa fa-caret-right"></i> vertical menu</a></li>
                                </ul>
							</section>
						</aside>
						<aside class="col-xs-12 col-sm-6 col-md-3">
							...
							<section class="widget cate-widget">
								<h2>Miscellaneous</h2>
                                <ul class="list-unstyled">
                                    <li><a href="comming-soon.html"><i class="fa fa-caret-right"></i> coming soon layout 1</a></li>
                                    <li><a href="comming-soon2.html"><i class="fa fa-caret-right"></i> coming soon layout 2</a></li>
                                    <li><a href="comming-soon3.html"><i class="fa fa-caret-right"></i> coming soon layout 3</a></li>
                                    <li><a href="404.html"><i class="fa fa-caret-right"></i> 404 - layout 1</a></li>
                                    <li><a href="404-2.html"><i class="fa fa-caret-right"></i> 404 - layout 2</a></li>
                                    <li><a href="404-3.html"><i class="fa fa-caret-right"></i> 404 - layout 3</a></li>
                                    <li><a href="login.html"><i class="fa fa-caret-right"></i> Login</a></li>
                                </ul>
							</section>
						</aside>
					</div>
