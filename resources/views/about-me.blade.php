	...
	<div id="wrapper">
		<div class="w1">
			...
			<main id="main" role="main">
				...
				<header class="page-banner">
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-capitalize">Ahrami Luiz</h1>
				...
				<!-- lancer about -->
				<section class="lancer-about">
					<div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="txt">
                                    <img src="http://placehold.it/560x530" alt="image description" class="img-responsive">
                                </div>
                                <div class="chart-block">
                                    <div class="holder">
                                        <!-- page heading -->
                                        <header class="page-heading left-align margin-zero">
                                            <h2 class="lime text-uppercase font-medium">Ahrami Luiz</h2>
                                        </header>
                                        <strong class="title">Art Director</strong>
                                        <p>Suspendisse et metus eu massa lobortis condimentum sed ut orci. Nullam viverra dapibus risus, eu tristique nisl sollicitudin at. Etiam iaculis blandit liberolicitudin at. Etiam iaculis blandit libero.</p>
                                    </div>
                                    <!-- box -->
                                    <div class="box" data-animate="fadeInUp" data-delay="100">
                                        <div class="pie-block">
                                            <div class="pie-chart" data-percent="75" data-barColor="#e74c3c" data-trackColor="#eee" data-lineWidth="2" data-barSize="120">
                                    ...
                                    <div class="box" data-animate="fadeInUp" data-delay="150">
                                        <div class="pie-block">
                                            <div class="pie-chart" data-percent="85" data-barColor="#e74c3c" data-trackColor="#eee" data-lineWidth="2" data-barSize="120">
                                                <div class="pie-chart-percent">
                                                    <span></span>%
                                                </div>
                                            </div>
                                    ...
                                    <div class="box" data-animate="fadeInUp" data-delay="200">
                                        <div class="pie-block">
                                            <div class="pie-chart" data-percent="100" data-barColor="#e74c3c" data-trackColor="#eee" data-lineWidth="2" data-barSize="120">
                                                <div class="pie-chart-percent">
                                                    <span></span>%
                                                </div>
                                            </div>
                                    ...
                                    <div class="box" data-animate="fadeInUp" data-delay="300">
                                        <div class="pie-block">
                                            <div class="pie-chart" data-percent="50" data-barColor="#e74c3c" data-trackColor="#eee" data-lineWidth="2" data-barSize="120">
                                                <div class="pie-chart-percent">
                                                    <span></span>%
                                                </div>
                                            </div>
                                    ...
                                    <div class="box" data-animate="fadeInUp" data-delay="350">
                                        <div class="pie-block">
                                            <div class="pie-chart" data-percent="35" data-barColor="#e74c3c" data-trackColor="#eee" data-lineWidth="2" data-barSize="120">
                                                <div class="pie-chart-percent">
                                                    <span></span>%
                                                </div>
                                            </div>
				...
				<!-- work section -->
				<section class="work-section padding-bottom-90 dark-bottom-border">
					<!-- beans-stepslider -->
					<div class="beans-stepslider work-slider">
								...
								<div class="beans-slide">
									...
									<div class="portfolio-block nospace">
										...
										<div class="box">
											...
											<img src="http://placehold.it/480x460" alt="image description">
										</div>
									</div>
								</div>
								<!-- beans-slide-2 -->
										...
										<div class="box">
											<div class="over">
												<div class="holder">
													<div class="frame">
														<div class="over-frame">
															<strong class="title upper">products you love</strong>
															<p>PRODUCT</p>
														</div>
													</div>
												</div>
										...
										<div class="box">
											<div class="over">
												<div class="holder">
													<div class="frame">
														<div class="over-frame">
															<strong class="title upper">COVER DESIGN</strong>
															<p>DESIGN</p>
														</div>
													</div>
												</div>
						...
						<div class="container">
							<div class="row">
								<!-- col -->
								<div class="col-xs-12">
									<a class="btn btn-dark pull-left" href="portfolio-2columns.html">VIEW OUR PORTFOLIO</a>
				...
				<!-- portfolio footer -->
                <div class="portfolio-footer style2 padding-top-60 padding-bottom-60 bg-shark">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <span class="new-txt">Do your want new project for your business ? </span>
                                <a href="contact.html" class="btn btn-get pull-right">GET IN TOUCH NOW</a>
                            </div>
                        </div>
                    </div>
                </div>
				<!-- lancer footer -->
				<footer id="lancer-footer" class="style2">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<!-- f social -->
					...
					<div class="parallax-holder">
						<div class="parallax-frame">
							<img width="1920" height="900" alt="image description" src="http://placehold.it/1920x900">
						</div>
					</div>
				</footer>
			</main>
