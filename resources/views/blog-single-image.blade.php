												...
												<div class="drop">
													<ul class="list-unstyled">
														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	<li class="active"><a href="blog-single-image.html">image</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">single blog image</a></li>
								</ul>
							</div>
						</div>
				    </div>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<article class="blog-post-v1 style-full">
								<div class="img-box">
									<img src="http://placehold.it/1170x480" alt="image description" class="img-responsive">
								</div>
								<div class="blog-txt">
