	...
	<div id="wrapper">
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															...
															<ul class="list-unstyled">
																...
																<li class="active"><a href="services2.html">service 2</a></li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li class="active"><a href="#">services alt</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<section class="container padding-bottom-90 padding-top-90">
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-4 padding-top-60 padding-xs-topzero">
							<!-- f iconbox -->
							<div class="f-iconbox margin-bottom-30 right" data-animate="fadeInUp" data-delay="100">
							...
							<!-- f iconbox -->
							<div class="f-iconbox margin-bottom-30 right" data-animate="fadeInUp" data-delay="150">
								<span class="icon"><i class="fa fa-cog"></i></span>
								<span class="title">Theme Options</span>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
							</div>
							<!-- f iconbox -->
							<div class="f-iconbox margin-bottom-30 right" data-animate="fadeInUp" data-delay="200">
						...
						<div class="col-xs-12 col-md-4 hidden-sm hidden-xs">
							<img src="http://placehold.it/370x510" alt="image description" class="img">
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4 padding-top-60 padding-xs-topzero">
							<!-- f iconbox -->
							<div class="f-iconbox margin-bottom-30" data-animate="fadeInUp" data-delay="250">
							...
							<!-- f iconbox -->
							<div class="f-iconbox margin-bottom-30" data-animate="fadeInUp" data-delay="350">
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								...
								<img src="http://placehold.it/680x340" alt="image description" class="img img-responsive" data-animate="fadeInUp" data-delay="200">
							</div>
						</div>
					</div>
				...
				<!-- process section -->
				<section class="process-section padding-top-60">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<!-- icon block -->
