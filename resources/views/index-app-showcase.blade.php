...
<body>
	...
	<div id="wrapper">
		<div class="w1">
											...
											<div class="mega-drop">
												<div class="drop-holder">
													...
													<div class="coll">
														...
														<ul class="list-unstyled">
															<li class="active"><a href="index-app-showcase.html">Home - App Showcase</a></li>
			...
			<main id="main">
				<!-- appshowcase banner  -->
				<div class="appshowcase-banner">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<img src="http://placehold.it/600x300" alt="image description" class="img-responsive img" data-animate="fadeInUp" data-delay="250">
								<div class="frame" data-animate="fadeInRight" data-delay="250">
									<span class="title">Beautiful, Simple &amp; Easy to use </span>
				...
				<section class="services-section style6 container">
					<div class="row">
						<div class="col-xs-12 col-md-6">
							<div class="text-box">
								<h2>TAKE A LOOK AT OUR SCREEN</h2>
								<p>Vivamus fringilla nibh velit, at maximus lorem tincidunt vel. Ut fringilla in libero id ullamcorper. Curabitur at augue congue, porta lacus id, porttitor sem. Nunc quis bibendum sem. Morbi dignissim turpis enim, vitae tempor leo porta vitae. .from complete turn key to project manager.</p>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-xs-12 col-md-6 hidden-xs hidden-sm">
							<img src="http://placehold.it/970x655" alt="image description" class="img" data-animate="fadeInRight" data-delay="200">
						</div>
					</div>
				</section>
				<!-- core-section style3 -->
				<section class="core-section bg-grey style3">
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<img src="http://placehold.it/570x645" alt="image description" class="img img-responsive" data-animate="fadeInLeft" data-delay="200">
							</div>
							<div class="col-xs-12 col-sm-6 holder">
								<h2>we are working hard on it</h2>
								...
								<ul class="list-unstyled list">
									<li data-animate="fadeIn" data-delay="250">WooCommerce.</li>
									<li data-animate="fadeIn" data-delay="300">Browsers compatibility.</li>
									<li data-animate="fadeIn" data-delay="350">Pages valid on w3c.</li>
									<li data-animate="fadeIn" data-delay="400">Well documented.</li>
									<li data-animate="fadeIn" data-delay="450">Easy to  customization.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<section class="banner-img">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<strong class="title">Ultra Responsive</strong>
								<h3>Mobile, Tablests &amp; Desktop</h3>
								<img src="http://placehold.it/860x460" alt="image description" class="img img-responsive" data-animate="fadeInUp" data-delay="250">
							</div>
						</div>
					</div>
					<!-- parallax-holder -->
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x500" height="500" width="1920" alt="image description"></div>
					</div>
				</section>
				<!-- section -->
				<div class="padding-top-30 padding-bottom-90 container">
					<div class="row">
						<div class="col-xs-12 col-md-4">
							<!-- f iconbox -->
							<div class="f-iconbox light margin-bottom-30" data-animate="fadeIn" data-delay="150">
							...
							<!-- box -->
							<div class="f-iconbox light margin-bottom-30" data-animate="fadeIn" data-delay="200">
						...
						<div class="col-xs-12 col-md-4">
							<!-- box -->
							<div class="f-iconbox light margin-bottom-30" data-animate="fadeIn" data-delay="250">
								<span class="icon"><i class="fa fa-magic"></i></span>
								<span class="title">Trendy Design</span>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
							</div>
							<!-- box -->
							<div class="f-iconbox light margin-bottom-30" data-animate="fadeIn" data-delay="300">
						...
						<div class="col-xs-12 col-md-4">
							<!-- box -->
							<div class="f-iconbox light margin-bottom-30" data-animate="fadeIn" data-delay="350">
								<span class="icon"><i class="fa fa-expand"></i></span>
								<span class="title">Responsive Design</span>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
							</div>
							<!-- box -->
							<div class="f-iconbox light margin-bottom-30" data-animate="fadeIn" data-delay="400">
			...
			<footer id="footer" class="style23">
				...
				<div class="socialize-holder">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<strong class="title">Be Socialize</strong>
								<!-- footer-social -->
								<ul class="list-inline footer-social">
									...
									<li class="behance"><a href="#"><i class="fa fa-skype"></i></a></li>
									<li class="behance"><a href="#"><i class="fa fa-apple"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="col-xs-12">
								...
								<div class="bottom-box3">
									...
									<div class="f-info-box">
										<span class="title">OUR SUPPORT 24/7</span>
										<a href="tel:01234567890" class="tel">01234-567-890</a>
										<ul class="list-inline footer-social">
											<li><a href="#"><i class="fa fa-android"></i></a></li>
											<li><a href="#"><i class="fa fa-apple"></i></a></li>
											<li><a href="#"><i class="fa fa-windows"></i></a></li>
