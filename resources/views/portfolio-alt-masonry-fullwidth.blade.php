																	...
																	<li>
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li> class="active"<a href="portfolio-alt-masonry-fullwidth.html">ALT FULL WIDTH</a></li>
																			</ul>
																		</div>
																	</li>
																</ul>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO masonry FULL WIDTH 2</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<section class="work-section padding-top-100 padding-bottom-100">
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        <!-- beans slider coll-2-->
                        <div class="beans-slider coll-2 work-design">
                                                    ...
                                                    <a href="portfolio-single-image.html" class="over">
                                                        <div class="holder">
                                                            <div class="frame">
                                                                <div class="over-frame">
                                                                    <span class="plus">+</span>
                                                                    <strong class="title">new fashion</strong>
                                                                    <p>fashion</p>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="work-pagination beans-pagination">
                            </div>
                        </div>
                        <!-- portfolio block coll-2 nospace -->
                        <div class="portfolio-block coll-2 nospace work-fashion">
                            <!-- box -->
                            <div class="box">
                                    ...
                                    <a href="portfolio-single-image.html" class="over">
                                        <div class="holder">
                                            <div class="frame">
                                                <div class="over-frame">
                                                    <span class="plus">+</span>
                                                    <strong class="title">adipiscing elit</strong>
                                                    <p>product</p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <!-- portfolio block coll-2 nospace -->
                        <div class="portfolio-block coll-2 nospace work-illustration">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder half">
                                    <a href="portfolio-single-image.html" class="over">
                        ...
                        <!-- portfolio block coll-2 nospace -->
                        <div class="portfolio-block coll-2 nospace work-products">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder half">
                                    <a href="portfolio-single-image.html" class="over">
