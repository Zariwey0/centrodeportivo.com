													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-toggles.html"><i class="fa fa-bolt"></i> TOGGLE</a></li>
															</ul>
														</div>
													</div>
												</div>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">toggles</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">toggles</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-toggles.html"><i class="fa fa-caret-right"></i> Toggles</a></li>
