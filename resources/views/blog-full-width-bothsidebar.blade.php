																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-full-width-bothsidebar.html">both SIDEBAR</a></li>
																			</ul>
																		</div>
																	</li>
																	<li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG FULL WIDTH both sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<div class="container padding-top-100">
					<div class="row">
						<div class="col-xs-12 col-md-6 col-md-push-3">
										...
										<div class="beans-mask">
											<div class="beans-slideset">
												...
												<div class="beans-slide">
													<a href="blog-single-slider.html"><img src="http://placehold.it/570x235" alt="image description" class="img-responsive"></a>
												</div>
												<!-- beans-slide -->
												<div class="beans-slide">
													<a href="blog-single-slider.html"><img src="http://placehold.it/570x235" alt="image description" class="img-responsive"></a>
							...
							<article class="blog-post-v1">
								<div class="img-box">
									<a href="blog-single-image.html"><img src="http://placehold.it/570x235" alt="image description" class="img-responsive"></a>
								</div>
								<div class="blog-txt">
							...
							<article class="blog-post-v1">
								<div class="img-box">
									<div class="box">
										<a href="blog-single-3column.html"><img src="http://placehold.it/180x180" alt="image description" class="img-responsive"></a>
									</div>
									<div class="box">
										<a href="blog-single-3column.html"><img src="http://placehold.it/180x180" alt="image description" class="img-responsive"></a>
									</div>
