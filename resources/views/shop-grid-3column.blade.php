												...
												<div class="drop">
													<ul class="list-unstyled">
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	<li class="active"><a href="shop-grid-3column.html">3 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">SHOP</a></li>
									<li class="active"><a href="#">SHOP grids 3 column</a></li>
								</ul>
							</div>
						</div>
				    </div>
							...
							<div class="products-holder side">
								...
								<article class="new-product" data-delay="200" data-animate="fadeInUp">
									<div class="product-img">
										<img src="http://placehold.it/365x500" alt="image description">
