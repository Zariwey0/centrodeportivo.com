																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-grids-3column-nospace.html">3 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog grids 3 column no space</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							<div class="col-xs-12">
								<div class="blog-masonry-holder" id="masonry-container">
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style3 item nospace">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/400x240" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
								...
								<nav class="blog-footer style2 text-center">
									<a href="blog-grids-3column-nospace.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
						</div>
					</div>
