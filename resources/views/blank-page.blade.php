...
<body>
	...
	<div id="wrapper">
		<div class="w1">
			...
			<main id="main" role="main" class="padding-top-60">
				<div class="container blank-page padding-top-100 padding-bottom-100">
                    <!-- page heading -->
                    <header class="page-heading">
                        <div class="heading">
                            <h2 class="lime text-uppercase font-medium">Hi, This is a blank page<span class="dot">.</span></h2>
                            <p>Quality means building the customer’s point of view into every aspect of a product from design to final recycling.</p>
                        </div>
                    </header>
					<div class="row">
