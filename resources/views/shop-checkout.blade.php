				...
				<header class="page-banner">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Checkout</h1>
							...
							<div class="block">
								...
								<form action="#" class="update-form">
									<fieldset>
										...
										<input class="btn btn-slider" type="submit" value="ORDER NOW">
									</fieldset>
								</form>
							</div>
						</div>
						...
						<div class="col-sm-4 col-xs-12">
							...
							<form action="#" class="update-form">
								<fieldset>
									...
									<label for="check1" class="label-checks">
										<input type="checkbox" id="check1">
										<span class="txt">Create an account</span>
									</label>
									<label for="check2" class="label-checks">
										<input type="checkbox" id="check2">
										<span class="txt">Ship the same address</span>
									</label>
								</fieldset>
							</form>
						</div>
