		...
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-thumbnails.html"><i class="fa fa-bolt"></i> THUMBNAILS</a></li>
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">thumbnails</h1>
								</div>
				...
				<div class="container padding-top-100">
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3 about-section2 padding-zero">
							<div class="row">
								<div class="col-xs-12 col-sm-6 col-md-4">
									<!-- img box -->
									<div class="img-box margin-bottom-30" data-animate="fadeInUp" data-delay="150">
										<img src="http://placehold.it/270x190" alt="image description" class="img-responsive">
									</div>
									<!-- img box -->
									<div class="img-box margin-bottom-30" data-animate="fadeInUp" data-delay="200">
										<img src="http://placehold.it/270x190" alt="image description" class="img-responsive">
									</div>
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
									<!-- img box -->
									<div class="img-box margin-bottom-30" data-animate="fadeInRight" data-delay="300">
										<img src="http://placehold.it/270x410" alt="image description" class="img-responsive">
									</div>
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
									<!-- img box -->
										...
										<div class="beans-mask">
											<div class="beans-slideset">
												<div class="beans-slide">
													<img src="http://placehold.it/435x280" alt="image description" class="img-responsive">
												</div>
												<div class="beans-slide">
													<img src="http://placehold.it/435x280" alt="image description" class="img-responsive">
												</div>
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-thumbnails.html"><i class="fa fa-caret-right"></i> Thumbnails</a></li>
