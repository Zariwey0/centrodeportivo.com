...
<head>
	...
	<!-- include the morphext stylesheet  -->
	<link rel="stylesheet" type="text/css" href="css/morphext.css">
    <!-- include the site animation stylesheet  -->
    <link rel="stylesheet" href="css/animate.css" type="text/css" />
    <!-- include the site media element player stylesheet  -->
	<link rel="stylesheet" type="text/css" media="all" href="css/mediaelementplayer.css">
	<!-- include the site mejs skins stylesheet  -->
	<link rel="stylesheet" type="text/css" media="all" href="css/mejs-skins.css">
</head>
<body>
	<!-- Page pre loader -->
    <div id="pre-loader">
	...
	<div id="wrapper">
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															...
															<ul class="list-unstyled">
																...
																<li class="active"><a href="index-blog-3.html">Home - Blog 3</a></li>
			...
			<!-- welcom banner style4 -->
			<section class="welcom-banner style4">
						...
						<section class="col-xs-12">
							<div class="banner-section win-height">
								<div class="welcome-heading">
									<h1>HI, IM <span id="js-rotating">AKRAM, Arfa, Fatah, Fatima</span></h1>
									<p>Welcome to WordPress. This is your first post. Edit or delete it, then start bloggin <br>Molestias excepturi sint occaecati cupiditate non provident similique sunt expedita <br>distinction.</p>
									<div class="buttons-box">
										<a href="about-me.html" class="btn btn-f-default">ABOUT ME</a>
									</div>
								</div>
							</div>
						</section>
			...
			<main id="main" role="main">
				<!-- blog section -->
				<section class="blog-section padding-top-90 padding-bottom-90">
                    <!-- page heading -->
                    <header class="page-heading dark-style">
                        <h2 class="heading6 playfair lime text-capitalize">Latest Articles</h2>
                    </header>
					<!-- beans-stepslider -->
						...
						<div class="beans-mask">
							<div class="beans-slideset">
								...
								<div class="beans-slide">
									<article class="blog-m-post">
										<a href="blog-single-slider.html"><img src="http://placehold.it/635x245" alt="image description" class="img-responsive"></a>
										<div class="blog-box">
										...
										<div class="blog-text">
											<h3><a href="blog-single-slider.html">Why Does Music Feel So Good?</a></h3>
											<ul class="meta list-inline">
												...
												<li>
													...
													<a href="blog-single-slider.html">Business</a>, <a href="blog-single-slider.html">Technologies</a>, <a href="blog-single-slider.html">Sport</a> 
												</li>
												<li>
								...
								<div class="beans-slide">
									<article class="blog-m-post">
										...
										<div class="blog-text">
											<h3><a href="blog-single-slider.html">All Things Workplace: Change &amp; Transitions</a></h3>
											<ul class="meta list-inline">
												<li>
													<i class="fa fa-user"></i>
													By <a href="blog-single-slider.html">Admin name</a>
								...
								<div class="beans-slide">
									<article class="blog-m-post">
										...
										<div class="blog-text">
											<h3><a href="blog-single-slider.html">Intelegent transitions in ux design</a></h3>
											<ul class="meta list-inline">
												<li>
													<i class="fa fa-user"></i>
													By <a href="blog-single-slider.html">Admin name</a>
				...
				<!-- blog container -->
				<section class="blog-container bg-grey">
					<div class="container">
                        <!-- page heading -->
                        <header class="page-heading dark-style">
                            <h2 class="heading6 playfair lime text-capitalize">All Articles</h2>
                        </header>
						<div class="row">
							<div class="col-xs-12">
								<article class="blog-post-v1 style2">
										...
										<div class="beans-slider" data-rotate="true">
											<div class="beans-mask">
												<div class="beans-slideset">
													<!-- beans-slide 1 -->
													<div class="beans-slide">
														<a href="blog-single-3column.html"><img src="http://placehold.it/570x420" alt="image description" class="img-responsive"></a>
													</div>
													<!-- beans-slide 2 -->
													<div class="beans-slide">
														<a href="blog-single-3column.html"><img src="http://placehold.it/570x420" alt="image description" class="img-responsive"></a>
									...
									<!-- blog-txt -->
									<div class="blog-txt">
										<h2><a href="blog-single-3column.html">Why Does Music Feel So Good?</a></h2>
										<ul class="meta list-inline">
											<li>
												<i class="fa fa-user"></i>
								...
								<article class="blog-post-v1 style2">
									<!-- img-box -->
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/570x420" alt="image description" class="img-responsive"></a>
									</div>
									<!-- blog-txt -->
									<div class="blog-txt">
								...
								<article class="blog-post-v1 style2">
									...
									<div class="img-box video-area">
										<video width="100%" height="100%">
											...
											<source src="media/video1.ogv" type="video/ogv">
											<source src="media/video1.webm" type="video/webm">
										</video>
									</div>
									<!-- blog-txt -->
									<div class="blog-txt">
										<h2><a href="blog-single-video.html">Video post</a></h2>
										<ul class="meta list-inline">
											<li>
												<i class="fa fa-user"></i>
												By <a href="blog-single-video.html">Admin name</a>
											</li>
											<li>
												<i class="fa fa-tags"></i>
												<a href="blog-single-video.html">Music</a>, <a href="blog-single-video.html">Technologies</a>, <a href="blog-single-video.html">People</a> 
											</li>
											<li>
												<i class="fa fa-heart"></i>
												<a href="blog-single-video.html">14</a>
											</li>
											<li>
												<i class="fa fa-comments"></i>
												<a href="blog-single-video.html">320</a>
											</li>
										</ul>
										<p>In a professional context it often happens that private or corporate clients corder a publication to be made and presented with the actual content still not being ready. Think of a news blog that's filled with content hourly on the day of going live. However, reviewers tend to be distracted by comprehensible content, say, a random text copied  newspaper or the internet. The are likely to focus on the text.</p>
										<a href="blog-single-video.html" class="more">[ CONTINUE READING ]</a>
										<!-- box-holder -->
										<div class="box-holder">
											<span class="icon"><i class="fa fa-video-camera"></i></span>
											<time datetime="2015-02-18">
								...
								<article class="blog-post-v1 style2">
									...
									<div class="img-box audio-area">
										<audio controls>
											<source src="media/Halka-Halka-Suroor.mp3" type="audio/mpeg">
											Your browser does not support the audio element.
										</audio>
										<img src="http://placehold.it/570x420" alt="image description" class="img-responsive">
									</div>
									<!-- blog-txt -->
									<div class="blog-txt">
										<h2><a href="blog-single-audio.html">Soundcloud post</a></h2>
										<ul class="meta list-inline">
											<li>
												<i class="fa fa-user"></i>
												By <a href="blog-single-audio.html">Admin name</a>
											</li>
											<li>
												<i class="fa fa-tags"></i>
												<a href="blog-single-audio.html">Music</a>, <a href="blog-single-audio.html">Technologies</a>, <a href="blog-single-audio.html">People</a> 
											</li>
											<li>
												<i class="fa fa-heart"></i>
												<a href="blog-single-audio.html">14</a>
											</li>
											<li>
												<i class="fa fa-comments"></i>
												<a href="blog-single-audio.html">320</a>
											</li>
										</ul>
										<p>In a professional context it often happens that private or corporate clients corder a publication to be made and presented with the actual content still not being ready. Think of a news blog that's filled with content hourly on the day of going live. However, reviewers tend to be distracted by comprehensible content, say, a random text copied  newspaper or the internet. The are likely to focus on the text, disregarding the layout and its elements. Besides, random text risks to be unintendedly humorous or offensive, an unacceptable risk in corporate environments.</p>
										<a href="blog-single-audio.html" class="more">[ CONTINUE READING ]</a>
										<!-- box-holder -->
										<div class="box-holder">
											<span class="icon"><i class="fa fa-picture-o"></i></span>
											<time datetime="2015-02-18">
								...
								<nav class="blog-footer style2 text-center">
									<a href="index-blog-3.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
						</div>
					</div>
			...
			<!-- footer of the page -->
			<footer id="footer" class="style24">
				<!-- socialize holder -->
							...
							<div class="col-xs-12 col-sm-6 col-md-3 info-box column1">
								...
								<div class="f-our-mission">
									...
									<div class="f-mission-box">
										...
										<a href="#" class="btn-more">READ MORE <i class="fa fa-angle-double-right"></i></a>
									</div>
								</div>
							</div>
