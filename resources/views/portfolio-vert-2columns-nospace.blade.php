						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-inline breadcrumbs">
									...
									<li class="active"><a href="#">PORTFOLIO VERTICAL 2 COLUMN no space</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="stretch">
						<img src="http://placehold.it/1920x400" alt="image description">
					</div>
				</header>
			    <!-- work section -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="icotop-holder margin-bottom-60" id="work">
                                    <!-- portfolio block nospace coll-2 -->
                                    <div class="portfolio-block nospace coll-2 work-design">
                                        <!-- box -->
                                        <div class="box">
                                            ...
                                            <div class="stretch">
                                                <img src="http://placehold.it/585x585" alt="image description">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- portfolio block nospace col-2 -->
                                    <div class="portfolio-block nospace coll-2 work-fashion">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace col-2 -->
                                    <div class="portfolio-block nospace coll-2 work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace col-2 -->
                                    <div class="portfolio-block nospace coll-2 work-products">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
								...
								<div class="text-center">
									<a href="portfolio-vert-2columns-nospace.html" class="btn btn-load">LOAD MORE</a>
								</div>
							</div>
						</div>
					</div>
