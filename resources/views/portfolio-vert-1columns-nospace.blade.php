						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-inline breadcrumbs">
									...
									<li class="active"><a href="#">PORTFOLIO VERTICAL 1 COLUMN nospace</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="icotop-holder margin-bottom-30" id="work">
                                    ...
                                    <div class="portfolio-block nospace work-design">
                                        <!-- box -->
                                        <div class="box">
                                    ...
                                    <!-- portfolio block nospace -->
                                    <div class="portfolio-block nospace work-fashion">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder half">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace -->
                                    <div class="portfolio-block nospace work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder half">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace -->
                                    <div class="portfolio-block nospace work-products">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder half">
                                                <div class="over">
								...
								<div class="text-center">
									<a href="portfolio-vert-1columns-nospace.html" class="btn btn-load">LOAD MORE</a>
								</div>
							</div>
						</div>
					</div>
