															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="blog-masonry-2column-nospace.html">2 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog MASONRY 2 column no space</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							<div class="col-xs-12">
								...
								<div class="blog-masonry-holder" id="work">
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style5 blog-design nospace">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/600x360" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
									...
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style5 blog-fashion nospace">
										<div class="img-box">
											<div class="beans-slider" data-rotate="true">
												<div class="beans-mask">
													<div class="beans-slideset">
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/600x410" alt="image description" class="img-responsive"></a>
														</div>
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/600x410" alt="image description" class="img-responsive"></a>
														</div>
									...
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style5 blog-illustration nospace">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/600x300" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
									...
									<!-- blog-post-v1 -->
									<article class="blog-post-v1 style5 blog-products nospace">
									...
									<article class="blog-post-v1 style5 blog-fashion nospace">
										...
										<div class="blog-txt">
											<h2><a href="blog-single-blockquote.html">Soundcloud post</a></h2>
											<ul class="meta list-inline">
												<li>
													<i class="fa fa-user"></i>
									...
									<article class="blog-post-v1 style5 blog-products nospace">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/600x380" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
								...
								<nav class="blog-footer style2 text-center">
									<a href="blog-masonry-2column-nospace.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
						</div>
					</div>
