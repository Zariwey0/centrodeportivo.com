														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="portfolio-parallex-fullwidth.html">parallax full width</a></li>
																</ul>
															</div>
														</li>
														<li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO parallax full width</a></li>
								</ul>
							</div>
						</div>
				    </div>
