													...
													<div class="drop-holder">
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-carousel.html"><i class="fa fa-eye"></i> CAROUSAL</a></li>
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Carousel</h1>
								</div>
				...
				<section class="finest-chef container">
                    ...
                    <header class="page-heading">
                        <h2 class="heading lime text-capitalize font-medium">Chef Carousel</h2>
                    </header>
					<div class="row">
						<div class="col-xs-12">
							<!-- beans-stepslide -->
								...
								<div class="beans-mask">
									<div class="beans-slideset">
										...
										<article class="beans-slide">
											<div class="img-box">
												<img src="http://placehold.it/370x370" alt="image descriptio">
											</div>
											<h3>Mark Doe</h3>
				...
				<div class="container">
                    <!-- page heading -->
                    <header class="page-heading">
                        <h2 class="heading lime text-capitalize font-medium">Shop Carousel</h2>
                    </header>
					<div class="row related-shop padding-bottom-100">
						<div class="col-xs-12">
								<!-- beans-stepslide -->
										...
										<div class="beans-slide">
											<article class="new-product">
												<div class="product-img">
													<img alt="image description" src="http://placehold.it/270x370">
													<div class="product-over">
														<div class="frame">
															<div class="box">
																<a class="btn btn-f-default" href="#">QUICK VIEW</a>
															</div>
														</div>
													</div>
												</div>
				...
				<!-- work section -->
				<section class="work-section padding-bottom-90">
                    <!-- page heading -->
                    <header class="page-heading">
                        <div class="heading">
                            <h2 class="lime text-capitalize font-medium">Portfolio Carousel - Full Width</h2>
								...
								<div class="beans-slide">
									...
									<div class="portfolio-block nospace">
										...
										<div class="box">
											...
											<img src="http://placehold.it/480x480" alt="image description">
										</div>
									</div>
								</div>
								<!-- beans-slide-2 -->
				...
				<section class="work-section padding-bottom-90">
                    ...
                    <header class="page-heading">
                        <div class="heading">
                            <h2 class="lime text-capitalize font-medium">Portfolio Carousel Style 2 - Full Width</h2>
                        </div>
                    </header>
					<!-- beans-stepslider -->
					<div class="beans-stepslider work-slider" data-rotate="true">
						...
						<div class="text-center container padding-top-60"><a class="btn btn-dark" href="portfolio-2columns.html">VIEW ALL</a></div>
					</div>
				</section>
				<!-- blog section2 -->
				<section class="blog-section padding-bottom-90">
                    <!-- page heading -->
                    <header class="page-heading">
                        <h2 class="heading lime text-capitalize font-medium">blog Carousel - Full Width</h2>
                    </header>
					<!-- beans-stepslide -->
					<div class="beans-stepslider">
						<div class="beans-mask">
							<div class="beans-slideset">
								...
								<div class="beans-slide">
								    <article class="blog-m-post">
                                        <a href="blog-single-image.html"><img src="http://placehold.it/640x240" alt="image description" class="img-responsive"></a>
                                        <div class="blog-box">
