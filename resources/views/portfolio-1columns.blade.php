															...
															<div class="drop">
																<ul class="list-unstyled">
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				<li class="active"><a href="portfolio-1columns.html">1 column</a></li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO 1 COLUMN </a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<section class="work-section padding-top-90 padding-bottom-90 space">
                    ...
                    <div class="icotop-holder margin-bottom-30" id="work">
                        <!-- portfolio block -->
                        <div class="portfolio-block  work-design">
                            <!-- box -->
                            <div class="box">
                                ...
                                <div class="stretch">
                                    <img src="http://placehold.it/1200x600" alt="image description">
                                </div>
                            </div>
                        </div>
                        <!-- portfolio block -->
                        <div class="portfolio-block work-fashion">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder half">
                                    <a href="portfolio-single-image.html" class="over">
                        ...
                        <!-- portfolio block -->
                        <div class="portfolio-block work-illustration">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder half">
                                    <a href="portfolio-single-image.html" class="over">
