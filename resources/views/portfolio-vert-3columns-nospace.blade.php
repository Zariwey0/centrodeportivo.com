						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-inline breadcrumbs">
									...
									<li class="active"><a href="#">PORTFOLIO VERTICAL 3 COLUMN nospace</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="icotop-holder margin-bottom-60" id="work">
                                    <!-- portfolio block nospace coll-3 -->
                                    <div class="portfolio-block nospace coll-3 work-design">
                                        <!-- box -->
                                        <div class="box">
                                            ...
                                            <div class="stretch">
                                                <img src="http://placehold.it/390x390" alt="image description">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- portfolio block nospace coll-3 -->
                                    <div class="portfolio-block nospace coll-3 work-fashion">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace coll-3 -->
                                    <div class="portfolio-block nospace coll-3 work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace coll-3 -->
                                    <div class="portfolio-block nospace coll-3 work-products">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
