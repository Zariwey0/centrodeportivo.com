													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-tabs.html"><i class="fa fa-bolt"></i> TABS</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">tabs</h1>
								</div>
				...
				<div class="container padding-top-100">
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							...
							<!-- mytab content -->
							<div id="myTabContent" class="tab-content margin-bottom-30">
                            ...
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Pills Navigation Style</h2>
                            </header>
							<!-- mytab2 -->
							<ul id="myTab2" class="nav nav-pills boot-tabs">
							  ...
							  <li><a href="#work3" data-toggle="tab">Work</a></li>
							  <li><a href="#all4" data-toggle="tab">All</a></li>
							</ul>
							<!-- mytab content 2 -->
							<div id="myTabContent2" class="tab-content">
							  ...
							  <div class="tab-pane fade" id="work3">
								<p>Etsy mixtape wayfarers, ethical wes anderson tofu before they sold out mcsweeney's organic lomo retro fanny pack lo-fi farm-to-table readymade. Messenger bag gentrify pitchfork tattooed craft beer, iphone skateboard locavore carles etsy salvia banksy hoodie helvetica. DIY synth PBR banksy irony. Leggings gentrify squid 8-bit cred pitchfork. Williamsburg banh mi whatever gluten-free, carles pitchfork biodiesel fixie etsy retro mlkshk vice blog. Scenester cred you probably haven't heard of them, vinyl craft beer blog stumptown. Pitchfork sustainable tofu synth chambray yr.</p>
							  </div>
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-tabs.html"><i class="fa fa-caret-right"></i> Tabs</a></li>
