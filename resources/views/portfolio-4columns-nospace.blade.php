																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="portfolio-4columns-nospace.html">4 column</a></li>
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        ...
                        <div class="portfolio-block coll-4 nospace work-design">
                            ...
                            <div class="box">
                                ...
                                <div class="stretch">
                                    <img src="http://placehold.it/300x300" alt="image description">
                                </div>
                            </div>
                        </div>
                        <!-- portfolio block coll-4 nospace -->
                        <div class="portfolio-block coll-4 nospace work-fashion">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <a href="portfolio-single-image.html" class="over">
                        ...
                        <!-- portfolio block coll-4 nospace -->
                        <div class="portfolio-block coll-4 nospace work-products">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <a href="portfolio-single-image.html" class="over">
                        ...
                        <!-- portfolio block coll-4 nospace -->
                        <div class="portfolio-block coll-4 nospace nospace work-fashion">
                            <!-- box -->
                            <div class="box">
                                <div class="box-holder">
                                    <a href="portfolio-single-image.html" class="over">
