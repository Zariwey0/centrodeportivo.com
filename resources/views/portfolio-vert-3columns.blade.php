						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-inline breadcrumbs">
									...
									<li class="active"><a href="#">PORTFOLIO VERTICAL 3 COLUMN</a></li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div class="icotop-holder margin-bottom-30" id="work">
                                    ...
                                    <div class="portfolio-block coll-3 work-design">
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="stretch">
                                                <img src="http://placehold.it/360x360" alt="image description">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- portfolio block coll-3 -->
                                    <div class="portfolio-block coll-3 work-fashion">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block coll-3 -->
                                    <div class="portfolio-block coll-3 work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block coll-3 -->
                                    <div class="portfolio-block coll-3 work-products">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
