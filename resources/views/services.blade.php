	...
	<div id="wrapper">
			...
			<main id="main" role="main">
				...
				<div class="banner">
					...
					<div class="parallax-holder">
						<div class="parallax-frame"><img src="http://placehold.it/1920x400" height="400" width="1920" alt="image description"></div>
					</div>
				</div>
				<!-- services section -->
				<section class="services-section container padding-top-90 padding-bottom-60 style7">
                    ...
                    <header class="page-heading">
                        <h2 class="lime text-capitalize font-medium">Core features</h2>
					...
					<div class="row holder">
						...
						<div class="col-xs-12 col-md-4 hidden-xs">
							<img src="http://placehold.it/200x410" alt="image description" class="img">
						</div>
						<div class="col-xs-12 col-md-4">
							<!-- box -->
							<div class="box" data-animate="fadeIn" data-delay="200">
					...
					<div class="container create-business">
						<div class="row">
							<article class="col-sm-6 col-xs-12 business-col">
								<h2>We create your business to sucess</h2>
								...
								<p>Fusce vel risus leo. Donec in venenatis felis.Maecenas non sem tincidunt, posuere elit in, accumsan nisl. In lorem nisi, scelerisque vitae tristique euismod, tincidunt non arcu. Cras suscipit ligula pulvinar scelerisque sed mollis mi.</p>
								<div class="buttons-box">
									<a href="features.html" class="btn btn-f-info">FEATURES</a>
									<a href="http://fekra.csshunter.com" class="btn btn-f-default get">GET STRATED</a>
								</div>
							</article>
							<div class="col-sm-6 col-xs-12" data-animate="fadeInUp" data-delay="300">
								<div class="img-box">
									<img class="img-responsive" src="http://placehold.it/570x465" alt="image description">
								</div>
							</div>
						</div>
					</div>
				...
				<section class="container padding-top-90 padding-bottom-90">
					...
					<div class="row">
						<div class="col-xs-12 col-md-4" data-animate="fadeInLeft" data-delay="300">
							<img src="http://placehold.it/375x520" height="520" width="377" alt="image description" class="img">
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4">
							...
							<div class="f-iconbox margin-bottom-30" data-animate="fadeInUp" data-delay="300">
								...
								<span class="title">Great Support</span>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
							</div>
							<!-- f iconbox -->
							...
							<div class="f-iconbox margin-bottom-30" data-animate="fadeInUp" data-delay="500">
								...
								<span class="title">Browser Compatibility</span>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4">
							...
							<div class="f-iconbox margin-bottom-30" data-animate="fadeInUp" data-delay="400">
								...
								<span class="title">Alot of  Elements</span>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry It has survived not only five centuries.</p>
							</div>
							<!-- box -->
							<div class="f-iconbox margin-bottom-30" data-animate="fadeInUp" data-delay="500">
				...
				<!-- section -->
				<div class="padding-top-90 padding-bottom-30 bg-grey">
                    <div class="container">
                        <div class="row">
                            <article class="features-col style3 col-sm-6 col-xs-12">
                                <h2>Why Choose Us</h2>
                                <div class="tabs-block">
                                    <!-- Nav tabs -->
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#responsive" aria-controls="responsive" role="tab" data-toggle="tab">Responsive</a></li>
                                        <li role="presentation"><a href="#retina" aria-controls="retina" role="tab" data-toggle="tab">Retina Ready</a></li>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="responsive">
                                            <div class="alignleft">
                                                <img class="img-responsive" src="http://placehold.it/167x167" alt="image description">
                                            </div>
                                            <div class="text-box">
                                                ...
                                                <p>labore et dolore a le ad minim veniam, quis nostrud  ullamco laboris. Lite amet.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-heading" role="tab" id="headingOne">
                                            <h3 class="panel-title">
                                                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                    <i class="fa fa-cog"></i>Theme Options
                                                </a>
                                            </h3>
                                        </div>
                                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="panel-body">
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elited do eiusmod tempor incididunt ut labore et dolore a le ad veniam, quis nostrud citation ullamco laboris. Lite amet, consectetur adipisicing elit.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingTwo">
                                            <h3 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                    <i class="fa fa-futbol-o"></i>Great Support
                                                </a>
                                            </h3>
                                        </div>
                                        ...
                                        <div class="panel-heading" role="tab" id="headingThree">
                                            <h3 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                    <i class="fa fa-globe"></i>Browser Cpmatibility
                                                </a>
                                            </h3>
                                        </div>
				...
				<section class="price-section style2 style3">
                    <div class="container">
                        <!-- page heading -->
                        <header class="page-heading">
                            <h2 class="lime text-capitalize font-medium">Pricing Table</h2>
                            <p>Will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it<br> has a more-or-less normal distribution of letters</p>
                        </header>
						<div class="row">
		...
		<div class="popup-holder">
			...
			<div id="popup1" class="lightbox team-lightbox">
				<div class="img-box">
					<img src="images/team/img01.jpg" alt="image description"/>
				</div>
				<div class="holder">
			...
			<div id="popup2" class="lightbox team-lightbox">
				<div class="img-box">
					<img src="images/team/img02.jpg" alt="image description"/>
				</div>
				<div class="holder">
			...
			<div id="popup3" class="lightbox team-lightbox">
				<div class="img-box">
					<img src="images/team/img03.jpg" alt="image description"/>
				</div>
				<div class="holder">
			...
			<div id="popup4" class="lightbox team-lightbox">
				<div class="img-box">
					<img src="images/team/img04.jpg" alt="image description"/>
				</div>
				<div class="holder">
