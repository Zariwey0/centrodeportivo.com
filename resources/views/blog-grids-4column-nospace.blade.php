																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-grids-4column-nospace.html">4 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog grids 4 column no space</a></li>
								</ul>
							</div>
						</div>
				    </div>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="blog-masonry-holder" id="masonry-container">
								<!-- blog-post-v1 -->
								<article class="blog-post-v1 style6 item nospace">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/305x185" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
											...
											<div class="beans-mask">
												<div class="beans-slideset">
													<div class="beans-slide">
														<a href="blog-single-slider.html"><img src="http://placehold.it/305x205" alt="image description" class="img-responsive"></a>
													</div>
													<div class="beans-slide">
														<a href="blog-single-slider.html"><img src="http://placehold.it/305x205" alt="image description" class="img-responsive"></a>
													</div>
								...
								<article class="blog-post-v1 style6 item nospace">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/305x150" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
										<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
								...
								<article class="blog-post-v1 style6 item nospace">
									<div class="img-box">
										<a href="blog-single-blockquote.html"><img src="http://placehold.it/305x195" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
										<h2><a href="blog-single-blockquote.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
