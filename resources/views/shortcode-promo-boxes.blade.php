											...
											<li class="active">
												...
												<div class="mega-drop">
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																<li class="active"><a href="shortcode-promo-boxes.html"><i class="fa fa-bolt"></i> PROMO BOXES</a></li>
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">promo boxes</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">promo boxes</a></li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div class="collection-over">
									<div class="frame">
										<div class="box">
											...
											<a href="#" class="btn-shop">SHOP NOW <i class="fa fa-angle-right"></i></a>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="collection-over add">
											<div class="frame">
												<div class="box">
													...
													<a href="#" class="btn-shop">FIND NOW <i class="fa fa-angle-right"></i></a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="collection-over add">
											<div class="frame">
												<div class="box">
													...
													<a href="#" class="btn-shop">BUY NOW <i class="fa fa-angle-right"></i></a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="collection-over add2">
									<div class="frame">
										<div class="box">
											...
											<a href="#" class="btn-shop">VIEW RANGE <i class="fa fa-angle-right"></i></a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<article class="col-xs-12 install-demos">
								<div class="txt-box">
									...
									<a href="#" class="btn btn-slider">PURCHASE NOW</a>
								</div>
							</article>
						</div>
					</section>
				...
				<div class="get-app">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<span class="heading">GET IT RIGHT NOW !</span>
								<p>Our app is available for download of the following</p>
						...
						<div class="row">
							<section class="col-xs-12 special-content">
								<div class="special-box">
									...
									<a href="#" class="btn btn-f-default">GET IT NOW</a>
								</div>
							</section>
						</div>
					</div>
