		...
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															...
															<ul class="list-unstyled">
																...
																<li class="active"><a href="index-blog-2.html">Home - Blog 2</a></li>
			...
			<main id="main" role="main">
				...
				<div class="blog-mainbanner">
									...
									<div class="beans-mask">
										<div class="beans-slideset">
											...
											<div class="beans-slide">
												<p>Journalism will kill you,  <br>but it will keep you alive while you’re at it.</p>
												<span class="title">- Horace Greeley -</span>
											</div>
											<!-- beans-slide 2 -->
											<div class="beans-slide">
												<p>Journalism will kill you,  <br>but it will keep you alive while you’re at it.</p>
					...
					<div class="stretch">
						<img alt="image description" src="http://placehold.it/1920x600" >
					</div>
				</div>
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<!-- blog post v1 style4 -->
							<article class="blog-post-v1 style4">
								<div class="img-box">
									<!-- beans-slider -->
									<div class="beans-slider" data-rotate="true">
										<div class="beans-mask">
											<div class="beans-slideset">
												<!-- beans-slide 1 -->
												<div class="beans-slide">
													<a href="blog-single-slider.html"><img src="http://placehold.it/1170x480" alt="image description" class="img-responsive"></a>
												</div>
												<!-- beans-slide 2 -->
												<div class="beans-slide">
													<a href="blog-single-slider.html"><img src="http://placehold.it/1170x480" alt="image description" class="img-responsive"></a>
							...
							<article class="blog-post-v1 style4">
								<!-- img-box -->
								<div class="img-box">
									<a href="blog-single-image.html"><img src="http://placehold.it/1170x480" alt="image description" class="img-responsive"></a>
								</div>
								<!-- blog-txt -->
								<div class="blog-txt">
							...
							<article class="blog-post-v1 style4">
								...
								<div class="img-box">
									<div class="box">
										<a href="blog-single-3column.html"><img src="http://placehold.it/370x370" alt="image description" class="img-responsive"></a>
									</div>
									<div class="box">
										<a href="blog-single-3column.html"><img src="http://placehold.it/370x370" alt="image description" class="img-responsive"></a>
									</div>
							...
							<article class="blog-post-v1 style4">
								...
								<!-- blog-txt -->
								<div class="blog-txt">
									<h2><a href="blog-single-audio.html">Audio post</a></h2>
									<ul class="meta list-inline">
										<li>
											<i class="fa fa-user"></i>
							...
							<!-- blog footer style3 -->
							<nav class="blog-footer style3">
								<div class="btn-box">
									<a href="index-blog-2.html" class="btn">PREVIOUS</a>
									<a href="index-blog-2.html" class="btn">NEXT</a>
								</div>
								<ul class="b-pagination list-unstyled">
									<li><a href="index-blog-2.html">1</a></li>
									<li class="active"><a href="index-blog-2.html">2</a></li>
									<li><a href="index-blog-2.html">3</a></li>
									<li><a href="index-blog-2.html">4</a></li>
								</ul>
							</nav>
						</div>
					</div>
			...
			<!-- footer of the page -->
			<footer id="footer" class="style21">
				<!-- f blog social -->
				<ul class="f-blog-social">
					<li class="facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
					<li class="google"><a href="#"><i class="fa fa-google-plus"></i></a></li>
					<li class="twitter"><a href="#"><i class="fa fa-twitter"></i></a></li>
					<li class="pinterest"><a href="#"><i class="fa fa-dribbble"></i></a></li>
				</ul>
				<!-- footer cent -->
