	...
	<div id="wrapper">
		<div class="w1">
																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-alt-timeline-default-rightsidebar.html">RIGHT SIDEBAR</a></li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG alt timeline right sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<!-- personal exper -->
				<section class="personal-exper style3 sidebar padding-top-100">
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-8 col-md-9">
								...
								<nav class="blog-footer style2 text-center">
									<a href="blog-timeline-default.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
