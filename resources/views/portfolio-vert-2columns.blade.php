						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-inline breadcrumbs">
									...
									<li class="active"><a href="#">PORTFOLIO VERTICAL 2 COLUMN</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="stretch">
						<img src="http://placehold.it/1290x200" alt="image description">
					</div>
				</header>
				<section class="work-section style9 bg-grey dark-bottom-border padding-top-100 padding-bottom-100">
					<div class="container-max">
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="icotop-holder margin-bottom-60" id="work">
                                    ...
                                    <div class="portfolio-block coll-2 work-design">
                                        <!-- box -->
                                        <div class="box">
                                            ...
                                            <div class="stretch">
                                                <img src="http://placehold.it/555x555" alt="image description">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- portfolio block coll-2 -->
                                    <div class="portfolio-block coll-2 work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block coll-2 -->
                                    <div class="portfolio-block coll-2 work-fashion">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block coll-2 -->
                                    <div class="portfolio-block coll-2 work-products">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
								...
								<div class="text-center">
									<a href="portfolio-vert-2columns.html" class="btn btn-load">LOAD MORE</a>
								</div>
							</div>
						</div>
					</div>
