													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-media-embeds.html"><i class="fa fa-bolt"></i> MEDIA EMBDED</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Media embeds</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">Media embeds</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
                            ...
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Vimeo Embed</h2>
                            </header>
							<div class="video-area padding-bottom-30">
								<iframe src="https://player.vimeo.com/video/88921691?title=0&byline=0&portrait=0" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
							</div>
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Youtube Embed</h2>
                            </header>
							<div class="video-area padding-bottom-30">
								<iframe width="560" height="315" src="https://www.youtube.com/embed/RDfjXj5EGqI" frameborder="0" allowfullscreen></iframe>
							</div>
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Dailymotion Embed</h2>
                            </header>
							<div class="video-area padding-bottom-30">
								<iframe frameborder="0" width="100%" height="315" src="//www.dailymotion.com/embed/video/x39d189" allowfullscreen></iframe>
							</div>
                            <!-- page heading -->
                            <header class="page-heading">
                                <h2 class="heading lime text-capitalize font-medium">Soundcloud Embed</h2>
                            </header>
							<div class="video-area padding-bottom-30">
								<iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/224822099&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
							</div>
						</div>
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-media-embeds.html"><i class="fa fa-caret-right"></i> Media Embeds</a></li>
