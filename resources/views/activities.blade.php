...
$activities = DB::table('activities')->pluck('id_type','name');
...
$img = Image::make('activitiesimages/sryvMaYUTWRUROztBfeRC5EHDVZqYg-Acuáticasgeneral1.jpg');

// crop image
$img->crop(400, 400, 25, 25);
				...
				<section class="work-section padding-top-90 padding-bottom-90">
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                    	...
                    	<?php
                    		...
                    		foreach($activities as $name => $id){
                    			
                    			echo '<div class="portfolio-block coll-3 nospace '.str_replace(' ', '-', strtolower(remove_accents($types[$id]))).'"><div class="box"><div class="box-holder">
                                    <a href="portfolio-single-image.html" class="over">
                                        <div class="holder">
                                            <div class="frame">
                                                <div class="over-frame">
                                                    <span class="plus">+</span><strong class="title">'.$name.'</strong><p>'.$types[$id].'</p></div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
