	...
	<div id="wrapper">
		<div class="w1">
																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-alt-timeline-default-leftsidebar.html">LEFT SIDEBAR</a></li>
																			</ul>
																		</div>
																	</li>
																</ul>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG alt timeline left sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<!-- personal exper -->
				<section class="personal-exper padding-top-100 style3 sidebar">
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
								<div class="p-holder" data-animate="fadeInUp" data-delay="200">
									<!-- box -->
									<div class="box">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/385x145" alt="image description" class="img-responsive"></a>
										</div>
									...
									<time class="hidden-xs" datetime="2016-01-01">2005 - 2006</time>
								</div>
								<div class="p-holder" data-animate="fadeInUp" data-delay="200">
									<!-- box -->
									<div class="box">
									...
									<span class="icon hidden-xs"><i class="fa fa-calendar"></i></span>
									<time class="hidden-xs" datetime="2016-01-01">2007 - 2008</time>
								</div>
								<div class="p-holder" data-animate="fadeInUp" data-delay="200">
									<!-- box -->
									<div class="box">
										...
										<h2><a href="blog-single-image.html">Sample Blog Post</a></h2>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									</div>
									<span class="icon hidden-xs"><i class="fa fa-calendar"></i></span>
									<time class="hidden-xs" datetime="2016-01-01">2009 - 2011</time>
								</div>
								<div class="p-holder" data-animate="fadeInUp" data-delay="200">
									<!-- box -->
									<div class="box">
									...
									<span class="icon hidden-xs"><i class="fa fa-calendar"></i></span>
									<time class="hidden-xs" datetime="2016-01-01">2012 - Present</time>
								</div>
								<nav class="blog-footer text-center style2">
									<a href="blog-single-image.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
