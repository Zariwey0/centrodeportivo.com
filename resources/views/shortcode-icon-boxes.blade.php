				...
				<div class="container padding-top-100 padding-bottom-100">
					<div class="row">
						<div class="col-xs-12 col-sm-9 col-sm-push-3">
							...
							<!-- feature-section -->
							<div class="features-section row padding-top-60 padding-bottom-60">
							...
							<div class="divider-line2"></div>
							<div class="services-section padding-bottom-60 padding-top-60 row">
								<div class="col-xs-12 col-sm-6">
									<!-- box -->
									<div class="box">
										<h3><i class="fa fa-desktop"></i> Fully Responsive</h3>
									...
									<!-- box -->
									<div class="box">
										<h3><i class="fa fa-wifi"></i> Wifi Detecation</h3>
										<p>Ut tincidunt felis ac bibendum dignissim. Nam pellentesque cursus tortor. In eu ultrices erat. Ut nec mattis erat. Interdum et malesuada fames.</p>
									</div>
								</div>
								<div class="col-xs-12 col-sm-6">
									<!-- box -->
									<div class="box">
										<h3><i class="fa fa-eye"></i> Retina Ready</h3>
										<p>Ut tincidunt felis ac bibendum dignissim. Nam pellentesque cursus tortor. In eu ultrices erat. Ut nec mattis erat. Interdum et malesuada fames.</p>
									</div>
									<!-- box -->
									<div class="box">
										<h3><i class="fa fa-map-marker"></i> GPS Ready</h3>
										<p>Ut tincidunt felis ac bibendum dignissim. Nam pellentesque cursus tortor. In eu ultrices erat. Ut nec mattis erat. Interdum et malesuada fames.</p>
									</div>
								</div>
							</div>
						...
						<aside class="col-xs-12 col-sm-3 col-sm-pull-9">
							...
							<section class="widget cate-widget">
								...
								<ul class="list-unstyled">
									...
									<li class="active"><a href="shortcode-icon-boxes.html"><i class="fa fa-caret-right"></i> Icon Boxes</a></li>
