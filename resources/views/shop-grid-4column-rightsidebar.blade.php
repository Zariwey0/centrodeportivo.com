														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="shop-grid-4column-rightsidebar.html">4 column - right sidebar</a></li>
														...
														<li>
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li><a href="shop-list-rightsidebar.html">right sidebar</a></li>
																	<li><a href="shop-list-leftsidebar.html">leftsidebar</a></li>
																</ul>
															</div>
														</li>
				...
				<header class="page-banner">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Shop</h1>
									<p>Your Solgan Here</p>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">SHOP</a></li>
									<li class="active"><a href="#">SHOP grids 4 column right sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<section class="contact-block shop container">
					<div class="row">
						<div class="col-xs-12 col-sm-9">
							<header class="row shop-header">
								<div class="col-xs-12">
									<div class="holder">
										<h2>PRODUCT NAME</h2>
										<p>Showing <a href="#">1</a> - <a href="#">12</a> of <a href="#">83</a> Results</p>
									</div>
							...
							<div class="row products-shop">
								<div class="col-xs-12">
									<div class="products-holder sidebar">
										<!-- new-product -->
										<article class="new-product" data-delay="200" data-animate="fadeInUp">
											<div class="product-img">
												<img src="http://placehold.it/200x275" alt="image description">
							...
							<footer class="row shop-footer">
								<div class="col-xs-12">
									...
									<div class="txt-box">
										<p>1 - 12 of about 83 results found for <a href="#">Product name</a></p>
									</div>
								</div>
							</footer>
						</div>
						<aside class="col-xs-12 col-sm-3">
							<!-- shop-widget -->
							<form class="shop-widget rang-form">
								<fieldset>
									<h3>Filter By Price</h3>
									<input type="range">
									<span class="num">Price: $2 - $2999</span>
									<button class="btn btn-form" type="submit">Filter</button>
								</fieldset>
							</form>
							<!-- shop-widget -->
							...
							<nav class="shop-widget">
								<h3>Size</h3>
								<ul class="list-unstyled">
									<li><a href="#">Extra Large (9)</a></li>
									<li><a href="#">Large (2)</a></li>
									<li><a href="#">Medium (1)</a></li>
									<li><a href="#">Small (3)</a></li>
									<li><a href="#">Extra Small (3)</a></li>
								</ul>
							</nav>
							<section class="shop-widget sellers-widget">
								<h3>Top Sellers</h3>
								<!-- top-seller -->
								<article class="top-seller">
									<div class="alignleft">
										<a href="#"><img class="img-responsive" alt="image description" src="http://placehold.it/70x70" ></a>
									</div>
									<div class="txt-box">
