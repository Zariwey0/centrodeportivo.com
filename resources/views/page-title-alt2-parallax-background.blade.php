																	...
																	<li class="active">
																		...
																		<div class="drop right-align">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="page-title-alt2-parallax-background.html">parallax background</a></li>
																			</ul>
																		</div>
																	</li>
																</ul>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li class="active"><a href="#">page title alt2 parallax background</a></li>
								</ul>
							</div>
						</div>
				    </div>
