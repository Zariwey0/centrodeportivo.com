						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-inline breadcrumbs">
									...
									<li class="active"><a href="#">PORTFOLIO VERTICAL 4 COLUMN no space</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="icotop-holder margin-bottom-60" id="work">
                                    <!-- portfolio block nospace coll-4 -->
                                    <div class="portfolio-block nospace coll-4 work-design">
                                        <!-- box -->
                                        <div class="box">
                                            ...
                                            <div class="stretch">
                                                <img src="http://placehold.it/410x410" alt="image description">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- portfolio block nospace coll-4 -->
                                    <div class="portfolio-block nospace coll-4 work-fashion">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace coll-4 -->
                                    <div class="portfolio-block nospace coll-4 work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace coll-4 -->
                                    <div class="portfolio-block nospace coll-4 work-products">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
								...
								<div class="text-center">
									<a href="portfolio-vert-3columns.html" class="btn btn-load">LOAD MORE</a>
								</div>
							</div>
						</div>
					</div>
