													...
													<div class="drop-holder">
														...
														<div class="coll">
															...
															<ul class="list-unstyled">
																...
																<li class="active"><a href="layout-side-navigation.html">SIDE NAVIGATION</a></li>
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">Side Navigation</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">pages</a></li>
									<li class="active"><a href="#">Side Navigation</a></li>
								</ul>
							</div>
						</div>
					</div>
                   ...
                   <div class="row">
						<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
							...
							<div class="tab-content">
								<!-- tab1 -->
								<div id="tab1">
									<h2 class="margin-t-zero margin-bottom-30">Why to Choose Us</h2>
									...
									<div class="row padding-bottom-30">
										<div class="col-xs-12 col-sm-6">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a, sagittis enim. Phasellus sit amet justo sem. Morbi et vehicula ipsum, a vestibulum tellus. Sed bibendum In consectetur nulla dignissim, volutpat .Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim,</p>
										</div>
										<div class="col-xs-12 col-sm-6">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a, sagittis enim. Phasellus sit amet justo sem. Morbi et vehicula ipsum, a vestibulum tellus. Sed bibendum In consectetur nulla dignissim, volutpat .Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim,</p>
										</div>
								...
								<!-- tab2 -->
								<div id="tab2">
									<h2 class="margin-t-zero margin-bottom-30">Our Mission & Vision</h2>
									<div class="row padding-bottom-30">
										<div class="col-xs-12">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a, sagittis enim. Phasellus sit amet justo sem. Morbi et vehicula ipsum, a vestibulum tellus. Sed bibendum In consectetur nulla dignissim, volutpat .Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a,</p>
										</div>
								...
								<!-- tab3 -->
								<div id="tab3">
									<h2 class="margin-t-zero margin-bottom-30">Our Strategy</h2>
									<div class="row padding-bottom-30">
										<div class="col-xs-12">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a, sagittis enim. Phasellus sit amet justo sem. Morbi et vehicula ipsum, a vestibulum tellus. Sed bibendum In consectetur nulla dignissim, volutpat .Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a,</p>
										</div>
								...
								<!-- tab4 -->
								<div id="tab4">
									<h2 class="margin-t-zero margin-bottom-30">Our Goals</h2>
									<div class="row padding-bottom-30">
										<div class="col-xs-12">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a, sagittis enim. Phasellus sit amet justo sem. Morbi et vehicula ipsum, a vestibulum tellus. Sed bibendum In consectetur nulla dignissim, volutpat .Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a,</p>
										</div>
								...
								<!-- tab5 -->
								<div id="tab5">
									<h2 class="margin-t-zero margin-bottom-30">Our Solution</h2>
									<div class="row padding-bottom-30">
										<div class="col-xs-12">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a, sagittis enim. Phasellus sit amet justo sem. Morbi et vehicula ipsum, a vestibulum tellus. Sed bibendum In consectetur nulla dignissim, volutpat .Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a,</p>
										</div>
								...
								<!-- tab6 -->
								<div id="tab6">
									<h2 class="margin-t-zero margin-bottom-30">Our Technologies</h2>
									<div class="row padding-bottom-30">
										<div class="col-xs-12">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a, sagittis enim. Phasellus sit amet justo sem. Morbi et vehicula ipsum, a vestibulum tellus. Sed bibendum In consectetur nulla dignissim, volutpat .Lorem ipsum dolor sit amet, consectetur adipiscing elit. consectetur adipiscing elit. Cras sapien neque, bibendum in sagittis eu, fermentum vel risus. Sed sed erat velit. Aliquam a mollis enim. In consectetur nulla dignissim, volutpat lorem a,</p>
										</div>
						...
						<aside class="col-xs-12 col-sm-4 col-md-3 col-sm-pull-8 col-md-pull-9">
							<!-- widget -->
							<section class="widget cate-widget big-icon">
								<h2>Side Navigation</h2>
								<ul class="list-unstyled beans-tabset">
									<li class="active"><a href="#tab1"><i class="fa fa-apple"></i> Why to Choose Us</a></li>
									<li><a href="#tab2"><i class="fa fa-bell"></i> Our Mission & Vision</a></li>
									<li><a href="#tab3"><i class="fa fa-bolt"></i> Our Strategy</a></li>
									<li><a href="#tab4"><i class="fa fa-car"></i> Our Goals</a></li>
									<li><a href="#tab5"><i class="fa fa-drupal"></i> Our Solution</a></li>
									<li><a href="#tab6"><i class="fa fa-gift"></i> Our Technologies </a></li>
								</ul>
							</section>
						</aside>
					</div>
