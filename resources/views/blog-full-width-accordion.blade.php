		...
		<div class="w1">
												...
												<div class="drop">
													<ul class="list-unstyled">
														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	<li class="active"><a href="blog-full-width-accordion.html">FULL WIDTH</a></li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG FULL WIDTH accordion</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<div class="container padding-top-100">
					<div class="row">
						<div class="col-xs-12 blog-section padding-zero">
							<!-- blog-accordion -->
							<ul class="blog-accordion list-unstyled">
								<!-- blog-post -->
								<li class="blog-m-post accordion">
									<a href="blog-single-image.html" class="opener"><img src="http://placehold.it/1200x205" alt="image description" class="img-responsive"></a>
									<div class="blog-txt">
