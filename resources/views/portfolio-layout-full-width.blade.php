												...
												<div class="drop">
													<ul class="list-unstyled">
														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	<li class="active"><a href="portfolio-layout-full-width.html">FULL WIDTH</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									...
									<li class="active"><a href="#"> PORTFOLIO full width</a></li>
								</ul>
							</div>
						</div>
				    </div>
                    ...
                    <div class="icotop-holder margin-bottom-60" id="work">
                        ...
                        <div class="portfolio-block coll-4 work-design">
                            ...
                            <div class="box">
                                ...
                                <img src="http://placehold.it/438x438" alt="image description" class="img-responsive">
                            </div>
                        </div>
                        <!-- portfolio block coll-4 -->
