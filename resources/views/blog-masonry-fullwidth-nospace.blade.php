																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-masonry-fullwidth-nospace.html">Full width</a></li>
																			</ul>
																		</div>
																	</li>
																</ul>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog MASONRY full width no space</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<div class="container-fluid padding-top-100">
					<div class="row">
						<div class="col-xs-12">
							...
							<!-- blog-masonry-holder -->
							<div class="blog-masonry-holder full-width add-style" id="work">
								<!-- blog-post-v1 -->
								<article class="blog-post-v1 style3 blog-design">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/385x225" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
								...
								<article class="blog-post-v1 style3 blog-fashion">
											...
											<div class="beans-mask">
												<div class="beans-slideset">
													<div class="beans-slide">
														<a href="blog-single-slider.html"><img src="http://placehold.it/385x260" alt="image description" class="img-responsive"></a>
													</div>
													<div class="beans-slide">
														<a href="blog-single-slider.html"><img src="http://placehold.it/385x260" alt="image description" class="img-responsive"></a>
													</div>
									...
									<div class="blog-txt">
										<h2><a href="blog-single-image.html">Why Does Music Feel So Good?</a></h2>
										<ul class="meta list-inline">
											<li>
												<i class="fa fa-user"></i>
												By <a href="blog-single-image.html">Admin name</a>
								...
								<article class="blog-post-v1 style3 blog-illustration">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/385x200" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
										<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
								...
								<article class="blog-post-v1 style3 blog-fashion">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/385x240" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
										<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
								...
								<article class="blog-post-v1 style3 blog-products">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/385x220" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
										<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
							...
							<nav class="blog-footer style2 text-center">
								<a href="blog-masonry-fullwidth-nospace.html" class="btn btn-load">LOAD MORE</a>
							</nav>
						</div>
					</div>
				</div>
