																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-single-default-sidebar-right.html">right SIDEBAR</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">single blog right sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
										...
										<div class="beans-mask">
											<div class="beans-slideset">
												...
												<div class="beans-slide">
													<img src="http://placehold.it/870x360" alt="image description" class="img-responsive">
												</div>
												<!-- beans-slide -->
												<div class="beans-slide">
													<img src="http://placehold.it/870x360" alt="image description" class="img-responsive">
