	...
	<div id="wrapper">
		<div class="w1">
													...
													<div class="drop-holder">
														...
														<div class="coll">
															<ul class="list-unstyled">
																...
																<li class="active"><a href="shortcode-pies-skills.html"><i class="fa fa-bolt"></i> PIES SKILLS</a></li>
			...
			<main id="main" role="main">
				...
				<header class="page-banner small grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">pie skills</h1>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">short codes</a></li>
									<li class="active"><a href="#">pie skills</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<!-- whatwedo section -->
				<section class="whatwedo-section padding-top-100 padding-bottom-100">
					<div class="container">
                        <div class="row">
                            <div class="col-xs-12">
				...
				<section class="whatwedo-section style2  padding-top-100 padding-bottom-100 bg-grey">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<!-- progress holder -->
								<ul class="progress-holder style2 list-unstyled padding-zero">
									<li>
				...
				<!-- lancer banner -->
				<section class="lancer-about  padding-top-100 padding-bottom-100">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<!-- box -->
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<!-- pie block -->
									<div class="pie-block">
										<div class="pie-chart" data-percent="85" data-barColor="#e74c3c" data-trackColor="rgba(255, 255, 255, 0.5)" data-lineWidth="5" data-barSize="200">
											<div class="pie-chart-percent">
												<span></span>%
											</div>
										</div>
									...
									<!-- pie block -->
									<div class="pie-block">
										<div class="pie-chart" data-percent="100" data-barColor="#e74c3c" data-trackColor="rgba(255, 255, 255, 0.5)" data-lineWidth="5" data-barSize="200">
											<div class="pie-chart-percent">
												<span></span>%
											</div>
										</div>
									...
									<!-- pie block -->
									<div class="pie-block">
										<div class="pie-chart" data-percent="75" data-barColor="#e74c3c" data-trackColor="rgba(255, 255, 255, 0.5)" data-lineWidth="5" data-barSize="200">
											<div class="pie-chart-percent">
												<span></span>%
											</div>
										</div>
									...
									<!-- pie block -->
									<div class="pie-block">
										<div class="pie-chart" data-percent="50" data-barColor="#e74c3c" data-trackColor="rgba(255, 255, 255, 0.5)" data-lineWidth="5" data-barSize="200">
											<div class="pie-chart-percent">
												<span></span>%
											</div>
										</div>
