	...
	<div id="wrapper" class="no-boxed">
		<div class="w7">
				...
				<div class="win-height jcf-scrollable">
					...
					<div class="sidemenu-holder">
						<header id="header7">
							<div class="logo">
								<a href="#">
									<img src="images/portfolio-inner/logo.png" alt="photographer" class="b-logo">
									<img src="images/portfolio-inner/logo-w.png" alt="photographer" class="w-logo">
								</a>
							</div>
							<nav id="nav7">
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-inline breadcrumbs">
									...
									<li class="active"><a href="#">PORTFOLIO VERTICAL 5 COLUMN</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<section class="work-section padding-top-100 padding-bottom-100 bg-grey dark-bottom-border space">
					<div class="container-fluid">
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="icotop-holder margin-bottom-30" id="work">
                                    <!-- portfolio block coll-5 -->
                                    <div class="portfolio-block coll-5 work-design">
                                        <!-- box -->
                                        <div class="box">
                                            ...
                                            <div class="stretch">
                                                <img src="http://placehold.it/287x287" alt="image description">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- portfolio block coll-5 -->
                                    <div class="portfolio-block coll-5 work-fashion">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block coll-5 -->
                                    <div class="portfolio-block coll-5 work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block coll-5 -->
                                    <div class="portfolio-block coll-5 work-products">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder">
                                                <div class="over">
                                            ...
                                            <div class="box-holder">
                                                <div class="over">
                                                    <div class="holder">
                                                        <div class="frame">
                                                            <div class="over-frame">
                                                                <strong class="title"> you're so awesome!</strong>
                                                                <p>Illustration</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="box-holder">
                                                <div class="over">
                                                    <div class="holder">
                                                        <div class="frame">
                                                            <div class="over-frame">
                                                                <strong class="title">this is long time ago</strong>
                                                                <p>Products</p>
                                                            </div>
                                                        </div>
                                                    </div>
								...
								<div class="text-center">
									<a href="portfolio-vert-5columns.html" class="btn btn-load">LOAD MORE</a>
								</div>
							</div>
						</div>
					</div>
