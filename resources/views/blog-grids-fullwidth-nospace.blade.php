																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-grids-fullwidth-nospace.html">Full width</a></li>
																			</ul>
																		</div>
																	</li>
																</ul>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog grids full width no space</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="col-xs-12">
							...
							<div class="blog-masonry-holder full-width add-style" id="masonry-container">
								...
								<article class="blog-post-v1 style3 item">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/385x230" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
								...
								<article class="blog-post-v1 style3 item">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/385x190" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
										<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
								...
								<article class="blog-post-v1 style3 item">
									<div class="img-box">
										<a href="blog-single-image.html"><img src="http://placehold.it/385x320" alt="image description" class="img-responsive"></a>
									</div>
									<div class="blog-txt">
										<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
										<ul class="meta list-inline">
							...
							<nav class="blog-footer style2 text-center">
								<a href="blog-grids-fullwidth-nospace.html" class="btn btn-load">LOAD MORE</a>
							</nav>
						</div>
					</div>
				</div>
