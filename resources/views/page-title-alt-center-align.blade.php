	...
	<div id="wrapper">
		<div class="w1">
																	...
																	<li class="active">
																		...
																		<div class="drop right-align">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="page-title-alt-center-align.html">center align</a></li>
			...
			<main id="main" role="main">
                <!-- page banner -->
				<header class="page-banner small grey center">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li class="active"><a href="#">page title alt center align</a></li>
								</ul>
							</div>
						</div>
					</div>
