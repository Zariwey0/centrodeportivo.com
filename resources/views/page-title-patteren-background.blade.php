	...
	<div id="wrapper">
		<div class="w1">
																	...
																	<li class="active">
																		...
																		<div class="drop right-align">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="page-title-patteren-background.html">pattern background</a></li>
			...
			<main id="main" role="main">
                <!-- page banner -->
				<header class="page-banner pattern">
					<div class="container">
						<div class="row">
							<div class="col-xs-12">
								<div class="holder">
									<h1 class="heading text-uppercase">page title</h1>
									<p>Your challenge is our progress</p>
								</div>
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li class="active"><a href="#">page title patteren background</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="container padding-bottom-100">
					<div class="row padding-top-100 padding-bottom-30">
						<div class="col-xs-12">
					...
					<div class="row padding-bottom-30">
						<div class="col-xs-12">
							<blockquote><q>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae odit iste exercitationem praesentium deleniti nostrum laborum rem id nihil tempora. Adipisci ea commodi unde nam placeat cupiditate quasi a ducimus rem consequuntur ex eligendi minima voluptatem assumenda voluptas quidem sit maiores odio velit voluptate.</q></blockquote>
						</div>
					</div>
					<div class="row padding-bottom-30">
						<div class="col-xs-12 col-sm-6">
