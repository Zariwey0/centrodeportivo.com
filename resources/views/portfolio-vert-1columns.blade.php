	...
	<div id="wrapper" class="no-boxed">
		<div class="w7">
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="list-inline breadcrumbs">
									...
									<li class="active"><a href="#">PORTFOLIO VERTICAL 1 COLUMN</a></li>
								</ul>
							</div>
						</div>
					</div>
			    ...
			    <!-- work-section -->
				<section class="work-section bg-grey dark-bottom-border padding-top-100 padding-bottom-100">
					<div class="container-max">
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="icotop-holder margin-bottom-30" id="work">
                                    ...
                                    <div class="portfolio-block nospace margin-bottom-30 work-design">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder half">
                                                <div class="over">
                                                    <div class="holder">
                                                        <div class="frame">
                                            ...
                                            <div class="stretch">
                                                <img src="http://placehold.it/1170x585" alt="image description">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- portfolio block nospace -->
                                    <div class="portfolio-block nospace margin-bottom-30 work-fashion">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder half">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace -->
                                    <div class="portfolio-block nospace margin-bottom-30 work-illustration">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder half">
                                                <div class="over">
                                    ...
                                    <!-- portfolio block nospace -->
                                    <div class="portfolio-block nospace margin-bottom-30 work-products">
                                        <!-- box -->
                                        <div class="box">
                                            <div class="box-holder half">
                                                <div class="over">
								...
								<div class="text-center">
									<a href="portfolio-vert-1columns.html" class="btn btn-load">LOAD MORE</a>
								</div>
							</div>
						</div>
					</div>
