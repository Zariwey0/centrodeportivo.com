...
<body>
	...
	<div id="wrapper">
		<div class="w1">
			<!-- header of the page style29 -->
			<header id="header" class="style29">
				<div class="container"> 
					<div class="row">
						<div class="col-xs-12">
							<!-- page logo -->
							<div class="logo">
								<a href="#">
									<img src="images/logo-shop2.png" alt="Fekra" class="img-responsive b-logo">
									<img src="images/logo-shop3.png" alt="Fekra" class="img-responsive w-logo">
								</a>
							</div>
							<!-- holder -->
							<div class="holder">
			...
			<main id="main" class="dark" role="main">
				<!-- shop gallery -->
				<div class="shop-gallery beans-slider shop2">
					<div class="beans-mask">
						<div class="beans-slideset">
							<!-- beans-slide -->
							<div class="beans-slide" style="background-image: url('http://placehold.it/1920x700');" >
								<div class="shop2-content">
									<div class="container">
										<div class="row">
											<div class="col-xs-12">
												<div class="shop-heading">
													<h1><span class="txt">UP TO 30% OFf</span> Sale <span class="text2">FREE SHIPPING OVER 40$</span></h1>
													<div class="button-slider">
														<a href="shop-grid-4column.html" class="btn btn-f-default">SHOP NOW</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="shop2-content">
									<div class="container">
										<div class="row">
											<div class="col-xs-12">
												<div class="shop-heading">
													<h1><span class="txt">UP TO 30% OFf</span> SALE</h1>
													<div class="button-slider">
				...
				<div class="shop2-container padding-top-90 padding-bottom-60">
					<div class="container">
						<div class="row txt-block">
							<div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
								<h2>Hot Collection</h2>
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur. Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-12 col-sm-4">
								<div class="shop-box">
									<a href="#"><img src="http://placehold.it/370x483" alt="image" class="img-responsive"></a>
								</div>
								<div class="shop-box">
									<a href="#"><img src="http://placehold.it/370x227" alt="image" class="img-responsive"></a>
								</div>
								<div class="shop-box arrow top">
									<a href="#" class="txt-box">
										<h3>ARTOF <span>EYES</span></h3>
									</a>
								</div>
							</div>
							<div class="col-xs-12 col-sm-4">
								<div class="shop-box arrow left">
									<a href="#" class="txt-box">
										<h3>MEANSWEAR <span>SUMMER</span> 2016</h3>
									</a>
								</div>
								<div class="shop-box">
									<a href="#"><img src="http://placehold.it/370x227" alt="image" class="img-responsive"></a>
								</div>
								<div class="shop-box arrow bottom">
									<a href="#" class="txt-box">
										<h3>GET INSPIRED <span>LEATHER</span></h3>
									</a>
								</div>
								<div class="shop-box">
									<a href="#"><img src="http://placehold.it/370x227" alt="image" class="img-responsive"></a>
							...
							<div class="col-xs-12 col-sm-4">
								<div class="shop-box  arrow bottom">
									<a href="#" class="txt-box">
										<h3>WOMENS <span>FASHION</span> OPEN NOW</h3>
									</a>
								</div>
								<div class="shop-box">
									<a href="#"><img src="http://placehold.it/370x483" alt="image" class="img-responsive"></a>
								...
								<div class="shop-box arrow top">
									<a href="#" class="txt-box">
										<h3>TIPPED WITH <span>SHOES</span></h3>
									</a>
								</div>
							</div>
						</div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="bottom-box1">
                                    <ul class="list-inline payment-nav">
                                        <li><a href="#"><img src="images/ico01.png" alt="Amarican Express"></a></li>
                                        <li><a href="#"><img src="images/ico02.png" alt="Master Card"></a></li>
                                        <li><a href="#"><img src="images/ico03.png" alt="Pay Pal"></a></li>
                                        <li><a href="#"><img src="images/ico04.png" alt="Visa"></a></li>
                                    </ul>
