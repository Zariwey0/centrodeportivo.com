																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-masonry-3column.html">3 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">blog MASONRY 3 column</a></li>
								</ul>
							</div>
						</div>
				    </div>
							...
							<div class="col-xs-12">
								...
								<div class="blog-masonry-holder" id="work">
									...
									<article class="blog-post-v1 style3 blog-design">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/360x215" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
												...
												<div class="beans-mask">
													<div class="beans-slideset">
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/360x245" alt="image description" class="img-responsive"></a>
														</div>
														<div class="beans-slide">
															<a href="blog-single-slider.html"><img src="http://placehold.it/360x245" alt="image description" class="img-responsive"></a>
														</div>
									...
									<article class="blog-post-v1 style3 blog-illustration">
										<div class="img-box">
											<a href="blog-single-image.html"><img src="http://placehold.it/360x180" alt="image description" class="img-responsive"></a>
										</div>
										<div class="blog-txt">
											<h2><a href="blog-single-image.html">Intelegent transitions in ux design</a></h2>
											<ul class="meta list-inline">
								...
								<nav class="blog-footer style2 text-center">
									<a href="blog-masonry-3column.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
						</div>
					</div>
