		...
		<div class="w1">
														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="blog-full-width-accordion-rightsidebar.html">RIGHT SIDEBAR</a></li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG FULL WIDTH accordion right sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<div class="container padding-top-100">
					<div class="row">
						<div class="col-xs-12 col-sm-8 col-md-9 blog-section padding-zero">
							<!-- blog-accordion -->
