														...
														<li class="active">
															...
															<div class="drop">
																<ul class="list-unstyled">
																	...
																	<li class="active"><a href="blog-single-3column.html">3 column</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">single blog 3 column</a></li>
								</ul>
							</div>
						</div>
				    </div>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<article class="blog-post-v1 style-full">
								...
								<div class="blog-txt">
									<h2>This is a 3 column sample post</h2>
							...
							<div class="col-xs-12 col-sm-6 col-md-3 column3 clearfix-sm">
								...
								<div class="f-lastest-news">
									...
									<div class="footer-news-box">
										<div class="img-box">
											<a href="#"><img src="http://placehold.it/80x80" alt="image description"></a>
										</div>
										<div class="txt">
