																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-timeline-default-rightsidebar.html">RIGHT SIDEBAR</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">BLOG timeline right sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-8 col-md-9">
								...
								<nav class="blog-footer style2 text-center">
									<a href="blog-timeline-default-rightsidebar.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
