	...
	<div id="wrapper">
		<div class="w1">
																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-timeline-default-leftsidebar.html">LEFT SIDEBAR</a></li>
																			</ul>
																		</div>
																	</li>
																	<li>
			...
			<main id="main" role="main">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#">BLOG timeline left sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
				...
				<!-- love story -->
				<section class="love-story padding-top-100 sidebar">
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-8 col-md-9 col-sm-push-4 col-md-push-3">
								<div class="row-holder">
									...
									<div class="box" data-animate="fadeInUp" data-delay="300">
										<a href="blog-single-image.html"><img src="http://placehold.it/355x210" alt="image description" class="img-responsive"></a>
										<div class="text-box">
											<h3><a href="blog-single-image.html">Sample Blog Post</a></h3>
									...
									<div class="box right" data-animate="fadeInUp" data-delay="300">
										<a href="blog-single-image.html"><img src="http://placehold.it/355x240" alt="image description" class="img-responsive"></a>
										<div class="text-box">
											<h3><a href="blog-single-image.html">Sample Blog Post</a></h3>
								...
								<nav class="blog-footer style2 text-center">
									<a href="blog-timeline-default-leftsidebar.html" class="btn btn-load">LOAD MORE</a>
								</nav>
							</div>
