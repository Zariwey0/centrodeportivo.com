																	...
																	<li class="active">
																		...
																		<div class="drop">
																			<ul class="list-unstyled">
																				...
																				<li class="active"><a href="blog-alt2-default-leftsidebar.html">LEFT SIDEBAR - layout 2</a></li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<ul class="breadcrumbs list-inline">
									<li><a href="#">HOME</a></li>
									<li><a href="#">BLOG</a></li>
									<li class="active"><a href="#"> BLOG FULL WIDTH alt2 left sidebar</a></li>
								</ul>
							</div>
						</div>
				    </div>
							...
							<article class="blog-post-v1 style2">
								...
								<div class="blog-txt">
									...
									<ul class="meta list-inline">
										...
										<li>
											<i class="fa fa-tags"></i>
											<a href="blog-single-image.html">Music</a>
										</li>
										<li>
											<i class="fa fa-heart"></i>
											<a href="blog-single-image.html">14</a>
